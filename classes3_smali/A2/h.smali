...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA2/h;->c:Lcom/sec/android/app/camera/cropper/util/c;
...
.method public final a(ILandroid/graphics/PointF;)V
    ...
    :goto_21
    invoke-static {p1, p0, p2}, LQ3/I;->d(Lcom/sec/android/app/camera/cropper/util/d;LA2/h;Landroid/graphics/PointF;)V
...
.method public final d()Lcom/sec/android/app/camera/cropper/util/c;
    ...
    sget-object p0, LA2/h;->c:Lcom/sec/android/app/camera/cropper/util/c;
...
.method public final e(Ljava/util/ArrayList;)Z
    ...
    invoke-static {p1, v0}, Landroidx/compose/foundation/text/a;->m(Ljava/util/ArrayList;I)Ljava/lang/Object;
    ...
    invoke-static {v7, v8}, LA2/c;->c(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
...
.method public final f(Landroid/graphics/Rect;Ljava/util/ArrayList;)Z
    ...
    invoke-direct {v2, p0, v1, v0, p1}, LA2/f;-><init>(FFFF)V
...
.method public final g(ILjava/util/ArrayList;Landroid/graphics/PointF;)V
    ...
    invoke-static {p0, p2, p1}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V
    ...
    :cond_9d
    :goto_9d
    invoke-static {p0, p2, p3}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V

    invoke-static {v0, p2, p3}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V

    :goto_a3
    return-void
.end method

.method public final h(ILA2/c;Landroid/graphics/PointF;Landroid/graphics/Rect;)V
    .registers 13
    ...
    invoke-static {v4, v3, v6}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V
    ...
    invoke-static {v4, v3, v5}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V
    ...
    invoke-static {v0, v3, v4}, LQ3/I;->F(ILjava/util/ArrayList;Landroid/graphics/PointF;)V
    ...
    :goto_ca
    invoke-static {p2, v3, p4}, LQ3/I;->C(LA2/c;Ljava/util/ArrayList;Landroid/graphics/Rect;)Z

    move-result v0

    if-eqz v0, :cond_d4

    invoke-virtual {p2, v3}, LA2/c;->i(Ljava/util/ArrayList;)V
