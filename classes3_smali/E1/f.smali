...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    if-eq v2, v10, :cond_548

    const/4 v4, 0x2

    if-eq v2, v4, :cond_501

    const-string v4, "null cannot be cast to non-null type kotlin.String"

    if-eq v2, v6, :cond_4a5
    ...
    if-eq v2, v7, :cond_479

    const/4 v7, 0x2

    if-eq v2, v7, :cond_450
    ...
    sparse-switch v5, :sswitch_data_792
    ...
    if-eq v2, v3, :cond_4cd

    const/4 v5, 0x2

    if-eq v2, v5, :cond_4b1
    ...
    :sswitch_data_792
    .sparse-switch
        0x209089 -> :sswitch_427
        0x209096 -> :sswitch_409
        0x2238a8 -> :sswitch_3f2
        0x234c63 -> :sswitch_3c9
        0x255c4f -> :sswitch_3b2
        0x2653d5 -> :sswitch_3a8
        0x26844f -> :sswitch_296
        0x273cfa -> :sswitch_237
        0x281c46 -> :sswitch_161
    .end sparse-switch
.end method
