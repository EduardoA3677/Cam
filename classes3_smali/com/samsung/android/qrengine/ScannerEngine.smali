...
.method public processFrame(Lcom/samsung/android/qrengine/FrameData;)V
    ...
    const-string/jumbo v2, "processFrame frameData id: "
...
.method public startEngine(Landroid/content/Context;Lcom/samsung/android/qrengine/EngineSetting;)Ljava/lang/Boolean;
    ...
    const-string/jumbo v0, "startEngine E"
    ...
    const-string/jumbo v0, "startEngine imageWidth: "
    ...
    invoke-static {p1, v1, v0}, LG2/u;->A(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
...
.method public stopEngine()V
    ...
    const-string/jumbo v0, "stopEngine E"
