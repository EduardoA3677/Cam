...
.method public static create(Landroid/content/res/AssetManager;Ljava/lang/String;Ljava/lang/String;IZ)Lcom/samsung/android/qrengine/tflite/Classifier;
    ...
    :try_end_38
    .catch Ljava/lang/Exception; {:try_start_2d .. :try_end_38} :catch_96
...
.method public recognizeImage(Landroid/graphics/Bitmap;[BII[I[Landroid/graphics/RectF;)I
    ...
    if-gt v11, v10, :cond_186

    if-ltz v14, :cond_186

    if-gt v14, v10, :cond_186

    if-ltz v13, :cond_186

    if-gt v13, v10, :cond_186

    if-ltz v12, :cond_186

    if-gt v12, v10, :cond_186

    if-gt v11, v14, :cond_186

    if-le v13, v12, :cond_167
