...
.field private summarizationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/X;
...
.method public static bridge synthetic c(Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;)Landroid/os/IBinder$DeathRecipient;
    .registers 1
...
.method public static bridge synthetic e(Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;)Lcom/samsung/android/sivs/ai/sdkcommon/language/X;
    .registers 1

    iget-object p0, p0, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->summarizationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/X;
...
# virtual methods
.method public getService()Lcom/samsung/android/sivs/ai/sdkcommon/language/X;
    .registers 1
...
.method public onConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    sget p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/W;->b:I
    ...
    instance-of v1, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/X;

    if-eqz v1, :cond_1c

    check-cast p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/X;

    goto :goto_23

    :cond_1c
    new-instance p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/V;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p2, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/V;->b:Landroid/os/IBinder;

    :goto_23
    iput-object p1, p0, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->summarizationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/X;

    :try_start_25
    check-cast p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/V;

    iget-object p1, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/V;->b:Landroid/os/IBinder;
