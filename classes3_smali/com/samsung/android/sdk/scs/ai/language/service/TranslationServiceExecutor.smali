...
.field private translationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;
...
.method public static bridge synthetic c(Lcom/samsung/android/sdk/scs/ai/language/service/TranslationServiceExecutor;)Landroid/os/IBinder$DeathRecipient;
    .registers 1
...
.method public static bridge synthetic e(Lcom/samsung/android/sdk/scs/ai/language/service/TranslationServiceExecutor;)Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;
    .registers 1

    iget-object p0, p0, Lcom/samsung/android/sdk/scs/ai/language/service/TranslationServiceExecutor;->translationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;
...
# virtual methods
.method public getService()Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;
    .registers 1
...
.method public onConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    sget p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/c0;->b:I
    ...
    instance-of v1, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;

    if-eqz v1, :cond_1c

    check-cast p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;

    goto :goto_23

    :cond_1c
    new-instance p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/b0;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p2, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/b0;->b:Landroid/os/IBinder;

    :goto_23
    iput-object p1, p0, Lcom/samsung/android/sdk/scs/ai/language/service/TranslationServiceExecutor;->translationService:Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;

    :try_start_25
    check-cast p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/b0;

    iget-object p1, p1, Lcom/samsung/android/sivs/ai/sdkcommon/language/b0;->b:Landroid/os/IBinder;
