...
.method public static synthetic e(Lcom/samsung/android/motionphoto/StapleMotionPhotoMaker;Z)V
    .registers 2
...
.method public static synthetic f(Lcom/samsung/android/motionphoto/StapleMotionPhotoMaker;)V
    .registers 1
...
.method public static synthetic h(Lcom/samsung/android/sum/core/message/Event;I)Z
    .registers 2
...
.method private requestSurface(Z)V
    ...
    const-string/jumbo v2, "secmm.motionphoto-vdis-crop"
    ...
    const-string/jumbo v5, "preview crop on origin[%d/%d] -> [%d/%d]"
    ...
    const-string/jumbo v5, "request surface: w/h/fmt/usg=%d/%d/0x%x/0x%x"
    ...
    const-string/jumbo v4, "run-on-main-thread"
    ...
    const-string/jumbo v0, "store-width"
    ...
    const-string/jumbo v0, "store-height"
    ...
    const-string/jumbo v0, "vdis-crop"
    ...
    :try_end_fe
    .catch Ljava/lang/Exception; {:try_start_7c .. :try_end_fe} :catch_80
...
.method public finalize()V
    ...
    :try_end_19
    .catchall {:try_start_0 .. :try_end_19} :catchall_12
...
.method public onEvent(Lcom/samsung/android/sum/core/message/Event;)V
    ...
    monitor-exit p0
    :try_end_11d
    .catchall {:try_start_5e .. :try_end_11d} :catchall_db
...
.method public start(Lcom/samsung/android/motionphoto/MPOption;Ljava/lang/Runnable;)V
    ...
    invoke-direct {v1, p0, p2, v2}, Lcom/samsung/android/motionphoto/t;-><init>(Lcom/samsung/android/motionphoto/StapleMotionPhotoMaker;Ljava/lang/Runnable;I)V

    invoke-virtual {v0, v1}, Lcom/samsung/android/sum/core/message/Request;->setOnReplyListener(Ljava/util/function/Consumer;)V

    :cond_3a
    iget-object p2, p0, Lcom/samsung/android/motionphoto/StapleMotionPhotoMaker;->sumClient:Lcom/samsung/android/sum/core/controller/SumClient;

    invoke-virtual {p2, v0}, Lcom/samsung/android/sum/core/controller/SumClient;->request(Lcom/samsung/android/sum/core/message/Request;)Ljava/util/concurrent/Future;

    iget-object p2, p0, Lcom/samsung/android/motionphoto/StapleMotionPhotoMaker;->bufferChannel:Lcom/samsung/android/motionphoto/MPBufferChannel;

    if-eqz p2, :cond_62

    sget p2, Lcom/samsung/android/motionphoto/MPOption;->IS_SEAMLESS_RATIO:I

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    invoke-virtual {p1, p2, v0}, Lcom/samsung/android/sum/core/types/OptionBase;->get(ILjava/lang/Object;)Ljava/lang/Object;
