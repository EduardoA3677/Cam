...
.method public static synthetic j(Lcom/samsung/android/camera/core2/util/JpegUtils$ExternalJpegMetadata;)Ljava/lang/Integer;
    .registers 1
...
.method public static synthetic m(Lcom/samsung/android/camera/core2/util/JpegUtils$ExternalJpegMetadata;)Z
    .registers 1
...
.method public static synthetic o(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;Ljava/lang/Integer;)V
    .registers 2
...
.method public static synthetic p([B)Z
    .registers 1
...
.method public static synthetic q(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;Lcom/samsung/android/camera/core2/util/JpegUtils$ExternalJpegMetadata;)V
    .registers 2
...
.method private static setBrightness(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)V
    ...
    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->g(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;

    move-result-object v0

    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->c(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Lcom/samsung/android/camera/core2/util/JpegUtils$ExternalJpegMetadata;

    move-result-object v1

    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->e(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Lcom/samsung/android/camera/core2/util/ImageInfo;
    ...
    invoke-direct {v1, v0, v2}, Lcom/samsung/android/camera/core2/util/l;-><init>(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;I)V
...
.method private static setDebugInfo(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)V
    ...
    new-instance v2, Lcom/samsung/android/camera/core2/util/q;

    const/16 v3, 0xf

    invoke-direct {v2, v3}, Lcom/samsung/android/camera/core2/util/q;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3}, Lcom/samsung/android/camera/core2/util/l;-><init>(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;I)V
    ...
    sget-object p0, Lcom/samsung/android/camera/core2/local/vendorkey/SemCaptureResult;->e1:Landroid/hardware/camera2/CaptureResult$Key;
...
.method private static setExposureCompensation(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)V
    ...
    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->f(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Lcom/samsung/android/camera/core2/util/JpegUtils$JpegCamCapability;
...
.method private static setSize(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)V
    ...
    new-instance v3, Lcom/samsung/android/camera/core2/util/l;

    const/4 v4, 0x6

    invoke-direct {v3, v0, v4}, Lcom/samsung/android/camera/core2/util/l;-><init>(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;I)V

    invoke-virtual {v2, v3}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->b(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Z
...
.method private static setTime(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)V
    ...
    invoke-static {p0}, Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;->d(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadataExecutorData;)Lcom/samsung/android/camera/core2/container/ExtraBundle;
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/camera/core2/container/ExtraBundle;->a(Lcom/samsung/android/camera/core2/container/ExtraBundle$Key;)Ljava/lang/Object;
...
.method public static synthetic t(Lcom/samsung/android/camera/core2/util/JpegUtils$JpegMetadata;Ljava/lang/String;)V
    .registers 2
