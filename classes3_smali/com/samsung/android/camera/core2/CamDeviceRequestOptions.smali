...
.method public final a(Ljava/util/Map;Ljava/lang/String;Ljava/util/ArrayList;Landroid/view/Surface;Landroid/view/Surface;Landroid/view/Surface;Ljava/util/concurrent/ConcurrentHashMap;Lcom/samsung/android/camera/core2/util/BlockingImageReader;Lcom/samsung/android/camera/core2/util/BlockingImageReader;)Landroid/util/Pair;
    ...
    new-instance v1, Lcom/samsung/android/camera/core2/util/StringUtils$NumComparator;

    invoke-direct {v1}, Lcom/samsung/android/camera/core2/util/StringUtils$NumComparator;-><init>()V

    invoke-direct {v9, v1}, Ljava/util/TreeSet;-><init>(Ljava/util/Comparator;)V

    iget-boolean v1, v0, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->b:Z

    if-eqz v1, :cond_3c

    invoke-static/range {p4 .. p4}, Ljava/util/Optional;->ofNullable(Ljava/lang/Object;)Ljava/util/Optional;

    move-result-object v1

    new-instance v2, Lcom/samsung/android/camera/core2/a;

    const/4 v3, 0x0

    invoke-direct {v2, v8, p3, v9, v3}, Lcom/samsung/android/camera/core2/a;-><init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/TreeSet;I)V
    ...
    :cond_3c
    :try_start_3c
    iget-object v10, v0, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->c:Ljava/util/EnumSet;

    new-instance v11, LM1/a;
    ...
    :try_end_4d
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_4d} :catch_e0

    :try_start_4d
    iget-boolean v1, v0, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->d:Z

    if-eqz v1, :cond_6e

    invoke-virtual/range {p8 .. p8}, Lcom/samsung/android/camera/core2/util/BlockingImageReader;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {p3, v1}, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->b(Ljava/util/List;Landroid/view/Surface;)Ljava/lang/String;
    ...
    invoke-direct {v2, v9, v3}, LB2/m;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V
    :try_end_6e
    .catch Ljava/lang/Exception; {:try_start_4d .. :try_end_6e} :catch_d8

    :cond_6e
    :try_start_6e
    iget-boolean v0, v0, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->e:Z

    if-eqz v0, :cond_8f

    invoke-virtual/range {p9 .. p9}, Lcom/samsung/android/camera/core2/util/BlockingImageReader;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {p3, v0}, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions;->b(Ljava/util/List;Landroid/view/Surface;)Ljava/lang/String;
    ...
    invoke-direct {v1, v9, v2}, LB2/m;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v1}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V
    :try_end_8f
    .catch Ljava/lang/Exception; {:try_start_6e .. :try_end_8f} :catch_d0
    ...
    :goto_9d
    invoke-direct {v0, p2, v3}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    move-object v1, p1

    invoke-static {p1, v0}, Lcom/samsung/android/camera/core2/local/vendorkey/SemCaptureRequest;->a(Ljava/util/Map;Landroid/util/Pair;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/camera/core2/exception/CamDeviceException;-><init>(Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;)V
    ...
    sget-object v1, Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;->NO_PICTURE_DEPTH_READER:Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;
    ...
    sget-object v1, Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;->NO_THUMBNAIL_IMAGE_READER:Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;
    ...
    sget-object v1, Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;->NO_PICTURE_IMAGE_READER:Lcom/samsung/android/camera/core2/exception/CamDeviceException$Type;
...
.method public final d(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/view/Surface;Landroid/view/Surface;Landroid/view/Surface;Ljava/util/Map;Lcom/samsung/android/camera/core2/util/BlockingImageReader;Lcom/samsung/android/camera/core2/util/BlockingImageReader;)V
    .registers 10
    ...
    invoke-direct {v0, p1, v1}, Lcom/samsung/android/camera/core2/b;-><init>(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    new-instance p3, Lcom/samsung/android/camera/core2/b;

    const/4 v0, 0x0

    invoke-direct {p3, p1, v0}, Lcom/samsung/android/camera/core2/b;-><init>(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-direct {p3, p1, p4}, Lcom/samsung/android/camera/core2/b;-><init>(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-direct {p3, p4, p5, p1}, LL2/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :try_end_44
    .catch Ljava/lang/Exception; {:try_start_39 .. :try_end_44} :catch_58
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v4, v3, v5, v2, v6}, Landroidx/concurrent/futures/a;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
