.class public Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer;->tag:Ljava/lang/String;
...
.method public configure(Lcom/samsung/android/camera/core2/processor/nodeController/composer/NodeChainComposer$NodeChainCompositionBundle;)V
    ...
    sget-object v3, Lcom/samsung/android/camera/core2/processor/container/NodeChainKeyContainer;->NODE_CHAIN_KEY_HIGHRES_UDC:Lcom/samsung/android/camera/core2/node/NodeChain$Key;
    ...
    check-cast v2, Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase;

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/samsung/android/camera/core2/node/Node;->initialize(Z)V

    new-instance v4, Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase$SecUdcInitParam;

    sget-object v5, Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase$RestorationType;->MULTI_RAW_FRAME_RESTORATION_TYPE_4:Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase$RestorationType;

    invoke-direct {v4, v1, v5}, Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase$SecUdcInitParam;-><init>(Lcom/samsung/android/camera/core2/CamCapability;Lcom/samsung/android/camera/core2/node/udc/samsung/SecUdcNodeBase$RestorationType;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer;->tag:Ljava/lang/String;

    const-string p1, "configureHighresUdcNodeChain: secUdcNode chain is enabled."
...
.method public create(Lcom/samsung/android/camera/core2/CamCapability;)Lcom/samsung/android/camera/core2/node/NodeChain;
    ...
    sget-object v1, Lcom/samsung/android/camera/core2/processor/container/NodeChainKeyContainer;->NODE_CHAIN_KEY_HIGHRES_UDC:Lcom/samsung/android/camera/core2/node/NodeChain$Key;
    ...
    new-instance p1, Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer$1;

    invoke-direct {p1, p0}, Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer$1;-><init>(Lcom/samsung/android/camera/core2/processor/nodeController/composer/HighResUdcNodeChainComposer;)V
