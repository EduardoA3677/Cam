...
.method public constructor <init>(Lcom/samsung/android/camera/core2/device/CamDeviceImpl;Ljava/util/HashMap;Lcom/samsung/android/camera/core2/CamDevice$BurstPictureCallback;)V
    ...
    iget-object p1, p1, Lcom/samsung/android/camera/core2/device/CamDeviceImpl;->d0:Lcom/samsung/android/camera/core2/CamDevice$RecordStateCallback;
...
.method public final onCaptureBufferLost(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/view/Surface;J)V
    ...
    iget-object v1, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->c:Ljava/lang/String;
    ...
    invoke-static {v1, p1, p0}, Lcom/samsung/android/camera/core2/util/CLog;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final onCaptureCompleted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    const-string v0, "BurstPicRecordCaptureCallback onCaptureCompleted - session %s, request %s, timestamp %s, sequenceId %d, frameNumber %d"

    iget-object v2, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->c:Ljava/lang/String;

    invoke-static {v2, v0, p1}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean p1, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->g:Z

    iget-object v0, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->f:Lcom/samsung/android/camera/core2/CamDevice$RecordStateCallback;
    ...
    invoke-direct {p2, v2, v1, p3}, Lcom/samsung/android/camera/core2/device/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v2, p2, p1}, Lcom/samsung/android/camera/core2/util/CLog;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final onCaptureFailed(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CaptureFailure;)V
    ...
    const-string p2, "BurstPicRecordCaptureCallback onCaptureFailed - session %s, request %s, sequenceId %d, frameNumber %d, reason %d"
    ...
    new-instance p2, Lcom/samsung/android/camera/core2/device/j;

    const/4 v1, 0x1

    invoke-direct {p2, v1, p0, p3}, Lcom/samsung/android/camera/core2/device/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final onCaptureSequenceAborted(Landroid/hardware/camera2/CameraCaptureSession;I)V
    ...
    const-string v0, "BurstPicRecordCaptureCallback onCaptureSequenceAborted - session %s, sequenceId %d"
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/camera/core2/device/CamDeviceImpl;->p0(Lcom/samsung/android/camera/core2/CamDevice$CaptureState;)V

    iget-object p1, v0, Lcom/samsung/android/camera/core2/device/CamDeviceImpl;->h:Lcom/samsung/android/camera/core2/device/CamDeviceHandlerManager;
    ...
    invoke-direct {v0, p2, v2}, Lcom/samsung/android/camera/core2/device/a;-><init>(II)V

    invoke-virtual {p1, v0}, Lcom/samsung/android/camera/core2/device/CamDeviceHandler;->b(Ljava/util/function/Predicate;)V

    new-instance v0, Lcom/samsung/android/camera/core2/device/l;

    const/4 v2, 0x1

    invoke-direct {v0, p0, p2, v2}, Lcom/samsung/android/camera/core2/device/l;-><init>(Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;II)V
...
.method public final onCaptureSequenceCompleted(Landroid/hardware/camera2/CameraCaptureSession;IJ)V
    ...
    const-string p3, "BurstPicRecordCaptureCallback onCaptureSequenceCompleted - session %s, sequenceId %d, frameNumber %d"

    iget-object p4, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->c:Ljava/lang/String;

    invoke-static {p4, p3, p1}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object p1, Lcom/samsung/android/camera/core2/CamDevice$CaptureState;->IDLE:Lcom/samsung/android/camera/core2/CamDevice$CaptureState;

    iget-object p3, p0, Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;->a:Lcom/samsung/android/camera/core2/device/CamDeviceImpl;

    invoke-virtual {p3, p1}, Lcom/samsung/android/camera/core2/device/CamDeviceImpl;->p0(Lcom/samsung/android/camera/core2/CamDevice$CaptureState;)V
    ...
    invoke-direct {p3, p2, v0}, Lcom/samsung/android/camera/core2/device/a;-><init>(II)V

    invoke-virtual {p1, p3}, Lcom/samsung/android/camera/core2/device/CamDeviceHandler;->b(Ljava/util/function/Predicate;)V

    new-instance p3, Lcom/samsung/android/camera/core2/device/l;

    const/4 v0, 0x0

    invoke-direct {p3, p0, p2, v0}, Lcom/samsung/android/camera/core2/device/l;-><init>(Lcom/samsung/android/camera/core2/device/CamDeviceBurstPicRecordCaptureCallback;II)V
...
.method public final onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
    ...
    invoke-direct/range {v2 .. v8}, Lcom/samsung/android/camera/core2/device/f;-><init>(Ljava/lang/Object;JJI)V

    invoke-virtual {p0, p1, p2}, Ljava/util/concurrent/ConcurrentSkipListMap;->compute(Ljava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
