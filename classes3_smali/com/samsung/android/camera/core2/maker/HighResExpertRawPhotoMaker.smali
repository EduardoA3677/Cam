...
# static fields
.field private static final HR_EXPERT_RAW_PHOTO_TAG:Ljava/lang/String; = "HrExpertRawPhotoMaker"
...
.method public static synthetic Z(Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
    .registers 1

    invoke-static {p0}, Lcom/samsung/android/camera/core2/maker/HighResExpertRawPhotoMaker;->lambda$prepareRawPicStreamConfig$0(Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
...
.method public static synthetic a0(Landroid/util/Size;Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
    .registers 2

    invoke-static {p0, p1}, Lcom/samsung/android/camera/core2/maker/HighResExpertRawPhotoMaker;->lambda$prepareRawPicStreamConfig$1(Landroid/util/Size;Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
...
.method private static lambda$prepareRawPicStreamConfig$0(Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
    .registers 2
...
.method private static lambda$prepareRawPicStreamConfig$1(Landroid/util/Size;Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
    .registers 3
...
.method public getMakerTag()Ljava/lang/String;
    ...
    const-string p0, "HrExpertRawPhotoMaker"
...
.method public prepareRawPicStreamConfig(Lcom/samsung/android/camera/core2/CamCapability;Lcom/samsung/android/camera/core2/container/DeviceConfiguration;)V
    ...
    iget-object p2, p1, Lcom/samsung/android/camera/core2/CamCapability;->e:Lcom/samsung/android/camera/core2/local/capability/FeatureCapability;

    iget-object v0, p2, Lcom/samsung/android/camera/core2/local/capability/FeatureCapability;->g:Ljava/lang/Boolean;

    if-nez v0, :cond_e

    const/16 v0, 0x50

    invoke-static {p2, v0}, Lb/a;->d(Lcom/samsung/android/camera/core2/local/capability/FeatureCapability;I)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p2, Lcom/samsung/android/camera/core2/local/capability/FeatureCapability;->g:Ljava/lang/Boolean;

    :cond_e
    iget-object p2, p2, Lcom/samsung/android/camera/core2/local/capability/FeatureCapability;->g:Ljava/lang/Boolean;
    ...
    iget-object p2, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->l:Ljava/util/List;

    if-nez p2, :cond_39

    iget-object p2, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->a:Lcom/samsung/android/camera/core2/CamCapability$CameraCharacteristicsSupplier;
    ...
    invoke-static {p2}, Lcom/samsung/android/camera/core2/container/SecStreamConfig;->b([I)Ljava/util/ArrayList;

    move-result-object p2

    iput-object p2, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->l:Ljava/util/List;
    ...
    iget-object v1, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->n:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->n:Ljava/util/List;
    ...
    :cond_68
    :goto_68
    iget-object v0, v0, Lcom/samsung/android/camera/core2/local/capability/ScalerCapability;->n:Ljava/util/List;
