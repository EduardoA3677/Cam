...
.method public static synthetic Z(Lcom/samsung/android/camera/core2/maker/StereoPhotoMaker;Lcom/samsung/android/camera/core2/container/SecStreamConfig;)Z
    .registers 2
...
.method public prepareYuvPicStreamConfig(Lcom/samsung/android/camera/core2/CamCapability;)V
    ...
    const-string/jumbo v1, "prepareYuvPicStreamConfig"
...
.method public takeProcessingPictureInternal(Lcom/samsung/android/camera/core2/container/DynamicShotInfo;Ljava/io/File;I)I
    ...
    iget-object v2, v8, Lcom/samsung/android/camera/core2/maker/MakerBase;->mDFovStreamType:Ljava/lang/Integer;
    ...
    const-string v6, "StereoPhotoMaker"

    invoke-static {v6, v2, v1}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v6, v10, v9}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v11, Lcom/samsung/android/camera/core2/processor/request/ProcessRequestImpl$Sequence;
    ...
    invoke-virtual {v8, v5}, Lcom/samsung/android/camera/core2/maker/PortraitZoomPhotoMaker;->initializeSequence(Lcom/samsung/android/camera/core2/processor/request/ProcessRequest$Sequence;)V

    new-instance v0, Ljava/lang/StringBuilder;

    const-string/jumbo v7, "takeProcessingPictureInternal - "
    ...
    invoke-interface {v5}, Lcom/samsung/android/camera/core2/processor/request/ProcessRequest$Sequence;->getProcessType()Lcom/samsung/android/camera/core2/container/ProcessType;
    ...
    invoke-static {v6, v7, v0}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_119
    invoke-virtual/range {v24 .. v24}, Lcom/samsung/android/camera/core2/CamCapability;->p()Ljava/lang/Boolean;
    ...
    :cond_133
    iget-object v1, v8, Lcom/samsung/android/camera/core2/maker/MakerBase;->mCapturePhysicalId:Ljava/lang/Integer;

    iget-object v2, v8, Lcom/samsung/android/camera/core2/maker/PortraitZoomPhotoMaker;->mYuvStreamPicTypeMap:Ljava/util/Map;
    ...
    iget-object v4, v8, Lcom/samsung/android/camera/core2/maker/PortraitZoomPhotoMaker;->mYuvStreamPicTypeMap:Ljava/util/Map;

    iget-object v7, v8, Lcom/samsung/android/camera/core2/maker/MakerBase;->mCaptureSubPhysicalId:Ljava/lang/Integer;
    ...
    const-string/jumbo v2, "takeProcessingPictureInternal - Main {physicalId %d, %s}, Sub {physicalId %d, %s}"
    ...
    iput-boolean v14, v0, Lcom/samsung/android/camera/core2/CamDeviceRequestOptions$Builder;->c:Z
    ...
    :cond_1d8
    invoke-virtual {v8, v0, v10, v11, v13}, Lcom/samsung/android/camera/core2/maker/PortraitZoomPhotoMaker;->setPictureForNormalDualCapture(Lcom/samsung/android/camera/core2/CamDeviceRequestOptions$Builder;III)V
    ...
    invoke-virtual {v0, v1, v15}, Lcom/samsung/android/camera/core2/CamDevice;->N(Lcom/samsung/android/camera/core2/processor/request/ProcessRequestImpl$Sequence;Ljava/util/List;)I
    ...
    const-string/jumbo v1, "takeProcessingPictureInternal : sequenceId(%d)"
    ...
    invoke-static {v14, v1, v2}, Lcom/samsung/android/camera/core2/util/CLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_210
    .catch Lcom/samsung/android/camera/core2/exception/CamDeviceException; {:try_start_1f8 .. :try_end_210} :catch_218
    .catchall {:try_start_1f8 .. :try_end_210} :catchall_216
    ...
    throw v1
    :try_end_222
    .catchall {:try_start_219 .. :try_end_222} :catchall_216
