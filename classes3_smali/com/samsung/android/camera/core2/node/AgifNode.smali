...
# direct methods
.method public constructor <init>(Landroid/util/Size;ILcom/samsung/android/camera/core2/node/AgifNode$AgifNodeCallback;)V
    .registers 7
...
.method private synthetic lambda$processAgif$0(ILandroid/hardware/camera2/CaptureResult;I)Ljava/lang/Boolean;
    ...
    const-string/jumbo v0, "processAgif E: count "
...
.method private prepareAgifEncoder(Landroid/hardware/camera2/CaptureResult;)V
    ...
    :cond_a4
    iget-object p1, p0, Lcom/samsung/android/camera/core2/node/AgifNode;->mAgifResultSize:Landroid/util/Size;
    ...
    const-string/jumbo p1, "prepareAgifEncoder: AgifImageSize %s, ThumbnailSize %s, MaxCaptureCount %d, Orientation %d, ResultFile %s"
...
.method public declared-synchronized processPictureYuv(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/container/ExtraBundle;)Lcom/samsung/android/camera/core2/util/ImageBuffer;
    ...
    const-string/jumbo p2, "processPictureYuv X: skip - invalid state = "
    ...
    :try_end_29
    .catchall {:try_start_4 .. :try_end_29} :catchall_2b
    ...
    const-string/jumbo v3, "processPictureYuv: Picture Size = %s, StrideInfo = %s"
    ...
    const-string/jumbo v0, "processPictureYuv X: failed to process quramResizeNV21"
    ...
    :try_end_a6
    .catchall {:try_start_2e .. :try_end_a6} :catchall_2b
    ...
    const-string/jumbo v1, "processPictureYuv X: format(%s) is not supported"
    ...
    invoke-virtual {p1, v11}, Lcom/samsung/android/camera/core2/util/DirectBuffer;->returnByteBuffer(Ljava/nio/ByteBuffer;)V
    :try_end_e8
    .catchall {:try_start_a8 .. :try_end_e8} :catchall_2b
    ...
    :try_end_f2
    .catchall {:try_start_ea .. :try_end_f2} :catchall_2b
    ...
    monitor-exit p0
    :try_end_f5
    .catchall {:try_start_f4 .. :try_end_f5} :catchall_2b
...
.method public declared-synchronized stopPicture()V
    ...
    .catchall {:try_start_2c .. :try_end_41} :catchall_26
    ...
    :try_end_49
    .catchall {:try_start_42 .. :try_end_49} :catchall_26
    ...
    monitor-exit p0
    :try_end_4c
    .catchall {:try_start_4b .. :try_end_4c} :catchall_26
