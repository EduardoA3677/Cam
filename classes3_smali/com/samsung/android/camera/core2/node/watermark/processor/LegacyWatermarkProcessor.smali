...
.method public final a(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/container/ExtraBundle;Lcom/samsung/android/camera/core2/container/Watermark;)Lcom/samsung/android/camera/core2/util/ImageBuffer;
    ...
    if-eq v5, v12, :cond_1c6

    const/4 v12, 0x3

    if-eq v5, v12, :cond_185

    const/4 v12, 0x4

    if-eq v5, v12, :cond_148

    const/4 v12, 0x5

    if-eq v5, v12, :cond_107
    ...
    move-result v0
    :try_end_2a9
    .catchall {:try_start_28b .. :try_end_2a9} :catchall_2c3
    ...
    throw v0
    :try_end_2e4
    .catchall {:try_start_2b5 .. :try_end_2e4} :catchall_2c3
