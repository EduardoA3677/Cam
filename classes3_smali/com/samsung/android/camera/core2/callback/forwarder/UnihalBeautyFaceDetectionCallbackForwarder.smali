...
.method public final o(Lcom/samsung/android/camera/core2/CamDevice;Ljava/lang/Long;Landroid/hardware/camera2/CaptureResult;)V
    ...
    :goto_92
    if-ge v8, v15, :cond_1a8

    mul-int v0, v8, v13

    add-int/lit8 v16, v0, 0x1

    if-eq v9, v7, :cond_15a
    ...
    aget v7, v6, v16
    :try_end_bf
    .catch Ljava/lang/Exception; {:try_start_a6 .. :try_end_bf} :catch_e7
    ...
    aget v9, v6, v16
    :try_end_c5
    .catch Ljava/lang/Exception; {:try_start_c3 .. :try_end_c5} :catch_e3
    ...
    aget v13, v6, v13
    :try_end_110
    .catch Ljava/lang/Exception; {:try_start_c9 .. :try_end_110} :catch_de
    ...
    invoke-virtual {v14, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    :try_end_18b
    .catch Ljava/lang/Exception; {:try_start_114 .. :try_end_18b} :catch_158
