...
.method private static parseJpegExif(Ljava/io/File;)Ljava/nio/ByteBuffer;
    ...
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_6} :catch_89
    ...
    :try_end_85
    .catchall {:try_start_7 .. :try_end_85} :catchall_5b
    ...
    move-result-object p0
    :try_end_b1
    .catchall {:try_start_8e .. :try_end_b1} :catchall_5b

    :try_start_b1
    invoke-virtual {v1}, Ljava/io/FileInputStream;->close()V
    :try_end_b4
    .catch Ljava/lang/Exception; {:try_start_b1 .. :try_end_b4} :catch_89
    ...
    :try_end_dd
    .catchall {:try_start_b5 .. :try_end_dd} :catchall_5b
    ...
    invoke-virtual {v1}, Ljava/io/FileInputStream;->close()V
    :try_end_e4
    .catch Ljava/lang/Exception; {:try_start_dd .. :try_end_e4} :catch_89
    ...
    throw p0
    :try_end_ee
    .catch Ljava/lang/Exception; {:try_start_ea .. :try_end_ee} :catch_89
...
.method private reset()V
    ...
    iget-object p0, p0, Lcom/samsung/android/sum/core/UniExifInterface;->tempFile:Ljava/io/File;
...
.method private static toJpegExifFile(Ljava/nio/ByteBuffer;)Ljava/io/File;
    ...
    :goto_4e
    const-string/jumbo p0, "temp.jpg"
...
.method public getOriginExifBuffer()Ljava/nio/ByteBuffer;
    ...
    iget-object p0, p0, Lcom/samsung/android/sum/core/UniExifInterface;->originExifBuffer:Ljava/nio/ByteBuffer;
