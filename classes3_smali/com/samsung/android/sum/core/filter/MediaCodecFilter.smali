...
.method private forceStop()V
    ...
    iget-object p0, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->codecOnReadyCountingLatch:Lcom/samsung/android/sum/core/functional/CountingLatch;
...
.method public getDescriptor()Lcom/samsung/android/sum/core/descriptor/MFDescriptor;
    ...
    iget-object p0, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->codecDescriptor:Lcom/samsung/android/sum/core/descriptor/CodecDescriptor;
...
.method public getMessagesToReceive()[I
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sum/core/descriptor/MFDescriptorBase;->getMessageToReceive()[I
    ...
    invoke-static {v0, p0}, Ljava/util/stream/IntStream;->concat(Ljava/util/stream/IntStream;Ljava/util/stream/IntStream;)Ljava/util/stream/IntStream;
...
.method public onMessageReceived(Lcom/samsung/android/sum/core/message/Message;)Z
    ...
    invoke-direct {v5, v2}, Lcom/samsung/android/sum/core/filter/g;-><init>(I)V
    ...
    const-string/jumbo v3, "update whole frame num to "

    const-string v5, "(add "

    const-string v6, ")"

    invoke-static {v1, v2, v3, v5, v6}, Landroidx/collection/a;->o(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, v1}, Lcom/samsung/android/sum/core/SLog;->v(Lcom/samsung/android/sum/core/Tag;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lcom/samsung/android/sum/core/functional/CountingLatch;->up(I)I

    goto :goto_11f

    :cond_111
    iget-object p0, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->flushRequestedContents:Ljava/util/Set;
...
.method public pause()V
    ...
    iget-object p0, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->cvPause:Landroid/os/ConditionVariable;
...
.method public declared-synchronized release()V
    ...
    const-string/jumbo v3, "wait encoded buffer to release"

    const-wide/16 v4, 0x7d0

    invoke-virtual {v2, v1, v4, v5, v3}, Lcom/samsung/android/sum/core/functional/CountingLatch;->await(IJLjava/lang/String;)I
    ...
    :try_end_25
    .catch Ljava/lang/IllegalStateException; {:try_start_11 .. :try_end_25} :catch_3a
    ...
    :goto_37
    iput-object v0, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->mediaCodec:Landroid/media/MediaCodec;
    :try_end_39
    .catchall {:try_start_25 .. :try_end_39} :catchall_2f
    ...
    invoke-virtual {v2}, Lcom/samsung/android/sum/core/functional/CountingLatch;->getCount()I
    ...
    const-string v3, "fail to wait for all encoded buffer to release"

    invoke-static {v2, v3}, Lcom/samsung/android/sum/core/SLog;->w(Lcom/samsung/android/sum/core/Tag;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->messageProducer:Lcom/samsung/android/sum/core/message/MessageProducer;

    const/4 v3, -0x2

    invoke-interface {v2, v3}, Lcom/samsung/android/sum/core/message/MessageProducer;->newMessage(I)Lcom/samsung/android/sum/core/message/Message;
    ...
    invoke-static {v2, v3}, Lcom/samsung/android/sum/core/SLog;->w(Lcom/samsung/android/sum/core/Tag;Ljava/lang/String;)V
    :try_end_5f
    .catchall {:try_start_3a .. :try_end_5f} :catchall_1e
    ...
    :cond_7f
    :goto_7f
    iput v1, p0, Lcom/samsung/android/sum/core/filter/MediaCodecFilter;->processedFrames:I
    ...
    invoke-static {v0, v1}, Lcom/samsung/android/sum/core/SLog;->v(Lcom/samsung/android/sum/core/Tag;Ljava/lang/String;)V
    :try_end_a9
    .catchall {:try_start_5f .. :try_end_a9} :catchall_2f
    ...
    monitor-exit p0
    :try_end_ac
    .catchall {:try_start_ab .. :try_end_ac} :catchall_2f
