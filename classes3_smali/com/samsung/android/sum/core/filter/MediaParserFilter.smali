...
.method private isTrackDirectlyMuxing(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p1, v1}, LN2/b;-><init>(Ljava/lang/String;I)V
...
.method private static synthetic lambda$isTrackDirectlyMuxing$1(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Boolean;
    ...
    invoke-direct {v0, p0, v1}, LO2/k;-><init>(Ljava/lang/String;I)V
...
.method private synthetic lambda$run$4(Landroid/media/MediaExtractor;JILandroid/util/Pair;)V
    ...
    :try_end_6f
    .catch Ljava/lang/NullPointerException; {:try_start_6b .. :try_end_6f} :catch_16a
    ...
    :try_end_99
    .catch Ljava/lang/NullPointerException; {:try_start_71 .. :try_end_99} :catch_86
    ...
    move-result-object v9
    :try_end_a5
    .catch Ljava/lang/IllegalStateException; {:try_start_9e .. :try_end_a5} :catch_a7
    .catch Ljava/lang/NullPointerException; {:try_start_9e .. :try_end_a5} :catch_86
    ...
    move-result v14
    :try_end_bd
    .catch Ljava/lang/NullPointerException; {:try_start_ac .. :try_end_bd} :catch_86
    ...
    move-result-object v9
    :try_end_c6
    .catch Ljava/lang/IllegalStateException; {:try_start_bf .. :try_end_c6} :catch_c7
    .catch Ljava/lang/NullPointerException; {:try_start_bf .. :try_end_c6} :catch_86
    ...
    move-result v15
    :try_end_f2
    .catch Ljava/lang/NullPointerException; {:try_start_cc .. :try_end_f2} :catch_86
    ...
    :try_end_169
    .catch Ljava/lang/NullPointerException; {:try_start_f6 .. :try_end_169} :catch_86
...
.method public run(Lcom/samsung/android/sum/core/buffer/MediaBuffer;Lcom/samsung/android/sum/core/buffer/MutableMediaBuffer;)Lcom/samsung/android/sum/core/buffer/MutableMediaBuffer;
    ...
    :try_end_77
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_77} :catch_15c
    .catchall {:try_start_29 .. :try_end_77} :catchall_145
    ...
    :try_end_ca
    .catchall {:try_start_77 .. :try_end_ca} :catchall_14c
    ...
    invoke-virtual {v1}, Lcom/samsung/android/sum/core/message/Message;->post()Lcom/samsung/android/sum/core/message/Message;
    :try_end_e4
    .catchall {:try_start_d9 .. :try_end_e4} :catchall_149
    ...
    new-instance v2, Lcom/samsung/android/sum/core/filter/p;

    invoke-direct {v2, v1}, Lcom/samsung/android/sum/core/filter/p;-><init>(Ljava/util/List;)V
    ...
    new-instance v8, Lcom/samsung/android/sum/core/filter/q;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/samsung/android/sum/core/filter/q;-><init>(Lcom/samsung/android/sum/core/filter/MediaParserFilter;Landroid/media/MediaExtractor;JI)V

    invoke-virtual {v7, v8}, Ljava/util/ArrayList;->forEach(Ljava/util/function/Consumer;)V
    :try_end_141
    .catch Ljava/io/IOException; {:try_start_e4 .. :try_end_141} :catch_147
    .catchall {:try_start_e4 .. :try_end_141} :catchall_145
    ...
    throw v1
    :try_end_15c
    .catch Ljava/io/IOException; {:try_start_158 .. :try_end_15c} :catch_147
    .catchall {:try_start_158 .. :try_end_15c} :catchall_145
    ...
    throw v1
    :try_end_178
    .catchall {:try_start_15f .. :try_end_178} :catchall_145
