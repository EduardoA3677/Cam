...
.method public static synthetic c(Ljava/lang/Exception;)Z
    .registers 1
...
.method public static synthetic h(Lcom/samsung/android/sum/core/message/Request;Lcom/samsung/android/sum/core/service/ServiceProxy;)Ljava/util/concurrent/Future;
    .registers 2
...
.method private static synthetic lambda$new$0(Ljava/lang/Exception;)Z
    ...
    new-instance v2, Lcom/samsung/android/sum/core/controller/f;

    const/4 v3, 0x2

    invoke-direct {v2, v3}, Lcom/samsung/android/sum/core/controller/f;-><init>(I)V
...
.method public release()V
    ...
    monitor-exit v0
    :try_end_23
    .catchall {:try_start_f .. :try_end_23} :catchall_1e
...
.method public request(Lcom/samsung/android/sum/core/message/Request;)Ljava/util/concurrent/Future;
    ...
    new-instance p1, Lcom/samsung/android/sum/core/controller/h;

    const/4 v0, 0x1

    invoke-direct {p1, v0}, Lcom/samsung/android/sum/core/controller/h;-><init>(I)V
...
.method public run(Ljava/util/List;Ljava/util/List;)Ljava/util/concurrent/Future;
    ...
    invoke-direct {p1, p2}, Lcom/samsung/android/sum/core/controller/h;-><init>(I)V
