...
.field public static final enum ACTION_DOCUMENT_AUTO_SCAN:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
...
.field public static final enum ACTION_UPDATE_THUMBNAIL:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
...
.method private static synthetic $values()[Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
    ...
    sget-object v1, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_CAMERA:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
    ...
    sget-object v3, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_TIMER:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v4, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_MODE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v5, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_MODE_MULTIDEEPLINK:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v6, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_CAMERA:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v7, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_TIMER:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v8, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_FLASH:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v9, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_SHOW_SETTING:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v10, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_QR_SCANNER:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v11, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHECK_MODE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v12, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHECK_INFO:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v13, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_SUPERSTEADY:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v14, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_SUPERSTEADY:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v15, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_MOTIONPHOTO:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v16, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_MOTIONPHOTO:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v17, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_ZOOM:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v18, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_ZOOM:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v19, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_RESOLUTION:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v20, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_RESOLUTION:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v21, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_ANGLE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v22, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_ANGLE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v23, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CREATE_MYFILTER:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v24, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_SELECT_MYFILTER:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v25, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_MULTI_RECORDING_TYPE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v26, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_MULTI_RECORDING_TYPE:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v27, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CHANGE_VIDEO_AUTO_FRAMING:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v28, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_CAPTURE_VIDEO_AUTO_FRAMING:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v29, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_GOTO_QUICK_VIEW:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v30, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_UPDATE_THUMBNAIL:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    sget-object v31, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_DOCUMENT_AUTO_SCAN:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    filled-new-array/range {v0 .. v31}, [Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.mode"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.camera"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.flash"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.timer"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.capture.mode"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.capture.mode.multideeplink"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.capture.camera"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.capture.timer"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.capture.flash"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.show.setting"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.qr.scanner"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.check.mode"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.supersteady"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.motionphoto"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.zoom"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.resolution"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.angle"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.create.myfilter"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.multi_recording_type"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.change.video_auto_framing"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.goto.quick_view"
    ...
    const-string/jumbo v2, "viv.cameraApp.action.update.thumbnail"

    const-string v3, "ACTION_UPDATE_THUMBNAIL"

    invoke-direct {v0, v3, v1, v2}, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_UPDATE_THUMBNAIL:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    new-instance v0, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;

    const/16 v1, 0x1f

    const-string/jumbo v2, "viv.cameraApp.action.document_auto_scan"

    const-string v3, "ACTION_DOCUMENT_AUTO_SCAN"

    invoke-direct {v0, v3, v1, v2}, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v0, Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;->ACTION_DOCUMENT_AUTO_SCAN:Lcom/sec/android/app/camera/executor/ActionStateSet$ActionId;
