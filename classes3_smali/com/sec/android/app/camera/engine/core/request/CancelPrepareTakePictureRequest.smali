.class Lcom/sec/android/app/camera/engine/core/request/CancelPrepareTakePictureRequest;
...
.method private stopTorchFlash(Lcom/sec/android/app/camera/engine/interfaces/Engine$MakerSettings;)V
    .registers 5
    ...
    invoke-interface {v0, v1}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->setTorchFlashEnabled(Z)V
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->isManualExposure()Z
...
.method public execute()V
    ...
    const-string v0, "CamAccessException : "
    ...
    invoke-interface {v4}, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature;->isTakingPictureSupported()Z
    ...
    invoke-interface {v4}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->isTorchFlashEnabled()Z

    move-result v4

    if-eqz v4, :cond_47

    const-string v4, "CancelPrepareTakePictureRequest : Stop torch flash."

    invoke-static {v5, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, v3}, Lcom/sec/android/app/camera/engine/core/request/CancelPrepareTakePictureRequest;->stopTorchFlash(Lcom/sec/android/app/camera/engine/interfaces/Engine$MakerSettings;)V

    invoke-interface {v2}, Lcom/samsung/android/camera/core2/MakerInterface;->applySettings()I
    ...
    invoke-interface {v3}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->notifyCurrentLightCondition()V
    ...
    invoke-interface {v2, v3, v3}, Lcom/samsung/android/camera/core2/MakerInterface;->setAfAndAePreCaptureTrigger(II)V
    :try_end_4b
    .catch Lcom/samsung/android/camera/core2/exception/CamAccessException; {:try_start_28 .. :try_end_4b} :catch_45
    .catch Ljava/lang/IllegalStateException; {:try_start_28 .. :try_end_4b} :catch_43
    .catch Lcom/samsung/android/camera/core2/exception/InvalidOperationException; {:try_start_28 .. :try_end_4b} :catch_43
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_28 .. :try_end_4b} :catch_43
    .catchall {:try_start_28 .. :try_end_4b} :catchall_41
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/core/request/Request;->discard()V
    :try_end_8f
    .catchall {:try_start_51 .. :try_end_8f} :catchall_41
