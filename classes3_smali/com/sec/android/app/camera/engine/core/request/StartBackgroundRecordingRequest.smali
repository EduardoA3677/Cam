.class Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;
...
.method public static synthetic a(Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;)V
    .registers 1

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;->lambda$execute$1()V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;)V
    .registers 1

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;->lambda$execute$0()V
...
.method private synthetic lambda$execute$0()V
    ...
    invoke-interface {p0, v0}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine$RecordingEventListener;->onRecordingFailed(I)V
...
.method private synthetic lambda$execute$1()V
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine$RecordingEventListener;->onRecordingStarted()V
...
.method public execute()V
    ...
    invoke-interface {v4}, Lcom/sec/android/app/camera/engine/interfaces/InternalRecordingManager;->startRecording()V
    :try_end_16
    .catch Ljava/lang/IllegalStateException; {:try_start_11 .. :try_end_16} :catch_34
    .catch Lcom/samsung/android/camera/core2/exception/InvalidOperationException; {:try_start_11 .. :try_end_16} :catch_32
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/core/request/m;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/camera/engine/core/request/m;-><init>(Lcom/sec/android/app/camera/engine/core/request/StartBackgroundRecordingRequest;I)V
    ...
    :try_end_56
    .catchall {:try_start_36 .. :try_end_56} :catchall_30
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/core/request/Request;->discard()V
    :try_end_86
    .catchall {:try_start_60 .. :try_end_86} :catchall_30
