.class Lcom/sec/android/app/camera/engine/core/request/WaitCaptureAvailableRequest;
...
.method public static synthetic a(Lcom/sec/android/app/camera/engine/core/request/WaitCaptureAvailableRequest;)V
    .registers 1

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/core/request/WaitCaptureAvailableRequest;->lambda$onTimeout$0()V
...
.method public execute()V
    ...
    invoke-interface {v4}, Lcom/sec/android/app/camera/engine/interfaces/InternalCaptureManager;->countDownCaptureAvailableRequestLatch()V
    ...
    const-string v4, "WaitCaptureAvailableRequest : Stop torch flash."

    invoke-static {v0, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, v3}, Lcom/sec/android/app/camera/engine/core/request/WaitCaptureAvailableRequest;->stopTorchFlash(Lcom/sec/android/app/camera/engine/interfaces/Engine$MakerSettings;)V
    ...
    invoke-interface {v3}, Lcom/samsung/android/camera/core2/MakerInterface;->applySettings()I
    ...
    invoke-interface {v3}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->isCancelAfRequiredAfterTakingPicture()Z

    move-result v3

    if-eqz v3, :cond_4f

    const-string v3, "WaitCaptureAvailableRequest : Cancel auto focus."
    ...
    invoke-interface {v3, v4}, Lcom/samsung/android/camera/core2/MakerInterface;->setAfTrigger(I)V

    iget-object v3, p0, Lcom/sec/android/app/camera/engine/core/request/Request;->mEngine:Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;

    sget-object v4, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine$AeAfTriggerState;->CANCEL_REQUESTED:Lcom/sec/android/app/camera/engine/interfaces/InternalEngine$AeAfTriggerState;

    invoke-interface {v3, v4}, Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;->changeAfTriggerState(Lcom/sec/android/app/camera/engine/interfaces/InternalEngine$AeAfTriggerState;)V
    :try_end_4f
    .catch Lcom/samsung/android/camera/core2/exception/CamAccessException; {:try_start_c .. :try_end_4f} :catch_2f
    .catch Ljava/lang/IllegalStateException; {:try_start_c .. :try_end_4f} :catch_2d
    .catch Lcom/samsung/android/camera/core2/exception/InvalidOperationException; {:try_start_c .. :try_end_4f} :catch_2d
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_c .. :try_end_4f} :catch_2d
    .catchall {:try_start_c .. :try_end_4f} :catchall_2b
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/core/request/Request;->discard()V
    :try_end_93
    .catchall {:try_start_55 .. :try_end_93} :catchall_2b
