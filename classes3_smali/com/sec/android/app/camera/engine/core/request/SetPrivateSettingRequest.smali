.class Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;
...
# direct methods
.method public constructor <init>(Lcom/sec/android/app/camera/engine/core/interfaces/MakerProvider;Lcom/sec/android/app/camera/engine/interfaces/InternalEngine;Lcom/sec/android/app/camera/engine/interfaces/RequestId;Lcom/sec/android/app/camera/engine/core/MakerPrivateSetting;)V
    .registers 5
    ...
    invoke-virtual {p4}, Lcom/sec/android/app/camera/engine/core/MakerPrivateSetting;->getKey()Lcom/samsung/android/camera/core2/MakerPrivateKey;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mPrivateKey:Lcom/samsung/android/camera/core2/MakerPrivateKey;

    invoke-virtual {p4}, Lcom/sec/android/app/camera/engine/core/MakerPrivateSetting;->getValue()Ljava/lang/Object;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mValue:Ljava/lang/Object;
...
.method private isValidKey(Lcom/samsung/android/camera/core2/MakerInterface;)Z
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mPrivateKey:Lcom/samsung/android/camera/core2/MakerPrivateKey;
...
.method public execute()V
    ...
    :try_start_a
    invoke-direct {p0, v2}, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->isValidKey(Lcom/samsung/android/camera/core2/MakerInterface;)Z
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mPrivateKey:Lcom/samsung/android/camera/core2/MakerPrivateKey;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mValue:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mValue:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/core/request/SetPrivateSettingRequest;->mPrivateKey:Lcom/samsung/android/camera/core2/MakerPrivateKey;
    ...
    :try_end_4e
    .catch Ljava/lang/IllegalStateException; {:try_start_a .. :try_end_4e} :catch_33
    .catch Lcom/samsung/android/camera/core2/exception/InvalidOperationException; {:try_start_a .. :try_end_4e} :catch_33
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_a .. :try_end_4e} :catch_33
