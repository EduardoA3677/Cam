...
.method private completeTakePictureSequence(I)V
    ...
    new-instance v0, Lcom/sec/android/app/camera/engine/capture/q;

    const/4 v1, 0x2

    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/camera/engine/capture/q;-><init>(Lcom/sec/android/app/camera/engine/capture/SingleCaptureController;I)V
...
.method private isMaxPostProcessingCountReached(I)Z
    ...
    :cond_30
    sget-object p0, Lx1/h;->MAX_POST_PROCESSING_COUNT_FOR_BACK_AI_HIGH_RESOLUTION:Lx1/h;
    ...
    :cond_37
    sget-object p0, Lx1/c;->SUPPORT_FUSION_HIGH_RESOLUTION:Lx1/c;
    ...
    sget-object p0, Lx1/h;->MAX_POST_PROCESSING_COUNT_FOR_BACK_HIGH_RESOLUTION:Lx1/h;
...
.method private synthetic lambda$onShutter$3(Lcom/sec/android/app/camera/engine/interfaces/CaptureInfo;)V
    ...
    new-instance p1, Lcom/sec/android/app/camera/engine/z;

    const/16 v0, 0xa

    invoke-direct {p1, v0}, Lcom/sec/android/app/camera/engine/z;-><init>(I)V
...
.method private takePicture(Lcom/sec/android/app/camera/engine/interfaces/CaptureInfo;)V
    ...
    sget-object v0, LK2/d;->TAKE_PICTURE:LK2/d;
    ...
    sget-object v0, LK2/d;->TAKE_RAW_PICTURE:LK2/d;
...
.method private waitCancelActionExecuted()V
    ...
    move-result p0
    :try_end_12
    .catch Ljava/lang/InterruptedException; {:try_start_8 .. :try_end_12} :catch_19
...
.method private waitCaptureAvailableRequestLatch()V
    ...
    :try_end_24
    .catch Ljava/lang/InterruptedException; {:try_start_5 .. :try_end_24} :catch_25
...
.method private waitShutterCallbackLatch()V
    ...
    invoke-static {v0, v1, p0}, LG2/u;->z(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private waitTakePictureRequestLatch()V
    ...
    :try_end_1d
    .catch Ljava/lang/InterruptedException; {:try_start_8 .. :try_end_1d} :catch_1e
...
.method public handleTakePictureStopped()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/camera/engine/capture/q;-><init>(Lcom/sec/android/app/camera/engine/capture/SingleCaptureController;I)V
...
.method public onCaptureAvailable(ILjava/lang/Long;Lcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p1, p0, p3}, Landroidx/compose/foundation/text/a;->u(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, p3}, Landroidx/compose/foundation/text/a;->u(ILjava/lang/String;Ljava/lang/String;)V
...
.method public onDraftPostProcessingPictureTaken(ILandroid/net/Uri;Ljava/io/File;Lcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p1, p4, v0}, Lb/a;->A(ILjava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/sec/android/app/camera/engine/capture/q;

    const/4 p3, 0x1

    invoke-direct {p2, p0, p3}, Lcom/sec/android/app/camera/engine/capture/q;-><init>(Lcom/sec/android/app/camera/engine/capture/SingleCaptureController;I)V
...
.method public onPostProcessingError(ILcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p1, p0, p2}, Lb/a;->A(ILjava/lang/String;Ljava/lang/String;)V
...
.method public onPostProcessorSequenceCountChanged(IILcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p1, p2, p3}, LG2/u;->v(ILjava/lang/String;Ljava/lang/String;)V
...
.method public onProcessingFrameCollected(IILcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p2, p1, p0, p3, v0}, LG2/u;->u(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onProgress(ILcom/samsung/android/camera/core2/CamDevice;)V
    ...
    invoke-static {p1, p0, p2}, LG2/u;->v(ILjava/lang/String;Ljava/lang/String;)V
