...
.method public static synthetic a(Lcom/samsung/android/camera/core2/callback/VideoMetadataCallback$VideoMetadata;Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)V
    .registers 2

    invoke-static {p0, p1}, Lcom/sec/android/app/camera/engine/recording/session/RecordingSessionManagerImpl;->lambda$setVideoMetadata$8(Lcom/samsung/android/camera/core2/callback/VideoMetadataCallback$VideoMetadata;Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)V
...
.method public static synthetic c(Landroid/media/AudioDeviceInfo;Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)V
    .registers 2
...
.method public static synthetic d()Ljava/lang/RuntimeException;
    .registers 1
...
.method public static synthetic g(Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)Z
    .registers 1
...
.method private getMaxRecordingDuration(ILcom/sec/android/app/camera/engine/recording/session/RecordingSession;)I
    ...
    invoke-static {v0, p0, p1}, Landroidx/concurrent/futures/a;->s(ILjava/lang/String;Ljava/lang/String;)V
...
.method private getRecordingSession(Lcom/sec/android/app/camera/interfaces/CameraId;)Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/recording/session/k;

    invoke-direct {v1, p1}, Lcom/sec/android/app/camera/engine/recording/session/k;-><init>(Lcom/sec/android/app/camera/interfaces/CameraId;)V
...
.method public static synthetic h(Lcom/sec/android/app/camera/engine/recording/session/RecordingSessionManagerImpl;Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)V
    .registers 2
...
.method private isUsbStorageAvailable()Z
    ...
    invoke-static {p0, v0}, Lcom/sec/android/app/camera/util/StorageProvider;->isAvailable(Landroid/content/Context;I)Z
...
.method private static synthetic lambda$setVideoMetadata$7(ILcom/sec/android/app/camera/engine/recording/session/RecordingSession;)Z
    .registers 2
...
.method private static synthetic lambda$setVideoMetadata$8(Lcom/samsung/android/camera/core2/callback/VideoMetadataCallback$VideoMetadata;Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;)V
    .registers 2

    invoke-virtual {p1, p0}, Lcom/sec/android/app/camera/engine/recording/session/RecordingSession;->setVideoMetadataInfo(Lcom/samsung/android/camera/core2/callback/VideoMetadataCallback$VideoMetadata;)V
...
.method public static synthetic n(ILcom/sec/android/app/camera/engine/recording/session/RecordingSession;)Z
    ...
    invoke-static {p0, p1}, Lcom/sec/android/app/camera/engine/recording/session/RecordingSessionManagerImpl;->lambda$setVideoMetadata$7(ILcom/sec/android/app/camera/engine/recording/session/RecordingSession;)Z
...
.method public prepareRecording()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/camera/engine/recording/session/j;-><init>(Lcom/sec/android/app/camera/engine/recording/session/RecordingSessionManagerImpl;I)V
...
.method public setVideoMetadata(ILcom/samsung/android/camera/core2/callback/VideoMetadataCallback$VideoMetadata;)V
    ...
    new-instance v0, Lcom/sec/android/app/camera/engine/recording/session/i;

    invoke-direct {v0, p1}, Lcom/sec/android/app/camera/engine/recording/session/i;-><init>(I)V
