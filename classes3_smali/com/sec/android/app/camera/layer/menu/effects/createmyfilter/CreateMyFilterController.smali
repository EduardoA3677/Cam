...
# instance fields
.field private final mCompositeDisposable:Lj3/a;
...
.method public constructor <init>(Landroid/content/Context;Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/CreateMyFilterController$CreateMyFilterEventListener;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/CreateMyFilterController;->mCompositeDisposable:Lj3/a;
...
.method private getBitmapInfo(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, p0}, Lw3/N;->F(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v2
    :try_end_78
    .catch Ljava/io/IOException; {:try_start_50 .. :try_end_78} :catch_98
...
.method private isNeedToRotateImageThumbnail(Ljava/lang/String;)Z
    ...
    sget-object p0, Lx1/c;->SUPPORT_PRO_RAW_ONLY_PICTURE_FORMAT:Lx1/c;
...
.method private updateCreateMyFilterInfo(Ljava/lang/String;Landroid/graphics/Rect;Lcom/sec/android/app/camera/layer/menu/effects/data/MyFilterSaveData;Landroid/graphics/Bitmap;)V
    ...
    :cond_10
    iget-object p2, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/CreateMyFilterController;->mCompositeDisposable:Lj3/a;
    ...
    invoke-direct {p1, p4, v1}, Ll4/f;-><init>(Ljava/lang/Object;I)V

    sget-object p4, Lt3/f;->a:Lh3/c;

    const-string/jumbo v1, "scheduler is null"

    invoke-static {p4, v1}, Ln3/b;->a(Ljava/lang/Object;Ljava/lang/String;)V

    sget-object v1, Li3/b;->a:Li3/e;
    ...
    invoke-direct {p0, v2, p3}, Lo3/a;-><init>(Ll3/a;Ll3/a;)V

    :try_start_38
    new-instance p3, Lp3/a;

    invoke-direct {p3, p0, v1}, Lp3/a;-><init>(Lh3/d;Li3/e;)V
    :try_end_3d
    .catch Ljava/lang/NullPointerException; {:try_start_38 .. :try_end_3d} :catch_71
    .catchall {:try_start_38 .. :try_end_3d} :catchall_64

    :try_start_3d
    new-instance v1, Lp3/b;

    invoke-direct {v1, p3, p1}, Lp3/b;-><init>(Lh3/d;Ll4/f;)V

    invoke-interface {p3, v1}, Lh3/d;->b(Lj3/b;)V

    invoke-virtual {p4, v1}, Lh3/c;->b(Ljava/lang/Runnable;)Lj3/b;

    move-result-object p1

    iget-object p3, v1, Lp3/b;->b:Lj3/c;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {p3, p1}, Lm3/b;->b(Ljava/util/concurrent/atomic/AtomicReference;Lj3/b;)Z
    :try_end_51
    .catch Ljava/lang/NullPointerException; {:try_start_3d .. :try_end_51} :catch_62
    .catchall {:try_start_3d .. :try_end_51} :catchall_55

    invoke-virtual {p2, p0}, Lj3/a;->b(Lj3/b;)Z
    ...
    throw p0
    :try_end_64
    .catch Ljava/lang/NullPointerException; {:try_start_56 .. :try_end_64} :catch_71
...
.method public clear()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/CreateMyFilterController;->mCompositeDisposable:Lj3/a;
...
.method public stop()V
    ...
    :cond_18
    iget-object v1, v0, Lj3/a;->a:Lr3/c;

    const/4 v2, 0x0

    iput-object v2, v0, Lj3/a;->a:Lr3/c;

    monitor-exit v0
    :try_end_1e
    .catchall {:try_start_10 .. :try_end_1e} :catchall_16

    invoke-static {v1}, Lj3/a;->d(Lr3/c;)V
