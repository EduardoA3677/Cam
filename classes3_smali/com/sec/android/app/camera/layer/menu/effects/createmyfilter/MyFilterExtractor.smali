...
.method private cropImage()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/MyFilterExtractor;->mCropRect:Landroid/graphics/Rect;
    ...
    invoke-static {v5, v1}, Li0/b;->l(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Rect;

    move-result-object v1

    if-eqz v1, :cond_86

    invoke-direct {p0, v1}, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/MyFilterExtractor;->correctCropRect(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/MyFilterExtractor;->mCropRect:Landroid/graphics/Rect;
    ...
    :cond_10c
    iget-object v1, p0, Lcom/sec/android/app/camera/layer/menu/effects/createmyfilter/MyFilterExtractor;->mHandler:Landroid/os/Handler;
...
.method private extractMyFilter()Lcom/sec/android/app/camera/layer/menu/effects/data/MyFilterSaveData;
    ...
    :try_end_5d
    .catch Ljava/lang/NullPointerException; {:try_start_28 .. :try_end_5d} :catch_56
