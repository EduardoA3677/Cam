...
.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuContract$View;Lcom/sec/android/app/camera/layer/menu/effects/manager/LiveThumbnailPreviewManager;Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mFilterListData:LQ2/a;
...
.method public static synthetic a(LC2/f;)V
    ...
    invoke-static {p0}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->lambda$initializeSelectedItem$0(LC2/f;)V
...
.method public static synthetic b(LC2/f;)V
    .registers 1

    invoke-static {p0}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->lambda$selectNextItem$1(LC2/f;)V
...
.method private deleteItem()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
    ...
    :cond_5
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->isServiceTerminatedFilter(LC2/f;)Z
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->selectNextItem(LC2/f;)V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
...
.method private handleBackInvoked()Z
    ...
    :cond_1c
    invoke-super {p0}, Lcom/sec/android/app/camera/layer/menu/effects/abstraction/AbstractFilterPresenter;->onBackInvoked()Z
...
.method private initializeSelectedItem()V
    ...
    new-instance v4, Lcom/sec/android/app/camera/layer/keyscreen/zoom/widget/d;

    const/4 v5, 0x2

    invoke-direct {v4, v5}, Lcom/sec/android/app/camera/layer/keyscreen/zoom/widget/d;-><init>(I)V

    invoke-virtual {v3, v4}, Ljava/util/ArrayList;->forEach(Ljava/util/function/Consumer;)V

    const/4 v3, 0x1

    iput-boolean v3, v2, LC2/f;->b:Z
    ...
    invoke-virtual {v2}, LC2/f;->f()Ljava/lang/String;
...
.method private static lambda$initializeSelectedItem$0(LC2/f;)V
    .registers 2
...
.method private static lambda$selectNextItem$1(LC2/f;)V
    .registers 2
...
.method private onDeleteButtonClicked(Lcom/sec/android/app/camera/interfaces/CameraDialogManager$DialogId;)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
...
.method private refreshFilterData(Z)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mFilterListData:LQ2/a;
...
.method private selectNextItem(LC2/f;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->findDeleteAndNextItem(LC2/f;)I
...
.method private updateAllFilterList()V
    ...
    iget-object v3, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mFilterListData:LQ2/a;
...
.method public onBackInvoked()Z
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->handleBackInvoked()Z
...
.method public onItemDeleteClick(I)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/layer/menu/effects/filter/FilterMenuPresenter;->mDeleteItem:LC2/f;
