...
.method private static synthetic $values()[Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;
    ...
    sget-object v0, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_SHUTTER_MID:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v1, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_SHUTTER:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->SLIDER:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v4, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->QR_CODE_DETECTED:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v5, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_SHUTTER_CALLBACK:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v6, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_LIST_SCROLLING:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v7, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->ZOOM_SLIDER_LARGE_TICK:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v8, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->LEVELMETER_AND_INCLINOMETER:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v9, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_QUICK_SETTING_STABILIZATION:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v10, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->CAMERA_QUICK_SETTING_MOTION_PHOTO:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v11, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->FLOATING_SHUTTER_SHOW_HIDE:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v12, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->DRAG_AND_DROP_FLOATING:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v13, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->FILTER_SLIDER_TICK:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v14, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->FILTER_SLIDER_DEFAULT_TICK:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v15, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->EXPOSURE_SLIDER_LARGE_TICK:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    sget-object v16, Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;->FOOD_COLOR_TUNE_DEFAULT_VALUE:Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;

    filled-new-array/range {v0 .. v16}, [Lcom/sec/android/app/camera/interfaces/CameraContext$HapticPattern;
...
.method static constructor <clinit>()V
    ...
    const-string v5, "CAMERA_QUICK_SETTING_STABILIZATION"
    ...
    const-string v5, "CAMERA_QUICK_SETTING_MOTION_PHOTO"
    ...
    const-string v5, "DRAG_AND_DROP_FLOATING"
