...
.method public static g(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/sec/android/app/camera/cropper/util/g;->b:Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Lcom/sec/android/app/camera/cropper/util/l;->e(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p0

    invoke-static {p0, v2}, Lcom/sec/android/app/camera/cropper/util/l;->e(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_b7
    invoke-static {p0, v6}, Lcom/sec/android/app/camera/cropper/util/l;->e(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_f0
    invoke-static {v0, v1}, Lcom/sec/android/app/camera/cropper/util/l;->b(Ljava/io/File;Ljava/io/File;)Z
...
.method public static h(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)Z
    .registers 8
    ...
    invoke-static {v2, p1, p2}, Landroidx/concurrent/futures/a;->n(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_35
    .catch Ljava/io/IOException; {:try_start_30 .. :try_end_35} :catch_55
    ...
    :try_end_3f
    .catchall {:try_start_35 .. :try_end_3f} :catchall_57

    :try_start_3f
    invoke-virtual {p1}, Ljava/io/FileOutputStream;->close()V
    :try_end_42
    .catch Ljava/io/IOException; {:try_start_3f .. :try_end_42} :catch_55

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide p0

    const-string/jumbo p2, "writeImage : End["
    ...
    throw p0
    :try_end_61
    .catch Ljava/io/IOException; {:try_start_5d .. :try_end_61} :catch_55

    :goto_61
    new-instance p1, Ljava/lang/StringBuilder;

    const-string/jumbo p2, "writeImage : "
