...
.field private static final mStatusMultipleCustomKeyMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sget-object v4, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_SUPER_SLOW_MOTION:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v5, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_SLOW_MOTION:Lcom/sec/android/app/camera/interfaces/CommandId;
    ...
    sget-object v8, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_HYPER_LAPSE:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v9, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_PRO_VIDEO:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v10, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_PORTRAIT:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v11, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_PHOTO:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v12, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_VIDEO:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v13, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_PORTRAIT_VIDEO:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v14, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_DUAL_RECORDING:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v15, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_MULTI_RECORDING:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v16, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_DUAL_RECORDING_V2:Lcom/sec/android/app/camera/interfaces/CommandId;

    sget-object v17, Lcom/sec/android/app/camera/interfaces/CommandId;->SHOOTING_MODE_BIXBY_VISION:Lcom/sec/android/app/camera/interfaces/CommandId;

    filled-new-array/range {v0 .. v17}, [Lcom/sec/android/app/camera/interfaces/CommandId;
    ...
    sput-object v1, Lcom/sec/android/app/camera/logging/SaLogStatusKeyMap;->mStatusCustomKeyList:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    sput-object v2, Lcom/sec/android/app/camera/logging/SaLogStatusKeyMap;->mStatusMultipleCustomKeyMap:Ljava/util/HashMap;

    const-string v3, "number_of_mode_list"

    const-string v4, "number_of_widget_list"

    const-string v5, "back_camera_picture_ratio"

    const-string v6, "front_camera_picture_ratio"

    invoke-static {v1, v3, v4, v5, v6}, Lb/a;->y(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v3, "watermark_model_name_custom"

    const-string/jumbo v4, "zoom_lens_settings"

    const-string/jumbo v5, "pref_key_wine_first_time_use"

    const-string v6, "hdr_videos_settings"
    ...
    const-string v3, "log_video_settings"
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->PICTURE_FORMAT_INDICATOR:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;

    filled-new-array {v1, v3}, [Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    const-string/jumbo v3, "picture_format_settings"
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->WATERMARK_INDICATOR:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    const-string/jumbo v3, "watermark_settings"
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->RECORDING_360_BT_MIC_INDICATOR:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    const-string/jumbo v3, "recording_360_bt_mic_settings"
    ...
    sget-object v1, Lx1/c;->SUPPORT_CAMERA_FLASH:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_HYPER_LAPSE_ASTROGRAPHY:Lx1/c;
    ...
    sget-object v2, Lx1/c;->SUPPORT_BACK_VIDEO_BEAUTY:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_COMPOSITION_GUIDE:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_DOCUMENT_SCAN_OBJECT_REMOVAL:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_HEIF_FORMAT:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_MOTION_PHOTO:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_POWER_KEY_QUICK_LAUNCH:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_OBJECT_TRACKING_AF:Lx1/c;
    ...
    :cond_301
    sget-object v1, Lx1/c;->SUPPORT_CAMCORDER_ANTI_SHAKE:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_CAMCORDER_FRONT_ANTI_SHAKE:Lx1/c;
    ...
    sget-object v1, Lx1/c;->SUPPORT_MOTION_PHOTO_CAPTURE_MODE:Lx1/c;
...
.method public static getStatusMultipleCustomKeyArray()[Ljava/lang/String;
    .registers 2

    sget-object v0, Lcom/sec/android/app/camera/logging/SaLogStatusKeyMap;->mStatusMultipleCustomKeyMap:Ljava/util/HashMap;
...
.method public static getStatusMultipleCustomKeyMap()Ljava/util/HashMap;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
