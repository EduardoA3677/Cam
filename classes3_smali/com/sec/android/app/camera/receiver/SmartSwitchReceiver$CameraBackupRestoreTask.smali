...
.method private copyFileToFileUri(Ljava/io/File;Landroid/net/Uri;)I
    ...
    :try_end_12
    .catch Ljava/io/FileNotFoundException; {:try_start_3 .. :try_end_12} :catch_2a
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_12} :catch_24
    ...
    :try_end_19
    .catch Ljava/io/FileNotFoundException; {:try_start_16 .. :try_end_19} :catch_2a
    ...
    throw p0
    :try_end_24
    .catch Ljava/io/FileNotFoundException; {:try_start_20 .. :try_end_24} :catch_2a
...
.method private copyFileToStream(Ljava/io/File;Ljava/io/OutputStream;)Z
    ...
    :try_end_8
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_8} :catch_40
    ...
    :try_end_1f
    .catch Ljava/io/IOException; {:try_start_1c .. :try_end_1f} :catch_40
    ...
    throw p0
    :try_end_2e
    .catchall {:try_start_2a .. :try_end_2e} :catchall_17
    ...
    throw p0
    :try_end_37
    .catchall {:try_start_33 .. :try_end_37} :catchall_20
...
.method private copyStream(Ljava/io/InputStream;Ljava/io/OutputStream;)Z
    ...
    throw p0
    :try_end_39
    .catchall {:try_start_35 .. :try_end_39} :catchall_28
...
.method private copyUriToFile(Landroid/content/Context;Landroid/net/Uri;Ljava/io/File;)Z
    ...
    :try_end_1a
    .catchall {:try_start_15 .. :try_end_1a} :catchall_31
    ...
    invoke-virtual {p1}, Ljava/io/InputStream;->close()V
    :try_end_2c
    .catch Ljava/io/IOException; {:try_start_29 .. :try_end_2c} :catch_5a
    ...
    throw p0
    :try_end_46
    .catchall {:try_start_42 .. :try_end_46} :catchall_2f
    ...
    throw p0
    :try_end_4f
    .catchall {:try_start_4b .. :try_end_4f} :catchall_2d
...
.method private createFile(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    move-result-object p0
    :try_end_c
    .catch Ljava/io/FileNotFoundException; {:try_start_8 .. :try_end_c} :catch_13
...
.method private createXmlFile(Ljava/io/File;)I
    ...
    .catch Ljava/lang/IllegalStateException; {:try_start_6 .. :try_end_b} :catch_4e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6 .. :try_end_b} :catch_4e
    ...
    move-result-wide v1
    :try_end_40
    .catchall {:try_start_b .. :try_end_40} :catchall_31
    ...
    :try_end_44
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_44} :catch_57
    .catch Ljava/lang/IllegalStateException; {:try_start_41 .. :try_end_44} :catch_4e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_41 .. :try_end_44} :catch_4e
    ...
    throw p1
    :try_end_4e
    .catch Ljava/io/IOException; {:try_start_4a .. :try_end_4e} :catch_57
    .catch Ljava/lang/IllegalStateException; {:try_start_4a .. :try_end_4e} :catch_4e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4a .. :try_end_4e} :catch_4e
...
.method private getDataFromUri(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    move-result-object p1
    :try_end_c
    .catch Ljava/io/FileNotFoundException; {:try_start_4 .. :try_end_c} :catch_41
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_c} :catch_3b
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_c} :catch_35
    ...
    invoke-virtual {p1}, Ljava/io/InputStream;->close()V
    :try_end_1d
    .catch Ljava/io/FileNotFoundException; {:try_start_1a .. :try_end_1d} :catch_41
    ...
    throw p0
    :try_end_35
    .catch Ljava/io/FileNotFoundException; {:try_start_31 .. :try_end_35} :catch_41
    .catch Ljava/io/IOException; {:try_start_31 .. :try_end_35} :catch_3b
...
.method private getPathUris()Ljava/util/List;
    ...
    move-result v3
    :try_end_33
    .catch Ljava/lang/Exception; {:try_start_17 .. :try_end_33} :catch_4d
    ...
    :try_end_4a
    .catch Ljava/lang/Exception; {:try_start_45 .. :try_end_4a} :catch_4d
...
.method private getStreamData(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    :try_end_d
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_d} :catch_4e
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_d} :catch_4c
    ...
    :try_end_2c
    .catchall {:try_start_17 .. :try_end_2c} :catchall_26
    ...
    throw p1
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_48 .. :try_end_4c} :catch_56
...
.method private insertMyFilter(Ljava/lang/String;[B[B[B[B)V
    ...
    :try_end_7e
    .catch Ljava/lang/RuntimeException; {:try_start_71 .. :try_end_7e} :catch_123
    ...
    sparse-switch p5, :sswitch_data_142
    ...
    :goto_d1
    packed-switch p4, :pswitch_data_154
    ...
    :sswitch_data_142
    .sparse-switch
        -0x21caecfe -> :sswitch_c7
        -0xdbd042e -> :sswitch_bb
        0x132cc574 -> :sswitch_af
        0x211d92aa -> :sswitch_a4
    .end sparse-switch
...
.method private moveUrisToDir(Landroid/net/Uri;Ljava/util/Collection;Ljava/io/File;)I
    ...
    move-result v3
    :try_end_84
    .catch Ljava/io/FileNotFoundException; {:try_start_7a .. :try_end_84} :catch_85
...
.method private readByteFromFile(Ljava/io/File;)[B
    ...
    :try_end_f
    .catch Ljava/io/FileNotFoundException; {:try_start_a .. :try_end_f} :catch_31
    ...
    throw p1
    :try_end_2a
    .catch Ljava/io/FileNotFoundException; {:try_start_26 .. :try_end_2a} :catch_31
...
.method private readXmlFile(Ljava/io/File;)I
    ...
    :try_end_b
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_b} :catch_9b
    .catch Ljava/lang/IllegalStateException; {:try_start_6 .. :try_end_b} :catch_92
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6 .. :try_end_b} :catch_89
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_6 .. :try_end_b} :catch_80
    ...
    :try_end_6a
    .catchall {:try_start_b .. :try_end_6a} :catchall_53

    :try_start_6a
    invoke-virtual {v5}, Ljava/io/FileInputStream;->close()V
    :try_end_6d
    .catch Ljava/io/IOException; {:try_start_6a .. :try_end_6d} :catch_9b
    .catch Ljava/lang/IllegalStateException; {:try_start_6a .. :try_end_6d} :catch_92
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6a .. :try_end_6d} :catch_89
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_6a .. :try_end_6d} :catch_80
    ...
    move-result-wide v6
    :try_end_72
    .catchall {:try_start_6e .. :try_end_72} :catchall_53
    ...
    invoke-virtual {v5}, Ljava/io/FileInputStream;->close()V
    :try_end_76
    .catch Ljava/io/IOException; {:try_start_73 .. :try_end_76} :catch_9b
    .catch Ljava/lang/IllegalStateException; {:try_start_73 .. :try_end_76} :catch_92
    .catch Ljava/lang/IllegalArgumentException; {:try_start_73 .. :try_end_76} :catch_89
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_73 .. :try_end_76} :catch_80
    ...
    throw p1
    :try_end_80
    .catch Ljava/io/IOException; {:try_start_7c .. :try_end_80} :catch_9b
    .catch Ljava/lang/IllegalStateException; {:try_start_7c .. :try_end_80} :catch_92
    .catch Ljava/lang/IllegalArgumentException; {:try_start_7c .. :try_end_80} :catch_89
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7c .. :try_end_80} :catch_80
...
.method private restoreCameraSettings()Ljava/lang/Integer;
    ...
    move-result-object p0
    :try_end_8a
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_8a} :catch_8b
