...
.method private receivingLocationUpdates()V
    ...
    :try_end_4b
    .catch Ljava/lang/SecurityException; {:try_start_3b .. :try_end_4b} :catch_50
    .catch Ljava/lang/IllegalArgumentException; {:try_start_3b .. :try_end_4b} :catch_4c
    ...
    :try_end_63
    .catch Ljava/lang/SecurityException; {:try_start_53 .. :try_end_63} :catch_68
    .catch Ljava/lang/IllegalArgumentException; {:try_start_53 .. :try_end_63} :catch_64
...
.method public static requestHighAccuracyLocationMode(Landroid/app/Activity;)V
    ...
    invoke-direct/range {v3 .. v24}, Lcom/google/android/gms/location/LocationRequest;-><init>(IJJJJJIFZJIIZLandroid/os/WorkSource;Lp0/f;)V
    ...
    sget-object v4, Lp0/a;->i:LA4/r;

    sget-object v5, Le0/b;->a:Le0/a;

    sget-object v6, Le0/e;->b:Le0/e;

    invoke-direct {v3, v1, v4, v5, v6}, Le0/f;-><init>(Landroid/content/Context;LA4/r;Le0/b;Le0/e;)V
    ...
    invoke-direct {v1, v2, v4, v5}, Lr0/b;-><init>(Ljava/util/ArrayList;ZZ)V
    ...
    invoke-direct {v6, v1, v7}, Ll4/f;-><init>(Ljava/lang/Object;I)V

    iput-object v6, v2, LA4/r;->b:Ljava/lang/Object;

    const/16 v1, 0x97a

    new-instance v6, LC0/i;

    iget-object v7, v2, LA4/r;->c:Ljava/lang/Object;

    check-cast v7, [Ld0/c;

    invoke-direct {v6, v2, v7, v4, v1}, LC0/i;-><init>(LA4/r;[Ld0/c;ZI)V

    invoke-virtual {v3, v5, v6}, Le0/f;->b(ILC0/i;)Lu0/g;
    ...
    sget-object v4, Lu0/d;->a:Lf0/j;

    invoke-direct {v3, v4, v2}, Lu0/e;-><init>(Lf0/j;Lu0/b;)V

    iget-object v2, v1, Lu0/g;->b:Ln2/a;

    invoke-virtual {v2, v3}, Ln2/a;->f(Lu0/e;)V
    ...
    sget-object v4, Lf0/y;->d:Ljava/util/WeakHashMap;
    ...
    check-cast v5, Lf0/y;
    :try_end_d3
    .catch Ljava/lang/ClassCastException; {:try_start_c9 .. :try_end_d3} :catch_f8
    ...
    sget-object v4, Lf0/x;->d:Ljava/util/WeakHashMap;
    ...
    check-cast v5, Lf0/x;
    :try_end_11f
    .catch Ljava/lang/ClassCastException; {:try_start_115 .. :try_end_11f} :catch_170
    ...
    const-class v2, Lu0/f;

    invoke-interface {v5, v2, v0}, Lf0/e;->b(Ljava/lang/Class;Ljava/lang/String;)Lcom/google/android/gms/common/api/internal/LifecycleCallback;
    ...
    invoke-direct {v0, v5}, Lu0/f;-><init>(Lf0/e;)V
    ...
    monitor-exit v5
    :try_end_159
    .catchall {:try_start_144 .. :try_end_159} :catchall_156

    iget-object v2, v0, Lu0/f;->b:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_15c
    iget-object v0, v0, Lu0/f;->b:Ljava/util/ArrayList;
    ...
    monitor-exit v2
    :try_end_167
    .catchall {:try_start_15c .. :try_end_167} :catchall_16b

    invoke-virtual {v1}, Lu0/g;->e()V
    ...
    monitor-exit v5
    :try_end_16f
    .catchall {:try_start_16e .. :try_end_16f} :catchall_156
...
.method private stopHandler()V
    ...
    invoke-direct {v2, v3}, Lcom/sec/android/app/camera/layer/keyscreen/zoom/widget/d;-><init>(I)V
...
.method public getCurrentLocation()Landroid/location/Location;
    ...
    invoke-static {p0, v2, v1}, LG2/u;->B(Ljava/lang/StringBuilder;ZLjava/lang/String;)V
