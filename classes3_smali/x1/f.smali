...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lx1/f;->b:Ljava/util/concurrent/CountDownLatch;

    new-instance v3, Ljava/util/concurrent/CountDownLatch;

    invoke-direct {v3, v2}, Ljava/util/concurrent/CountDownLatch;-><init>(I)V

    sput-object v3, Lx1/f;->c:Ljava/util/concurrent/CountDownLatch;
    ...
    :try_start_19
    const-string v4, "/system/cameradata/"
    ...
    const-string v1, "loadFeature : already completed"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_2c
    .catchall {:try_start_19 .. :try_end_2c} :catchall_2f
    ...
    const-string v5, "loadFeature : start"
    ...
    move-result-object v0
    :try_end_7e
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_39 .. :try_end_7e} :catch_112
    .catchall {:try_start_39 .. :try_end_7e} :catchall_2f
    ...
    :try_end_83
    .catch Ljava/io/IOException; {:try_start_7e .. :try_end_83} :catch_114
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7e .. :try_end_83} :catch_112
    .catchall {:try_start_7e .. :try_end_83} :catchall_2f
    ...
    move-result v1
    :try_end_c5
    .catch Ljava/io/IOException; {:try_start_c1 .. :try_end_c5} :catch_c6
    .catchall {:try_start_c1 .. :try_end_c5} :catchall_ba
    ...
    throw v1
    :try_end_d1
    .catchall {:try_start_c7 .. :try_end_d1} :catchall_ba

    :cond_d1
    :try_start_d1
    invoke-virtual {v5}, Ljava/io/FileInputStream;->close()V
    :try_end_d4
    .catch Ljava/io/IOException; {:try_start_d1 .. :try_end_d4} :catch_114
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_d1 .. :try_end_d4} :catch_112
    .catchall {:try_start_d1 .. :try_end_d4} :catchall_2f
    ...
    const-string v2, "loadFeature : complete "
    ...
    sget-object v0, Lx1/f;->b:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->countDown()V
    :try_end_108
    .catchall {:try_start_d4 .. :try_end_108} :catchall_2f
    ...
    const-string v1, "Feature file has no feature list"

    invoke-direct {v0, v1}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    throw v0
    :try_end_112
    .catchall {:try_start_10a .. :try_end_112} :catchall_2f
    ...
    throw v0
    :try_end_11f
    .catch Ljava/io/IOException; {:try_start_11b .. :try_end_11f} :catch_114
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_11b .. :try_end_11f} :catch_112
    .catchall {:try_start_11b .. :try_end_11f} :catchall_2f
    ...
    const-string v1, "Feature file is not a xml file."
    ...
    const-string v1, "Feature file is not valid."

    invoke-direct {v0, v1}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    throw v0
    :try_end_139
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_11f .. :try_end_139} :catch_112
    .catchall {:try_start_11f .. :try_end_139} :catchall_2f
    ...
    monitor-exit v3
    :try_end_144
    .catchall {:try_start_139 .. :try_end_144} :catchall_2f
...
.method public static a()Landroid/content/Context;
    ...
    :try_start_0
    sget-object v0, Lx1/f;->c:Ljava/util/concurrent/CountDownLatch;
...
.method public static e()Ljava/util/HashMap;
    ...
    const-string/jumbo v1, "seamless-zoom-support"

    invoke-virtual {v0, v1, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v1, "physical-zoom-supported"
