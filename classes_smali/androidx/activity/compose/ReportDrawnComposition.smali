...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "predicate",
        "<init>",
        "(Landroidx/activity/FullyDrawnReporter;LJ3/a;)V",
        "observeReporter",
        "(LJ3/a;)V",
        "invoke",
        "()V",
...
# instance fields
.field private final checkReporter:LJ3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/k;"
        }
...
.field private final predicate:LJ3/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/a;"
        }
...
# direct methods
.method public constructor <init>(Landroidx/activity/FullyDrawnReporter;LJ3/a;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/activity/compose/ReportDrawnComposition;->predicate:LJ3/a;
    ...
    invoke-direct {v0, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateObserver;-><init>(LJ3/k;)V
    ...
    iput-object v0, p0, Landroidx/activity/compose/ReportDrawnComposition;->checkReporter:LJ3/k;

    invoke-virtual {p1, p0}, Landroidx/activity/FullyDrawnReporter;->addOnReportDrawnListener(LJ3/a;)V
    ...
    invoke-direct {p0, p2}, Landroidx/activity/compose/ReportDrawnComposition;->observeReporter(LJ3/a;)V

    :cond_29
    return-void
.end method

.method public static final synthetic access$observeReporter(Landroidx/activity/compose/ReportDrawnComposition;LJ3/a;)V
    .registers 2

    invoke-direct {p0, p1}, Landroidx/activity/compose/ReportDrawnComposition;->observeReporter(LJ3/a;)V

    return-void
.end method

.method private final observeReporter(LJ3/a;)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, p0, Landroidx/activity/compose/ReportDrawnComposition;->checkReporter:LJ3/k;

    new-instance v3, Landroidx/activity/compose/ReportDrawnComposition$observeReporter$1;

    invoke-direct {v3, v0, p1}, Landroidx/activity/compose/ReportDrawnComposition$observeReporter$1;-><init>(Lkotlin/jvm/internal/A;LJ3/a;)V

    invoke-virtual {v1, p1, v2, v3}, Landroidx/compose/runtime/snapshots/SnapshotStateObserver;->observeReads(Ljava/lang/Object;LJ3/k;LJ3/a;)V

    iget-boolean p1, v0, Lkotlin/jvm/internal/A;->a:Z
...
.method public final removeReporter()V
    ...
    iget-object v1, p0, Landroidx/activity/compose/ReportDrawnComposition;->predicate:LJ3/a;
