...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/activity/compose/OnBackInstance;-><init>(Lc5/D;ZLJ3/n;Landroidx/activity/OnBackPressedCallback;)V
.end annotation
...
.field final synthetic $onBack:LJ3/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/n;"
        }
...
# direct methods
.method public constructor <init>(Landroidx/activity/OnBackPressedCallback;LJ3/n;Landroidx/activity/compose/OnBackInstance;Lz3/d;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/activity/compose/OnBackInstance$job$1;->$onBack:LJ3/n;
...
.method public final create(Ljava/lang/Object;Lz3/d;)Lz3/d;
    ...
    iget-object v1, p0, Landroidx/activity/compose/OnBackInstance$job$1;->$onBack:LJ3/n;

    iget-object p0, p0, Landroidx/activity/compose/OnBackInstance$job$1;->this$0:Landroidx/activity/compose/OnBackInstance;

    invoke-direct {p1, v0, v1, p0, p2}, Landroidx/activity/compose/OnBackInstance$job$1;-><init>(Landroidx/activity/OnBackPressedCallback;LJ3/n;Landroidx/activity/compose/OnBackInstance;Lz3/d;)V
...
.method public final invoke(Lc5/D;Lz3/d;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/activity/compose/OnBackInstance$job$1;->create(Ljava/lang/Object;Lz3/d;)Lz3/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/activity/compose/OnBackInstance$job$1;->invoke(Lc5/D;Lz3/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Landroidx/activity/compose/OnBackInstance;->getChannel()Le5/i;

    move-result-object v3

    new-instance v4, Lf5/d;

    invoke-direct {v4, v3, v2}, Lf5/d;-><init>(Le5/i;Z)V

    new-instance v3, Landroidx/activity/compose/OnBackInstance$job$1$1;

    const/4 v5, 0x0

    invoke-direct {v3, p1, v5}, Landroidx/activity/compose/OnBackInstance$job$1$1;-><init>(Lkotlin/jvm/internal/A;Lz3/d;)V

    new-instance v5, Lf5/q;

    invoke-direct {v5, v4, v3}, Lf5/q;-><init>(Lf5/d;LJ3/o;)V
    ...
    invoke-interface {v1, v5, p0}, LJ3/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
