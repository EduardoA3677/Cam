...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/runtime/Recomposer;->recompositionRunner(LJ3/o;Lz3/d;)Ljava/lang/Object;
.end annotation
...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/Recomposer;LJ3/o;Landroidx/compose/runtime/MonotonicFrameClock;Lz3/d;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;->$block:LJ3/o;
...
.method public final create(Ljava/lang/Object;Lz3/d;)Lz3/d;
    ...
    iget-object v2, p0, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;->$block:LJ3/o;
    ...
    invoke-direct {v0, v1, v2, p0, p2}, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;-><init>(Landroidx/compose/runtime/Recomposer;LJ3/o;Landroidx/compose/runtime/MonotonicFrameClock;Lz3/d;)V
...
.method public final invoke(Lc5/D;Lz3/d;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;->create(Ljava/lang/Object;Lz3/d;)Lz3/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;->invoke(Lc5/D;Lz3/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, v1}, Landroidx/compose/runtime/Recomposer;->access$registerRunnerJob(Landroidx/compose/runtime/Recomposer;Lc5/k0;)V
    ...
    invoke-virtual {p1, v4}, Landroidx/compose/runtime/snapshots/Snapshot$Companion;->registerApplyObserver(LJ3/n;)Landroidx/compose/runtime/snapshots/ObserverHandle;
    ...
    monitor-enter v4
    :try_end_57
    .catchall {:try_start_4e .. :try_end_57} :catchall_6f
    ...
    move-result-object v5
    :try_end_5b
    .catchall {:try_start_57 .. :try_end_5b} :catchall_b7
    ...
    iget-object v5, p0, Landroidx/compose/runtime/Recomposer$recompositionRunner$2;->$block:LJ3/o;
    ...
    invoke-direct {v4, v5, v6, v3}, Landroidx/compose/runtime/Recomposer$recompositionRunner$2$3;-><init>(LJ3/o;Landroidx/compose/runtime/MonotonicFrameClock;Lz3/d;)V
    ...
    invoke-static {v4, p0}, Lc5/G;->j(LJ3/n;Lz3/d;)Ljava/lang/Object;

    move-result-object v2
    :try_end_87
    .catchall {:try_start_5b .. :try_end_87} :catchall_6f
    ...
    :try_start_97
    invoke-static {v0}, Landroidx/compose/runtime/Recomposer;->access$getRunnerJob$p(Landroidx/compose/runtime/Recomposer;)Lc5/k0;

    move-result-object v2

    if-ne v2, v1, :cond_a3

    invoke-static {v0, v3}, Landroidx/compose/runtime/Recomposer;->access$setRunnerJob$p(Landroidx/compose/runtime/Recomposer;Lc5/k0;)V
    ...
    :try_end_a6
    .catchall {:try_start_97 .. :try_end_a6} :catchall_a1
    ...
    throw v0
    :try_end_ba
    .catchall {:try_start_b8 .. :try_end_ba} :catchall_6f
    ...
    :try_start_c6
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$getRunnerJob$p(Landroidx/compose/runtime/Recomposer;)Lc5/k0;

    move-result-object v4

    if-ne v4, v1, :cond_d2

    invoke-static {v2, v3}, Landroidx/compose/runtime/Recomposer;->access$setRunnerJob$p(Landroidx/compose/runtime/Recomposer;Lc5/k0;)V
    ...
    :cond_d2
    :goto_d2
    invoke-static {v2}, Landroidx/compose/runtime/Recomposer;->access$deriveStateLocked(Landroidx/compose/runtime/Recomposer;)Lc5/k;
    :try_end_d5
    .catchall {:try_start_c6 .. :try_end_d5} :catchall_d0
