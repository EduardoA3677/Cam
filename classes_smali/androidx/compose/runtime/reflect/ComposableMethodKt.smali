...
.method public static final varargs getDeclaredComposableMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Landroidx/compose/runtime/reflect/ComposableMethod;
    ...
    invoke-direct {v3, v4}, LR/c;-><init>(I)V

    iget-object v4, v3, LR/c;->b:Ljava/util/ArrayList;

    invoke-virtual {v3, p2}, LR/c;->c(Ljava/lang/Object;)V

    invoke-virtual {v3, v0}, LR/c;->a(Ljava/lang/Object;)V

    sget-object v5, Ljava/lang/Integer;->TYPE:Ljava/lang/Class;

    invoke-static {v2, v1}, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/c;->g0(II)LP3/f;
    ...
    invoke-virtual {v6}, LP3/d;->b()LP3/e;

    move-result-object v6

    :goto_29
    iget-boolean v8, v6, LP3/e;->c:Z

    if-eqz v8, :cond_34

    invoke-virtual {v6}, Lw3/G;->nextInt()I
    ...
    invoke-virtual {v3, v5}, LR/c;->c(Ljava/lang/Object;)V
    ...
    :try_end_4d
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_8 .. :try_end_4d} :catch_4e
    ...
    invoke-direct {v4, v5}, LR/c;-><init>(I)V

    iget-object v5, v4, LR/c;->b:Ljava/util/ArrayList;

    invoke-virtual {v4, p2}, LR/c;->c(Ljava/lang/Object;)V

    invoke-virtual {v4, v0}, LR/c;->a(Ljava/lang/Object;)V
    ...
    :goto_74
    iget-boolean v6, v0, LP3/e;->c:Z

    if-eqz v6, :cond_7f

    invoke-virtual {v0}, Lw3/G;->nextInt()I
    ...
    invoke-static {v2, v3}, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/c;->g0(II)LP3/f;
    ...
    move-result-object p2
    :try_end_bf
    .catch Ljava/lang/ReflectiveOperationException; {:try_start_53 .. :try_end_bf} :catch_c0
