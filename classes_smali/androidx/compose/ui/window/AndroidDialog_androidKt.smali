...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "content",
        "Dialog",
        "(LJ3/a;Landroidx/compose/ui/window/DialogProperties;LJ3/n;Landroidx/compose/runtime/Composer;II)V",
...
# direct methods
.method public static final Dialog(LJ3/a;Landroidx/compose/ui/window/DialogProperties;LJ3/n;Landroidx/compose/runtime/Composer;II)V
    .registers 25
    ...
    invoke-direct/range {v10 .. v15}, Landroidx/compose/ui/window/DialogProperties;-><init>(ZZLandroidx/compose/ui/window/SecureFlagPolicy;ILkotlin/jvm/internal/h;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/compose/ui/window/DialogWrapper;-><init>(LJ3/a;Landroidx/compose/ui/window/DialogProperties;Landroid/view/View;Landroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;Ljava/util/UUID;)V
    ...
    invoke-virtual {v12, v1, v0}, Landroidx/compose/ui/window/DialogWrapper;->setContent(Landroidx/compose/runtime/CompositionContext;LJ3/n;)V
    ...
    invoke-static {v12, v0, v15, v1}, Landroidx/compose/runtime/EffectsKt;->DisposableEffect(Ljava/lang/Object;LJ3/k;Landroidx/compose/runtime/Composer;I)V

    new-instance v0, Landroidx/compose/ui/window/AndroidDialog_androidKt$Dialog$2;

    invoke-direct {v0, v12, v7, v11, v14}, Landroidx/compose/ui/window/AndroidDialog_androidKt$Dialog$2;-><init>(Landroidx/compose/ui/window/DialogWrapper;LJ3/a;Landroidx/compose/ui/window/DialogProperties;Landroidx/compose/ui/unit/LayoutDirection;)V

    const/4 v1, 0x0

    invoke-static {v0, v15, v1}, Landroidx/compose/runtime/EffectsKt;->SideEffect(LJ3/a;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/compose/ui/window/AndroidDialog_androidKt$Dialog$3;-><init>(LJ3/a;Landroidx/compose/ui/window/DialogProperties;LJ3/n;II)V
...
.method private static final Dialog$lambda$0(Landroidx/compose/runtime/State;)LJ3/n;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final DialogLayout(Landroidx/compose/ui/Modifier;LJ3/n;Landroidx/compose/runtime/Composer;II)V
    .registers 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Landroidx/compose/ui/layout/LayoutKt;->modifierMaterializerOf(Landroidx/compose/ui/Modifier;)LJ3/o;
    ...
    invoke-virtual {v5}, Landroidx/compose/ui/node/ComposeUiNode$Companion;->getSetResolvedCompositionLocals()LJ3/n;
    ...
    invoke-virtual {v5}, Landroidx/compose/ui/node/ComposeUiNode$Companion;->getSetCompositeKeyHash()LJ3/n;
    ...
    invoke-interface {v6, v3, v0}, Landroidx/compose/runtime/Composer;->apply(Ljava/lang/Object;LJ3/n;)V
    ...
    invoke-direct {v0, p0, p1, p3, p4}, Landroidx/compose/ui/window/AndroidDialog_androidKt$DialogLayout$2;-><init>(Landroidx/compose/ui/Modifier;LJ3/n;II)V
...
.method public static final synthetic access$Dialog$lambda$0(Landroidx/compose/runtime/State;)LJ3/n;
    .registers 1

    invoke-static {p0}, Landroidx/compose/ui/window/AndroidDialog_androidKt;->Dialog$lambda$0(Landroidx/compose/runtime/State;)LJ3/n;
...
.method public static final synthetic access$DialogLayout(Landroidx/compose/ui/Modifier;LJ3/n;Landroidx/compose/runtime/Composer;II)V
    .registers 5

    invoke-static {p0, p1, p2, p3, p4}, Landroidx/compose/ui/window/AndroidDialog_androidKt;->DialogLayout(Landroidx/compose/ui/Modifier;LJ3/n;Landroidx/compose/runtime/Composer;II)V
