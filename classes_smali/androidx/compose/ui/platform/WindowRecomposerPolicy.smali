...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "block",
        "withFactory",
        "(Landroidx/compose/ui/platform/WindowRecomposerFactory;LJ3/a;)Ljava/lang/Object;",
        "Landroid/view/View;",
        "rootView",
...
.method public final createAndInstallWindowRecomposer$ui_release(Landroid/view/View;)Landroidx/compose/runtime/Recomposer;
    ...
    sget-object v0, Lc5/e0;->a:Lc5/e0;
    ...
    invoke-direct {v2, v1, v4, v3}, Ld5/b;-><init>(Landroid/os/Handler;Ljava/lang/String;Z)V

    new-instance v1, Landroidx/compose/ui/platform/WindowRecomposerPolicy$createAndInstallWindowRecomposer$unsetJob$1;

    const/4 v3, 0x0

    invoke-direct {v1, p0, p1, v3}, Landroidx/compose/ui/platform/WindowRecomposerPolicy$createAndInstallWindowRecomposer$unsetJob$1;-><init>(Landroidx/compose/runtime/Recomposer;Landroid/view/View;Lz3/d;)V

    const/4 v4, 0x2

    iget-object v2, v2, Ld5/b;->d:Ld5/b;

    invoke-static {v0, v2, v3, v1, v4}, Lc5/G;->y(Lc5/D;Lz3/i;Lc5/F;LJ3/n;I)Lc5/D0;

    move-result-object v0

    new-instance v1, Landroidx/compose/ui/platform/WindowRecomposerPolicy$createAndInstallWindowRecomposer$1;

    invoke-direct {v1, v0}, Landroidx/compose/ui/platform/WindowRecomposerPolicy$createAndInstallWindowRecomposer$1;-><init>(Lc5/k0;)V
...
.method public final withFactory(Landroidx/compose/ui/platform/WindowRecomposerFactory;LJ3/a;)Ljava/lang/Object;
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
