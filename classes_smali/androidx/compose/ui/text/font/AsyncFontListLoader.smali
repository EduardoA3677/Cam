...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "platformFontLoader",
        "<init>",
        "(Ljava/util/List;Ljava/lang/Object;Landroidx/compose/ui/text/font/TypefaceRequest;Landroidx/compose/ui/text/font/AsyncTypefaceCache;LJ3/k;Landroidx/compose/ui/text/font/PlatformFontLoader;)V",
        "load",
...
.field private final onCompletion:LJ3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/k;"
        }
...
# direct methods
.method public constructor <init>(Ljava/util/List;Ljava/lang/Object;Landroidx/compose/ui/text/font/TypefaceRequest;Landroidx/compose/ui/text/font/AsyncTypefaceCache;LJ3/k;Landroidx/compose/ui/text/font/PlatformFontLoader;)V
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Landroidx/compose/ui/text/font/AsyncFontListLoader;->onCompletion:LJ3/k;
...
.method public final load(Lz3/d;)Ljava/lang/Object;
    .registers 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v1, v0}, Landroidx/compose/ui/text/font/AsyncFontListLoader$load$1;-><init>(Landroidx/compose/ui/text/font/AsyncFontListLoader;Lz3/d;)V
    ...
    invoke-direct {v13, v1, v14, v6}, Landroidx/compose/ui/text/font/AsyncFontListLoader$load$2$typeface$1;-><init>(Landroidx/compose/ui/text/font/AsyncFontListLoader;Landroidx/compose/ui/text/font/Font;Lz3/d;)V
    ...
    invoke-virtual/range {v10 .. v15}, Landroidx/compose/ui/text/font/AsyncTypefaceCache;->runCached(Landroidx/compose/ui/text/font/Font;Landroidx/compose/ui/text/font/PlatformFontLoader;ZLJ3/k;Lz3/d;)Ljava/lang/Object;

    move-result-object v10

    if-ne v10, v3, :cond_b7
    ...
    :try_end_d8
    .catchall {:try_start_6d .. :try_end_d8} :catchall_f1

    invoke-interface {v2}, Lz3/d;->getContext()Lz3/i;

    move-result-object v0

    invoke-static {v0}, Lc5/G;->v(Lz3/i;)Z

    move-result v0

    iput-boolean v9, v1, Landroidx/compose/ui/text/font/AsyncFontListLoader;->cacheable:Z

    iget-object v2, v1, Landroidx/compose/ui/text/font/AsyncFontListLoader;->onCompletion:LJ3/k;
    ...
    invoke-static {v2}, Lc5/G;->L(LB3/c;)Ljava/lang/Object;

    move-result-object v0
    :try_end_103
    .catchall {:try_start_f3 .. :try_end_103} :catchall_f1
    ...
    invoke-static {v2}, Lc5/G;->v(Lz3/i;)Z

    move-result v2

    iput-boolean v9, v1, Landroidx/compose/ui/text/font/AsyncFontListLoader;->cacheable:Z

    iget-object v3, v1, Landroidx/compose/ui/text/font/AsyncFontListLoader;->onCompletion:LJ3/k;
...
.method public final loadWithTimeoutOrNull$ui_text_release(Landroidx/compose/ui/text/font/Font;Lz3/d;)Ljava/lang/Object;
    .registers 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/compose/ui/text/font/AsyncFontListLoader$loadWithTimeoutOrNull$1;-><init>(Landroidx/compose/ui/text/font/AsyncFontListLoader;Lz3/d;)V
    ...
    :try_end_2c
    .catch Ljava/util/concurrent/CancellationException; {:try_start_29 .. :try_end_2c} :catch_2f
    ...
    invoke-direct {p2, p0, p1, v4}, Landroidx/compose/ui/text/font/AsyncFontListLoader$loadWithTimeoutOrNull$2;-><init>(Landroidx/compose/ui/text/font/AsyncFontListLoader;Landroidx/compose/ui/text/font/Font;Lz3/d;)V
    ...
    invoke-static {v2, v3, p2, v0}, Lc5/G;->K(JLJ3/n;Lz3/d;)Ljava/lang/Object;

    move-result-object p2
    :try_end_4b
    .catch Ljava/util/concurrent/CancellationException; {:try_start_3c .. :try_end_4b} :catch_2f
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_4b} :catch_2d
    ...
    invoke-interface {p2, v0, v1}, Lc5/B;->handleException(Lz3/i;Ljava/lang/Throwable;)V
