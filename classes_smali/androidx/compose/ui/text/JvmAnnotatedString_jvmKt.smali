...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "transform",
        "(Landroidx/compose/ui/text/AnnotatedString;LJ3/o;)Landroidx/compose/ui/text/AnnotatedString;",
        "",
...
.method public static final transform(Landroidx/compose/ui/text/AnnotatedString;LJ3/o;)Landroidx/compose/ui/text/AnnotatedString;
    .registers 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v3}, Lw3/q;->u0([Ljava/lang/Object;Ljava/util/AbstractSet;)V
    ...
    invoke-direct {v4, v1, v1}, Lv3/h;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v4}, [Lv3/h;

    move-result-object v1

    invoke-static {v1}, Lw3/I;->B([Lv3/h;)Ljava/util/LinkedHashMap;

    move-result-object v1

    new-instance v4, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;

    invoke-direct {v4, v2, p1, p0, v1}, Landroidx/compose/ui/text/JvmAnnotatedString_jvmKt$transform$1;-><init>(Lkotlin/jvm/internal/E;LJ3/o;Landroidx/compose/ui/text/AnnotatedString;Ljava/util/Map;)V
    ...
    invoke-direct {v6, v3}, Lw3/e;-><init>(Ljava/util/List;)V
    ...
    sget-object v9, Lw3/f;->Companion:Lw3/c;

    iget-object v10, v6, Lw3/e;->d:Ljava/util/List;
    ...
    invoke-static {v3, v8, v10}, Lw3/c;->c(III)V

    iput v3, v6, Lw3/e;->b:I

    sub-int/2addr v8, v3

    iput v8, v6, Lw3/e;->c:I

    invoke-interface {v4, v6}, LJ3/k;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v3, Lw3/A;->a:Lw3/A;

    goto :goto_b9

    :cond_b0
    new-instance v7, Lw3/O;

    invoke-direct {v7, v6, v3, v0, v5}, Lw3/O;-><init>(ILjava/util/Iterator;ZLz3/d;)V

    invoke-static {v7}, La/a;->y(LJ3/n;)LZ4/l;
