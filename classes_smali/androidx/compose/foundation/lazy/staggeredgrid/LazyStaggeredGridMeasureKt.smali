...
.method private static final measure(Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureContext;I[I[IZ)Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureResult;
    ...
    :goto_201
    if-ge v0, v11, :cond_211

    aget v1, v12, v0

    if-lt v1, v14, :cond_20d
    ...
    if-lt v0, v9, :cond_6ee

    :goto_230
    const/4 v0, 0x0

    :goto_231
    if-ge v0, v6, :cond_2a2
    ...
    :goto_3a9
    if-ge v14, v2, :cond_3ca

    aget v15, v8, v14

    if-eq v15, v12, :cond_3b0
    ...
    if-eq v12, v10, :cond_4c7

    aget v10, v8, v2

    if-eqz v10, :cond_4c7

    if-lt v10, v14, :cond_4c7
    ...
    :goto_55e
    if-ge v6, v3, :cond_558

    move/from16 v16, v3

    aget v3, v5, v6

    if-le v3, v0, :cond_568
    ...
    :goto_610
    if-ge v1, v12, :cond_623

    move/from16 p3, v3

    aget v3, v10, v1

    if-ge v3, v7, :cond_61a
    ...
    :goto_692
    if-ge v3, v1, :cond_6a4

    aget v2, v10, v3

    add-int/lit8 v15, v9, -0x1

    if-ge v2, v15, :cond_69c
...
.method public static final measureStaggeredGrid-BTfHGGE(Landroidx/compose/foundation/lazy/layout/LazyLayoutMeasureScope;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridState;Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridItemProvider;[IJZZJIIIII)Landroidx/compose/foundation/lazy/staggeredgrid/LazyStaggeredGridMeasureResult;
    ...
    move-result-object v2
    :try_end_4f
    .catchall {:try_start_4b .. :try_end_4f} :catchall_d2
    ...
    aput v9, v5, v6
    :try_end_b5
    .catchall {:try_start_4f .. :try_end_b5} :catchall_7c
    ...
    throw v0
    :try_end_d8
    .catchall {:try_start_d4 .. :try_end_d8} :catchall_d2
