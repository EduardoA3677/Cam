...
.method public final childConstraints-JhjzzOo$foundation_release(II)J
    ...
    invoke-virtual {p0, v1}, Landroidx/compose/ui/unit/Constraints$Companion;->fixedWidth-OenEA2s(I)J
    ...
    invoke-virtual {p0, v1}, Landroidx/compose/ui/unit/Constraints$Companion;->fixedHeight-OenEA2s(I)J
...
.method public final getAndMeasure-bKFJvoY(I)Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;
    ...
    :cond_4f
    iget-object p0, p0, Landroidx/compose/foundation/lazy/grid/LazyMeasuredLineProvider;->measuredLineFactory:Landroidx/compose/foundation/lazy/grid/MeasuredLineFactory;

    invoke-virtual {v0}, Landroidx/compose/foundation/lazy/grid/LazyGridSpanLayoutProvider$LineConfiguration;->getSpans()Ljava/util/List;

    move-result-object v0

    invoke-interface {p0, p1, v4, v0, v3}, Landroidx/compose/foundation/lazy/grid/MeasuredLineFactory;->createLine-H9FfpSk(I[Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;Ljava/util/List;I)Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;
...
.method public final getKeyToIndexMap()Ljava/util/Map;
    ...
    iget-object p0, p0, Landroidx/compose/foundation/lazy/grid/LazyMeasuredLineProvider;->measuredItemProvider:Landroidx/compose/foundation/lazy/grid/LazyMeasuredItemProvider;

    invoke-virtual {p0}, Landroidx/compose/foundation/lazy/grid/LazyMeasuredItemProvider;->getKeyToIndexMap()Ljava/util/Map;
