...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;Landroidx/compose/runtime/Composer;II)V",
        "ClickableText",
        "onHover",
        "ClickableText-03UYbkw",
        "(Landroidx/compose/ui/text/AnnotatedString;LJ3/k;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;Landroidx/compose/runtime/Composer;II)V",
...
# direct methods
.method public static final ClickableText-03UYbkw(Landroidx/compose/ui/text/AnnotatedString;LJ3/k;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;Landroidx/compose/runtime/Composer;II)V
    .registers 37
    ...
    invoke-static {v5, v10, v0}, Landroidx/collection/a;->l(ILandroidx/compose/runtime/Composer;I)Ljava/lang/Object;
    ...
    invoke-direct/range {p2 .. p7}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$pointerInputModifier$1;-><init>(Lc5/D;LJ3/k;Landroidx/compose/runtime/MutableState;LJ3/k;Lz3/d;)V

    invoke-static {v5, v14, v13, v6}, Landroidx/compose/ui/input/pointer/SuspendingPointerInputFilterKt;->pointerInput(Landroidx/compose/ui/Modifier;Ljava/lang/Object;Ljava/lang/Object;LJ3/n;)Landroidx/compose/ui/Modifier;
    ...
    if-ne v6, v0, :cond_20c

    :cond_204
    new-instance v6, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$5$1;

    invoke-direct {v6, v2, v9}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$5$1;-><init>(Landroidx/compose/runtime/MutableState;LJ3/k;)V
    ...
    invoke-static/range {v0 .. v11}, Landroidx/compose/foundation/text/BasicTextKt;->BasicText-VhcvRP8(Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;LJ3/k;IZIILjava/util/Map;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct/range {v0 .. v11}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$6;-><init>(Landroidx/compose/ui/text/AnnotatedString;LJ3/k;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;II)V

    invoke-interface {v13, v12}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V

    :goto_275
    return-void
.end method

.method public static final ClickableText-4YKlhWE(Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;Landroidx/compose/runtime/Composer;II)V
    .registers 35
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v8, v0, v13, v5}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$pressIndicator$1$1;-><init>(Landroidx/compose/runtime/MutableState;LJ3/k;Lz3/d;)V
    ...
    invoke-static {v3, v13, v8}, Landroidx/compose/ui/input/pointer/SuspendingPointerInputFilterKt;->pointerInput(Landroidx/compose/ui/Modifier;Ljava/lang/Object;LJ3/n;)Landroidx/compose/ui/Modifier;
    ...
    if-ne v6, v2, :cond_1d4

    :cond_1cc
    new-instance v6, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$2$1;

    invoke-direct {v6, v0, v10}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$2$1;-><init>(Landroidx/compose/runtime/MutableState;LJ3/k;)V
    ...
    invoke-direct/range {v0 .. v10}, Landroidx/compose/foundation/text/ClickableTextKt$ClickableText$3;-><init>(Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/Modifier;Landroidx/compose/ui/text/TextStyle;ZIILJ3/k;LJ3/k;II)V
