...
.method public final cancelAndRemoveAll(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getContinuation()Lc5/k;
...
.method public final enqueue(Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;)Z
    ...
    invoke-virtual {p1}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getCurrentBounds()LJ3/a;
    ...
    invoke-virtual {p1}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getContinuation()Lc5/k;
    ...
    invoke-interface {v2, v3}, Lc5/k;->k(LJ3/k;)V
    ...
    invoke-direct {v3, v1, v2, v4}, LP3/d;-><init>(III)V
    ...
    invoke-virtual {v6}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getContinuation()Lc5/k;

    move-result-object v6

    invoke-interface {v6, v3}, Lc5/k;->d(Ljava/lang/Throwable;)Z
...
.method public final forEachFromSmallest(LJ3/k;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final resumeAndRemoveAll()V
    ...
    invoke-direct {v1, v3, v0, v2}, LP3/d;-><init>(III)V

    iget v0, v1, LP3/d;->b:I
...
.method public final resumeAndRemoveWhile(LJ3/k;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getCurrentBounds()LJ3/a;
    ...
    invoke-virtual {v0}, Landroidx/compose/foundation/gestures/ContentInViewModifier$Request;->getContinuation()Lc5/k;
