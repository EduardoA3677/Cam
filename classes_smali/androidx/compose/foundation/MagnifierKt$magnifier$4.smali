...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/foundation/MagnifierKt;->magnifier(Landroidx/compose/ui/Modifier;LJ3/k;LJ3/k;FLandroidx/compose/foundation/MagnifierStyle;LJ3/k;Landroidx/compose/foundation/PlatformMagnifierFactory;)Landroidx/compose/ui/Modifier;
.end annotation
...
# instance fields
.field final synthetic $magnifierCenter:LJ3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/k;"
        }
...
.field final synthetic $onSizeChanged:LJ3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/k;"
        }
...
.field final synthetic $sourceCenter:LJ3/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LJ3/k;"
        }
...
# direct methods
.method public constructor <init>(LJ3/k;LJ3/k;FLJ3/k;Landroidx/compose/foundation/PlatformMagnifierFactory;Landroidx/compose/foundation/MagnifierStyle;)V
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$sourceCenter:LJ3/k;

    iput-object p2, p0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$magnifierCenter:LJ3/k;

    iput p3, p0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$zoom:F

    iput-object p4, p0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$onSizeChanged:LJ3/k;
...
.method public static final synthetic access$invoke$lambda$3(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1

    invoke-static {p0}, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->invoke$lambda$3(Landroidx/compose/runtime/State;)LJ3/k;
...
.method public static final synthetic access$invoke$lambda$4(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1

    invoke-static {p0}, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->invoke$lambda$4(Landroidx/compose/runtime/State;)LJ3/k;
...
.method public static final synthetic access$invoke$lambda$6(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1

    invoke-static {p0}, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->invoke$lambda$6(Landroidx/compose/runtime/State;)LJ3/k;
...
.method private static final invoke$lambda$3(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final invoke$lambda$4(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final invoke$lambda$6(Landroidx/compose/runtime/State;)LJ3/k;
    .registers 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final invoke(Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/Modifier;
    ...
    .line 16
    iget-object v4, v0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$sourceCenter:LJ3/k;
    ...
    .line 17
    iget-object v5, v0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$magnifierCenter:LJ3/k;
    ...
    .line 19
    iget-object v5, v0, Landroidx/compose/foundation/MagnifierKt$magnifier$4;->$onSizeChanged:LJ3/k;
    ...
    invoke-static {v5}, Landroidx/compose/runtime/SnapshotStateKt;->derivedStateOf(LJ3/a;)Landroidx/compose/runtime/State;
    ...
    .line 37
    sget-object v3, Le5/a;->DROP_OLDEST:Le5/a;

    invoke-static {v10, v13, v3, v6}, Lf5/b0;->a(IILe5/a;I)Lf5/a0;
    ...
    invoke-direct/range {v4 .. v17}, Landroidx/compose/foundation/MagnifierKt$magnifier$4$1;-><init>(Landroidx/compose/foundation/PlatformMagnifierFactory;Landroidx/compose/foundation/MagnifierStyle;Landroid/view/View;Landroidx/compose/ui/unit/Density;FLf5/U;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;Landroidx/compose/runtime/MutableState;Landroidx/compose/runtime/State;Lz3/d;)V

    const/16 v4, 0x48

    move-object/from16 v5, v22

    invoke-static {v5, v1, v2, v4}, Landroidx/compose/runtime/EffectsKt;->LaunchedEffect([Ljava/lang/Object;LJ3/n;Landroidx/compose/runtime/Composer;I)V
    ...
    .line 53
    invoke-static {v4, v6}, Landroidx/compose/ui/layout/OnGloballyPositionedModifierKt;->onGloballyPositioned(Landroidx/compose/ui/Modifier;LJ3/k;)Landroidx/compose/ui/Modifier;
    ...
    invoke-direct {v5, v3}, Landroidx/compose/foundation/MagnifierKt$magnifier$4$3;-><init>(Lf5/U;)V

    invoke-static {v4, v5}, Landroidx/compose/ui/draw/DrawModifierKt;->drawBehind(Landroidx/compose/ui/Modifier;LJ3/k;)Landroidx/compose/ui/Modifier;
    ...
    .line 62
    invoke-static {v3, v5, v4, v0, v1}, Landroidx/compose/ui/semantics/SemanticsModifierKt;->semantics$default(Landroidx/compose/ui/Modifier;ZLJ3/k;ILjava/lang/Object;)Landroidx/compose/ui/Modifier;
