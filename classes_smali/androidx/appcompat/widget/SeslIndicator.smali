...
.method private final generateDotIndicator()Landroidx/appcompat/widget/SeslIndicator$PageIndicatorMarker;
    .registers 5
    ...
    invoke-direct {v0, v1, v2, v3, v2}, Landroidx/appcompat/widget/SeslIndicator$PageIndicatorMarker;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILkotlin/jvm/internal/h;)V

    iget-object v1, p0, Landroidx/appcompat/widget/SeslIndicator;->defaultCircle:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/SeslIndicator$PageIndicatorMarker;->setDefaultCircle(Landroid/graphics/drawable/Drawable;)V
...
.method public final addIndicator()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SeslIndicator;->generateDotIndicator()Landroidx/appcompat/widget/SeslIndicator$PageIndicatorMarker;

    move-result-object v0

    new-instance v1, Landroidx/appcompat/widget/b;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/b;-><init>(Landroidx/appcompat/widget/SeslIndicator;)V
    ...
    sget v3, Landroidx/appcompat/R$dimen;->sesl_viewpager_indicator_horizontal_padding:I
...
.method public final setOnItemClickListener(Landroidx/appcompat/widget/SeslIndicator$OnItemClickListener;)V
    ...
    invoke-direct {v2, p1, p0}, Landroidx/appcompat/widget/a;-><init>(Landroidx/appcompat/widget/SeslIndicator$OnItemClickListener;Landroidx/appcompat/widget/SeslIndicator;)V
