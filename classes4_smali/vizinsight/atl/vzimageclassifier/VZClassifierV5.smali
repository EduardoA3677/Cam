.class public Lvizinsight/atl/vzimageclassifier/VZClassifierV5;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "VZClassifierV5"
...
.method public constructor <init>(Landroid/content/Context;Lvizinsight/atl/vzimageclassifier/VZClassifier;)V
    ...
    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->sensorAnalyzer:Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;

    const/4 v1, -0x1

    iput v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->auto_mode:I

    const-string v1, ""

    iput-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->encoded_string:Ljava/lang/String;

    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->bb:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;

    iput-object p2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;

    iput-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->initialize()V
...
.method public classify(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual/range {v1 .. v6}, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->classify([BIIII)Ljava/util/List;
    ...
    invoke-virtual/range {v3 .. v8}, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->classify([BIIII)Ljava/util/List;
...
.method public classify(Ljava/nio/ByteBuffer;IIII)Ljava/util/List;
    ...
    .line 1
    iget v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->auto_mode:I

    if-nez v0, :cond_22

    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->sensorAnalyzer:Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;
    ...
    .line 2
    :cond_d
    iget-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
    ...
    .line 4
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
    ...
    :cond_22
    :goto_22
    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;
    ...
    .line 6
    iput-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->encoded_string:Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {p0, p1}, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->parse_encoded_string(Ljava/lang/String;)Ljava/util/List;
...
.method public classify([BIIII)Ljava/util/List;
    ...
    .line 13
    iget-object v2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->bb:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual/range {v1 .. v6}, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->classify(Ljava/nio/ByteBuffer;IIII)Ljava/util/List;

    move-result-object p1

    .line 14
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->bb:Ljava/nio/ByteBuffer;
...
.method public getIdleTime()I
    ...
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;
...
.method public initialize()V
    ...
    const-string v0, "VZClassifierV5"

    const-string v1, "JK Debug aar v5* mode"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;

    iget-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->mContext:Landroid/content/Context;
...
.method public parse_encoded_string(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
    ...
    iget-object v4, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
    ...
    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
    ...
    iget-object v2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->detections:Ljava/util/List;
...
.method public setSceneInfo(Lvizinsight/atl/vzimageclassifier/SceneDetectorParam;)V
    ...
    iput v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV5;->auto_mode:I
    ...
    const-string v2, "VZClassifierV5"
