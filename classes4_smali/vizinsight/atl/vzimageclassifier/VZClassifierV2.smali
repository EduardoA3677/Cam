.class public Lvizinsight/atl/vzimageclassifier/VZClassifierV2;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "VZClassifierV2"
...
.method public constructor <init>(Landroid/content/Context;Lvizinsight/atl/vzimageclassifier/VZClassifier;)V
    ...
    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->sensorAnalyzer:Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;

    const/4 v1, -0x1

    iput v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->auto_mode:I

    const-string v1, ""

    iput-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->encoded_string:Ljava/lang/String;

    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->bb:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;

    iput-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;

    invoke-virtual {p0}, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->initialize()V
...
.method public classify(Ljava/lang/String;)Ljava/util/List;
    ...
    move-result-object v8
    :try_end_5b
    .catch Ljava/lang/Exception; {:try_start_1c .. :try_end_5b} :catch_3e
    ...
    invoke-virtual/range {v1 .. v6}, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->classify([BIIII)Ljava/util/List;
    ...
    :try_end_76
    .catch Ljava/lang/OutOfMemoryError; {:try_start_60 .. :try_end_76} :catch_77
    ...
    invoke-virtual/range {v3 .. v8}, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->classify([BIIII)Ljava/util/List;
...
.method public classify(Ljava/nio/ByteBuffer;IIII)Ljava/util/List;
    ...
    .line 1
    iget v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->auto_mode:I

    if-nez v0, :cond_22

    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->sensorAnalyzer:Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;
    ...
    .line 2
    :cond_d
    iget-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
    ...
    .line 4
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
    ...
    :cond_22
    :goto_22
    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;
    ...
    .line 6
    iput-object p1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->encoded_string:Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {p0, p1}, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->parse_encoded_string(Ljava/lang/String;)Ljava/util/List;
...
.method public classify([BIIII)Ljava/util/List;
    ...
    .line 13
    iget-object v2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->bb:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual/range {v1 .. v6}, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->classify(Ljava/nio/ByteBuffer;IIII)Ljava/util/List;

    move-result-object p1

    .line 14
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->bb:Ljava/nio/ByteBuffer;
...
.method public getIdleTime()I
    ...
    iget-object p0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->mVZ:Lvizinsight/atl/vzimageclassifier/VZClassifier;
...
.method public initialize()V
    ...
    const-string v0, "VZClassifierV2"

    const-string v1, "JK Debug aar v2 mode"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v0, Lvizinsight/atl/vzimageclassifier/SensorAnalyzer;

    iget-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->mContext:Landroid/content/Context;
...
.method public parse_encoded_string(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
    ...
    iget-object v4, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
    ...
    :try_end_8f
    .catch Lorg/json/JSONException; {:try_start_8 .. :try_end_8f} :catch_93
    ...
    iget-object v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
    ...
    iget-object v2, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->detections:Ljava/util/List;
...
.method public setSceneInfo(Lvizinsight/atl/vzimageclassifier/SceneDetectorParam;)V
    ...
    iput v0, p0, Lvizinsight/atl/vzimageclassifier/VZClassifierV2;->auto_mode:I
    ...
    const-string v2, "VZClassifierV2"

    .line 4
    const-string v3, "JK Debug SceneDetect Param lensFocusDistance : "

    .line 5
    invoke-static {v0, v1, v2, v3}, LG2/u;->q(Ljava/lang/StringBuilder;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
