...
.method private static getBucketList(Landroid/content/Context;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v3, v5}, Landroidx/concurrent/futures/a;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, v1, v0}, Lcom/sec/android/app/camera/layer/keyscreen/zoom/j;-><init>(Ljava/util/ArrayList;I)V
...
.method public static getGalleryIntent(Lcom/sec/android/app/camera/interfaces/CameraContext;Landroid/widget/ImageView;Z)Landroid/content/Intent;
    .registers 13
    ...
    const-string v9, "com.samsung.android.gallery.app.activity.external.ImageQuickViewActivity"
    ...
    invoke-virtual {v6, v1, p2}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    invoke-virtual {v6, p2, v4}, Landroid/content/Intent;->setDataAndType(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;

    goto :goto_c1

    :cond_78
    const-string p2, "getGalleryIntent : update uri - start"
    ...
    invoke-static {v9}, Lcom/sec/android/app/camera/util/StorageProvider;->getPath(I)Ljava/lang/String;
    ...
    :goto_ab
    invoke-interface {v0, p2}, Lcom/sec/android/app/camera/interfaces/LatestMedia;->isCameraBucketEmpty(Ljava/lang/String;)Z
    ...
    :goto_bc
    const-string p2, "getGalleryIntent : update uri - end"
    ...
    invoke-virtual {p2, v1, v7, v8}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V
    ...
    invoke-virtual {p2, v0, v9}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V
    ...
    invoke-virtual {p2, p1, p0}, Landroid/os/Bundle;->putIntegerArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V

    invoke-virtual {v6, p2}, Landroid/content/Intent;->putExtras(Landroid/os/Bundle;)Landroid/content/Intent;

    sget-object p0, Lx1/c;->SUPPORT_QUICK_VIEW_SCALE_VI:Lx1/c;
...
.method private static getIntentForUsbStorage(Lcom/sec/android/app/camera/interfaces/CameraContext;Landroid/widget/ImageView;)Landroid/content/Intent;
    ...
    const-string v4, "com.samsung.android.gallery.app.activity.external.ImageQuickViewActivity"
    ...
    const-string v2, "android.intent.action.QUICK_VIEW"
