...
.method public static synthetic b(Ljava/lang/String;Ljava/lang/String;JLjava/lang/Long;)V
    .registers 5
...
.method public static synthetic c(Ljava/util/TreeMap;Ljava/util/List;)V
    .registers 2
...
.method public static checkMemInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    move-result v4
    :try_end_3b
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_3b} :catch_98
    .catch Ljava/lang/InterruptedException; {:try_start_9 .. :try_end_3b} :catch_98
    ...
    :try_end_98
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_98} :catch_98
    .catch Ljava/lang/InterruptedException; {:try_start_41 .. :try_end_98} :catch_98
...
.method public static checkMemInfo(Landroid/content/Context;Z)V
    ...
    invoke-direct {v1, p1, v3}, Lcom/sec/android/app/camera/layer/keyscreen/zoom/widget/c;-><init>(Ljava/lang/Object;I)V
    ...
    .line 18
    const-string v13, "[MemoryInfo Native] Pss: "

    .line 19
    invoke-static {v9, v13}, Landroidx/concurrent/futures/a;->p(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    .line 20
    iget v13, v8, Landroid/os/Debug$MemoryInfo;->nativePss:I

    invoke-virtual {v9, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v8, Landroid/os/Debug$MemoryInfo;->nativePrivateDirty:I

    invoke-virtual {v9, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v8, Landroid/os/Debug$MemoryInfo;->nativeSharedDirty:I

    .line 21
    invoke-static {v9, v12, v13}, Landroidx/compose/foundation/text/a;->q(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v9

    .line 22
    const-string v12, "[MemoryInfo Dalvik] Pss: "

    .line 23
    invoke-static {v9, v12}, Landroidx/concurrent/futures/a;->p(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget v10, v8, Landroid/os/Debug$MemoryInfo;->dalvikPrivateDirty:I

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v10, v8, Landroid/os/Debug$MemoryInfo;->dalvikSharedDirty:I
    ...
    .line 29
    invoke-virtual {p1, v4}, Lcom/sec/android/app/camera/util/debug/DebugUtil$ComparableMemoryInfo;->getInfo(I)Ljava/lang/String;
...
.method public static dumpCallStack(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2
    const-string v0, "dumpCallStack : start"
    ...
    :try_end_115
    .catch Ljava/io/IOException; {:try_start_e7 .. :try_end_115} :catch_116
...
.method private static synthetic lambda$checkLoggingDuration$1(Ljava/lang/String;Ljava/lang/String;JLjava/lang/Long;)V
    ...
    invoke-static {p1, p0, v0}, LG2/u;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
