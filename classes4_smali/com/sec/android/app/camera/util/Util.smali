...
.method public static byteArrayToLong([BI)J
    ...
    aget-byte v5, p0, v2
    :try_end_d
    .catch Ljava/lang/ArrayIndexOutOfBoundsException; {:try_start_b .. :try_end_d} :catch_14
...
.method public static getSamsungAccountName(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_end_13
    .catch Ljava/lang/SecurityException; {:try_start_7 .. :try_end_13} :catch_14
...
.method public static isKNOXMode(Landroid/content/Context;)Z
    ...
    move-result p0
    :try_end_f
    .catch Ljava/lang/NoSuchMethodError; {:try_start_1 .. :try_end_f} :catch_10
...
.method public static isMediaScannerScanning(Landroid/content/Context;)Z
    ...
    move-result v1
    :try_end_34
    .catchall {:try_start_18 .. :try_end_34} :catchall_37
...
.method public static requestSearchProviderIndexing(Landroid/content/Context;)V
    ...
    :try_end_2a
    .catch Ljava/lang/IllegalArgumentException; {:try_start_7 .. :try_end_2a} :catch_2b
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_7 .. :try_end_2a} :catch_2b
...
.method public static showQuickInstallationPopup(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_end_43
    .catch Landroid/content/ActivityNotFoundException; {:try_start_15 .. :try_end_43} :catch_44
...
.method public static writeByteArrayToFile(Ljava/lang/String;Ljava/lang/String;[B)Z
    ...
    :try_end_13
    .catch Ljava/io/FileNotFoundException; {:try_start_e .. :try_end_13} :catch_38
    ...
    :try_end_27
    .catch Ljava/io/FileNotFoundException; {:try_start_24 .. :try_end_27} :catch_38
    ...
    throw p2
    :try_end_32
    .catch Ljava/io/FileNotFoundException; {:try_start_2e .. :try_end_32} :catch_38
...
.method public static writeImageDataToRequestedUri(Landroid/content/Context;Landroid/net/Uri;I[B)Z
    ...
    move-result-object p0
    :try_end_1e
    .catch Ljava/lang/SecurityException; {:try_start_16 .. :try_end_1e} :catch_46
    .catch Ljava/io/IOException; {:try_start_16 .. :try_end_1e} :catch_40
    ...
    :try_end_2a
    .catch Ljava/lang/SecurityException; {:try_start_27 .. :try_end_2a} :catch_46
    .catch Ljava/io/IOException; {:try_start_27 .. :try_end_2a} :catch_40
    ...
    invoke-virtual {p0}, Ljava/io/OutputStream;->close()V
    :try_end_33
    .catch Ljava/lang/SecurityException; {:try_start_30 .. :try_end_33} :catch_46
    ...
    throw p1
    :try_end_40
    .catch Ljava/lang/SecurityException; {:try_start_3c .. :try_end_40} :catch_46
