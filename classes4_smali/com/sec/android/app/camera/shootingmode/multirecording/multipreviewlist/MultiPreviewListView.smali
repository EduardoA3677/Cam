...
.field private mPreviewListItemBindings:[LD2/P1;

.field private mThumbnailItemHeight:I

.field private mThumbnailItemWidth:I

.field private mViewBinding:LD2/N1;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 8
    sget-object p1, Lx1/c;->SUPPORT_DIRECTORS_VIEW_AUTO_TRACKING:Lx1/c;
...
.method public static synthetic b(Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;LC2/k;ILandroid/view/View;)V
    .registers 4

    invoke-direct {p0, p1, p2, p3}, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->lambda$registerThumbnailItemListeners$2(LC2/k;ILandroid/view/View;)V

    return-void
.end method

.method public static synthetic c(LC2/k;Landroid/graphics/Bitmap;)V
    .registers 2

    invoke-static {p0, p1}, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->lambda$setPreviewData$0(LC2/k;Landroid/graphics/Bitmap;)V
...
.method private createItemList()Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v2, v1, v3}, LC2/k;-><init>(ILcom/sec/android/app/camera/interfaces/CommandId;Z)V
    ...
    invoke-direct {v0, v3, v1, v3}, LC2/k;-><init>(ILcom/sec/android/app/camera/interfaces/CommandId;Z)V
    ...
    invoke-direct {v0, v4, v1, v3}, LC2/k;-><init>(ILcom/sec/android/app/camera/interfaces/CommandId;Z)V
    ...
    invoke-direct {v0, v3, v1, v2}, LC2/k;-><init>(ILcom/sec/android/app/camera/interfaces/CommandId;Z)V
...
.method private findItemByLensType(I)LC2/k;
    .registers 4
...
.method private getSelectedItem()LC2/k;
    .registers 3
...
.method private handleAutoTrackingState([I)Z
    ...
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->findItemByLensType(I)LC2/k;
...
.method private init()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mViewBinding:LD2/N1;

    iget-object v1, v0, LD2/N1;->g:LD2/P1;

    iget-object v2, v0, LD2/N1;->d:LD2/P1;

    iget-object v3, v0, LD2/N1;->f:LD2/P1;

    iget-object v4, v0, LD2/N1;->a:LD2/P1;

    iget-object v5, v0, LD2/N1;->b:LD2/P1;

    iget-object v6, v0, LD2/N1;->c:LD2/P1;

    filled-new-array/range {v1 .. v6}, [LD2/P1;

    move-result-object v0

    iput-object v0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mPreviewListItemBindings:[LD2/P1;
...
.method private initItemImageButtonInfo()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mPreviewListItemBindings:[LD2/P1;

    aget-object v1, v1, v0

    iget-object v1, v1, LD2/P1;->a:Landroid/widget/ImageButton;
    ...
    iget-object v3, v3, LC2/k;->d:Lcom/sec/android/app/camera/interfaces/CommandId;
...
.method private lambda$registerThumbnailItemListeners$2(LC2/k;ILandroid/view/View;)V
    .registers 5

    iget-boolean p3, p1, LC2/k;->c:Z
    ...
    iget-object p1, p1, LC2/k;->d:Lcom/sec/android/app/camera/interfaces/CommandId;
...
.method private static lambda$setPreviewData$0(LC2/k;Landroid/graphics/Bitmap;)V
    .registers 2

    iput-object p1, p0, LC2/k;->a:Landroid/graphics/Bitmap;
...
.method private refreshItemList()V
    ...
    iget-boolean v3, v2, LC2/k;->c:Z

    if-nez v3, :cond_34

    iget-boolean v3, v2, LC2/k;->b:Z
    ...
    :cond_34
    :goto_34
    iget-object v2, v2, LC2/k;->a:Landroid/graphics/Bitmap;
...
.method private registerThumbnailItemListeners()V
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mPreviewListItemBindings:[LD2/P1;

    aget-object v2, v2, v0

    iget-object v2, v2, LD2/P1;->a:Landroid/widget/ImageButton;

    new-instance v3, Lcom/sec/android/app/camera/layer/menu/effects/filterV2/a;

    invoke-direct {v3, p0, v1, v0}, Lcom/sec/android/app/camera/layer/menu/effects/filterV2/a;-><init>(Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;LC2/k;I)V
...
.method private resizeItemList()V
    ...
    iget-object v1, v1, LD2/P1;->b:Landroid/widget/FrameLayout;
...
.method private updateAutoTrackingViewMargin(Z)V
    ...
    :goto_17
    iget-object v0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mViewBinding:LD2/N1;

    iget-object v0, v0, LD2/N1;->a:LD2/P1;

    iget-object v0, v0, LD2/P1;->b:Landroid/widget/FrameLayout;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mViewBinding:LD2/N1;

    iget-object p0, p0, LD2/N1;->a:LD2/P1;

    iget-object p0, p0, LD2/P1;->b:Landroid/widget/FrameLayout;
...
.method public hideSelectedItem(I)V
    ...
    iput-boolean v1, v0, LC2/k;->b:Z

    iget-object v0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mPreviewListItemBindings:[LD2/P1;

    aget-object v0, v0, p1

    iget-object v0, v0, LD2/P1;->a:Landroid/widget/ImageButton;

    invoke-virtual {v0, v1}, Landroid/view/View;->setSelected(Z)V

    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->mPreviewListItemBindings:[LD2/P1;

    aget-object p0, p0, p1

    iget-object p0, p0, LD2/P1;->c:Landroid/widget/ImageView;
...
.method public refreshSelectedItem(I)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/multirecording/multipreviewlist/MultiPreviewListView;->getSelectedItem()LC2/k;
...
.method public setPreviewData(Landroid/graphics/Bitmap;[Landroid/graphics/Rect;Landroid/graphics/Matrix;)V
    ...
    new-instance v4, Lcom/sec/android/app/camera/layer/menu/effects/filterV2/v;

    const/4 v5, 0x3

    invoke-direct {v4, v5, v2, v3}, Lcom/sec/android/app/camera/layer/menu/effects/filterV2/v;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, p0, p2}, Lcom/sec/android/app/camera/layer/popup/abstraction/b;-><init>(Ljava/lang/Object;I)V
...
.method public showSelectedItem(I)V
    ...
    iget-object p1, p1, LD2/P1;->c:Landroid/widget/ImageView;
...
.method public startShowThumbnailButtonsAnimation()V
    ...
    iget-object v2, v2, LD2/P1;->b:Landroid/widget/FrameLayout;
