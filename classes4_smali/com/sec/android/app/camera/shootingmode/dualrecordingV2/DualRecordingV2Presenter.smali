.class public Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;
.super Lcom/sec/android/app/camera/shootingmode/abstraction/AbstractRecordingModePresenter;
.source "SourceFile"

# interfaces
.implements Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$Presenter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;
    }
.end annotation
...
.field private static final TAG:Ljava/lang/String; = "DualRecordingV2Presenter"


# instance fields
.field private mGroupId:I

.field private final mHandler:Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;
...
# direct methods
.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;I)V
    .registers 4
    ...
    new-instance p1, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;-><init>(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;I)V

    iput-object p1, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mHandler:Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;

    iput p2, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mGroupId:I

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->initializeVisibilityChangeConsumerMap()Ljava/util/EnumMap;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mVisibilityChangeConsumerMap:Ljava/util/EnumMap;

    return-void
.end method

.method public static synthetic access$000(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;)Lcom/sec/android/app/camera/interfaces/CameraSettings;
    .registers 1
...
.method public static synthetic access$100(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;)Lcom/sec/android/app/camera/interfaces/CameraSettings;
    .registers 1
...
.method public static synthetic access$200(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;)Lcom/sec/android/app/camera/shootingmode/abstraction/AbstractShootingModeContract$View;
    .registers 1
...
.method private addSefLensData(Lcom/sec/android/app/camera/engine/interfaces/Engine$SefDataHolder;Lcom/sec/android/app/camera/interfaces/CameraId;)V
    ...
    const-string v1, "DualRecordingV2Presenter"

    invoke-static {v1, v0}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget p0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mGroupId:I
    ...
    sget-object v0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$1;->$SwitchMap$com$sec$android$app$camera$interfaces$CameraId:[I
    ...
    :cond_40
    const-string p2, "Dual_Recording_Info_Back_Super_Tele"
    ...
    :cond_48
    const-string p2, "Dual_Recording_Info_Back_Tele"
    ...
    :cond_50
    const-string p2, "Dual_Recording_Info_Back_Wide"
    ...
    :cond_58
    const-string p2, "Dual_Recording_Info_Back_Ultra_Wide"
...
.method private getSAScreenID(I)Lcom/sec/android/app/camera/interfaces/SaLogScreenId;
    ...
    const-string p0, "DualRecordingV2Presenter"
...
.method private handleDualPipStateChange(II)V
    ...
    :goto_6
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->enableMultiCameraEffectPipRect(Z)V

    if-eq p1, p2, :cond_e

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->updatePipStandByLayout()V
    ...
    invoke-interface {p0, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->updatePipState(I)V
...
.method private handlePipSizeToggleChange()V
    ...
    sget-object v0, Lcom/sec/android/app/camera/interfaces/SaLogEventId;->DUAL_RECORDING_V2_PIP_SIZE:Lcom/sec/android/app/camera/interfaces/SaLogEventId;

    sget-object v2, Lcom/sec/android/app/camera/interfaces/SaLogDetail;->PIP_SIZE_EXPAND:Lcom/sec/android/app/camera/interfaces/SaLogDetail;
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/SaLogDetail;->PIP_SIZE_SHRINK:Lcom/sec/android/app/camera/interfaces/SaLogDetail;
...
.method private handleQuickSettingMenuVisibilityChanged(Z)V
    .registers 3
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->hideLensSelectButton()V
    ...
    sget-object p1, Lcom/sec/android/app/camera/engine/interfaces/RecordingManager$RecordingState;->STARTING:Lcom/sec/android/app/camera/engine/interfaces/RecordingManager$RecordingState;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->showLensSelectButton()V

    :cond_23
    return-void
.end method

.method private handleRecordingTypeChange(I)V
    .registers 5
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->refreshAeAfProperty()V

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->updatePipLayout()V
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->updatePipCameraFacing(I)V
    ...
    sget-object v2, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->DUAL_PIP_STATE:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    check-cast v0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;

    invoke-interface {v0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->hidePipLayout()V

    :cond_30
    :goto_30
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->setSaScreenIdByMultiRecordingType(I)V

    return-void
.end method

.method private handleSaveOptionChange(II)V
    .registers 5
    ...
    invoke-interface {v0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->refreshPipMenuLayout()V

    if-eq p1, p2, :cond_1c

    iget-object p1, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mHandler:Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;
...
.method private handleShootingModeChooserMenuVisibilityChanged(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->enableMultiCameraEffectPipRect(Z)V

    goto :goto_10

    :cond_7
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->isPipAvailable()Z

    move-result p1

    if-eqz p1, :cond_10

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->showPipRect()V
...
.method public static synthetic i(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;)V
    .registers 1

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->lambda$handleSaveOptionChange$1()V
...
.method private initializeVisibilityChangeConsumerMap()Ljava/util/EnumMap;
    ...
    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/a;-><init>(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;I)V
...
.method private isLensSelectButtonAvailable()Z
    .registers 4
    ...
    const-string v0, "isLensSelectButtonAvailable() : ShootingModeShortcut is scrolling"
...
.method private isLensSelectViewShowing()Z
    .registers 2
...
.method private isPipAvailable()Z
    ...
    sget-object v1, Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;->DUAL_RECORDING_LENS_SELECT:Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;
...
.method public static synthetic j(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;ZLcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$VisibilityChangeListener;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->lambda$onVisibilityChanged$0(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;ZLcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$VisibilityChangeListener;)V

    return-void
.end method

.method public static synthetic k(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->lambda$initializeVisibilityChangeConsumerMap$4(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V

    return-void
.end method

.method public static synthetic l(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->lambda$initializeVisibilityChangeConsumerMap$3(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V

    return-void
.end method

.method private synthetic lambda$handleSaveOptionChange$1()V
    .registers 3
...
.method private synthetic lambda$initializeVisibilityChangeConsumerMap$2(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handleShootingModeChooserMenuVisibilityChanged(Z)V
...
.method private synthetic lambda$initializeVisibilityChangeConsumerMap$3(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handleQuickSettingMenuVisibilityChanged(Z)V
...
.method public static synthetic m(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    .registers 3

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->lambda$initializeVisibilityChangeConsumerMap$2(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V

    return-void
.end method

.method public static bridge synthetic n(Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;)Z
    .registers 1
...
.method private sendSaLogRecordingStarted()V
    ...
    invoke-static {v2, v4, v0, v1}, Lcom/sec/android/app/camera/engine/core/callback/h;->p(Lcom/sec/android/app/camera/interfaces/CameraSettings;Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;Ljava/util/HashMap;Lcom/sec/android/app/camera/interfaces/SaLogEventKey;)V
    ...
    invoke-interface {v2}, Lcom/sec/android/app/camera/engine/interfaces/RecordingManager;->getRecordingOrientation()I
    ...
    invoke-interface {v4}, Lcom/sec/android/app/camera/engine/interfaces/Capability;->getSensorOrientation()I

    move-result v4

    const/4 v5, 0x0

    invoke-static {v2, v4, v5, v5}, Lcom/sec/android/app/camera/util/Util;->getOrientationString(IIZZ)Ljava/lang/String;
    ...
    sget-object v4, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->DUAL_RECORDING_SUB_LENS:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    invoke-static {v1, v2}, Lcom/sec/android/app/camera/logging/SaLogDetailConverter;->getDetailByDualRecordingV2LensSelection(II)Lcom/sec/android/app/camera/interfaces/SaLogDetail;
    ...
    sget-object v2, Lcom/sec/android/app/camera/interfaces/SaLogEventKey;->DUAL_RECORDING_V2_PIP_LENS_SELECTION:Lcom/sec/android/app/camera/interfaces/SaLogEventKey;
    ...
    :cond_5b
    sget-object v2, Lcom/sec/android/app/camera/interfaces/SaLogEventKey;->DUAL_RECORDING_V2_SPLIT_LENS_SELECTION:Lcom/sec/android/app/camera/interfaces/SaLogEventKey;
    ...
    invoke-static {v2}, Lcom/sec/android/app/camera/logging/SaLogDetailConverter;->getDetailByDualRecordingV2Resolution(I)Lcom/sec/android/app/camera/interfaces/SaLogDetail;
...
.method private showLensSelectButton()V
    .registers 2

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->isShowEffectButtonAvailable()Z
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->showLensSelectButton()V
...
.method private showPipRect()V
    ...
    check-cast v3, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;

    invoke-interface {v3, v0, v2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->showPipLayout(II)V
...
.method private updatePipCameraFacing(I)V
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->updatePipContentDescription(I)V
...
.method private updatePipLayout()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mHandler:Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;
    ...
    :cond_18
    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mHandler:Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$MainHandler;
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->hidePipLayout()V
...
.method private updatePipStandByLayout()V
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->showPipSizeToggleMenu()V
    ...
    invoke-interface {p0, v1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->showPipSizeOffMenu(Z)V
...
.method public handleShutterButtonClick(Lcom/sec/android/app/camera/interfaces/CameraContext$InputType;)Z
    ...
    sget-object p0, Lcom/sec/android/app/camera/interfaces/SaLogEventId;->DUAL_RECORDING_V2_CAPTURE_BUTTON:Lcom/sec/android/app/camera/interfaces/SaLogEventId;
...
.method public isShootingAvailable()Z
    ...
    const-string v0, "Shooting is not available because dual recording menu is visible."
...
.method public onActivate()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mVisibilityChangeConsumerMap:Ljava/util/EnumMap;
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->enableEngineEventListener(Z)V
...
.method public onCameraIdChanged(Lcom/sec/android/app/camera/interfaces/CameraId;IZ)V
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->updatePipCameraFacing(I)V
...
.method public onCameraSettingChanged(Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;II)V
    ...
    invoke-interface {p0, p3}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->updatePipType(I)V

    goto :goto_47

    :cond_3c
    invoke-direct {p0, p2, p3}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handleDualPipStateChange(II)V

    goto :goto_47

    :cond_40
    invoke-direct {p0, p3}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handleRecordingTypeChange(I)V

    goto :goto_47

    :cond_44
    invoke-direct {p0, p2, p3}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handleSaveOptionChange(II)V
...
.method public onConnectMakerPrepared(Lcom/sec/android/app/camera/interfaces/CameraId;Lcom/sec/android/app/camera/engine/interfaces/Capability;Lcom/sec/android/app/camera/engine/interfaces/ConnectionInfo;)V
    ...
    const-string p2, "DualRecordingV2Presenter"

    const-string v0, "onConnectMakerPrepared"

    invoke-static {p2, v0}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->isLensSelectViewShowing()Z
    ...
    invoke-interface {p2, p1}, Lcom/sec/android/app/camera/interfaces/CameraSettings;->getCameraFacing(Lcom/sec/android/app/camera/interfaces/CameraId;)I

    move-result p2

    if-nez p2, :cond_23

    sget-object p2, Lcom/sec/android/app/camera/interfaces/Resolution;->RESOLUTION_2560X1440:Lcom/sec/android/app/camera/interfaces/Resolution;

    invoke-virtual {p2}, Lcom/sec/android/app/camera/interfaces/Resolution;->getSize()Landroid/util/Size;

    move-result-object p2

    invoke-interface {p3, p2}, Lcom/sec/android/app/camera/engine/interfaces/ConnectionInfo;->setMainPreviewCallbackSize(Landroid/util/Size;)V

    goto :goto_43

    :cond_23
    sget-object p2, Lcom/sec/android/app/camera/interfaces/Resolution;->RESOLUTION_960X540:Lcom/sec/android/app/camera/interfaces/Resolution;
    ...
    :goto_43
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->getInitialZoomValue(Lcom/sec/android/app/camera/interfaces/CameraId;)I
...
.method public onLensSelectButtonClicked()V
    .registers 3

    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->isLensSelectButtonAvailable()Z
    ...
    invoke-interface {v0, v1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->hidePipStandByLayout(Z)V
...
.method public onPipRectDoubleClick()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->handlePipSizeToggleChange()V
...
.method public onPipRectMoveEnd()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->sendSaLogForMovePip()V
...
.method public onPipStateToggleMenuClick()V
    ...
    sget-object v0, Lcom/sec/android/app/camera/interfaces/SaLogEventId;->DUAL_RECORDING_V2_PIP_HIDE:Lcom/sec/android/app/camera/interfaces/SaLogEventId;
...
.method public onRecordingEvent(Lcom/sec/android/app/camera/engine/interfaces/RecordingManager$RecordingEvent;)V
    ...
    sget-object v0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter$1;->$SwitchMap$com$sec$android$app$camera$engine$interfaces$RecordingManager$RecordingEvent:[I
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->getSAScreenID(I)Lcom/sec/android/app/camera/interfaces/SaLogScreenId;
    ...
    check-cast p1, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;

    invoke-interface {p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->hideLensSelectButton()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->sendSaLogRecordingStarted()V
    ...
    invoke-static {p1, p0}, Lcom/sec/android/app/camera/logging/SaLogScreenIdConverter;->getMultiRecordingScreenIdForRecording(II)Lcom/sec/android/app/camera/interfaces/SaLogScreenId;
...
.method public onStartPreviewCompleted()V
    ...
    invoke-interface {v0, v1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Contract$View;->setPreviewRect(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0, p0}, Lcom/sec/android/app/camera/interfaces/KeyScreenLayerManager;->updateRightButtonContentDescription(Ljava/lang/String;)V
...
.method public onVideoSefUpdatePrepared(Lcom/sec/android/app/camera/interfaces/CameraId;Lcom/sec/android/app/camera/engine/interfaces/Engine$SefDataHolder;)V
    ...
    iget v0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mGroupId:I
    ...
    invoke-direct {p0, p2, p1}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->addSefLensData(Lcom/sec/android/app/camera/engine/interfaces/Engine$SefDataHolder;Lcom/sec/android/app/camera/interfaces/CameraId;)V
...
.method public onVisibilityChanged(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mVisibilityChangeConsumerMap:Ljava/util/EnumMap;
...
.method public startRecording()Z
    ...
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->getGroupId()I

    move-result v0

    iput v0, p0, Lcom/sec/android/app/camera/shootingmode/dualrecordingV2/DualRecordingV2Presenter;->mGroupId:I
