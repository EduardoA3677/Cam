...
.method public constructor <init>(Lcom/sec/android/app/camera/engine/interfaces/Engine;Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/shootingmode/qr/QrContract$View;I)V
    ...
    invoke-direct {p3, p0, p4}, LG2/k;-><init>(Ljava/lang/Object;I)V
...
.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/shootingmode/qr/QrContract$View;I)V
    ...
    invoke-direct {p3, p0, v0}, LG2/k;-><init>(Ljava/lang/Object;I)V
...
.method private decodeImageUri(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v1}, LP2/b;-><init>(Landroid/content/Context;LP2/a;)V
...
.method private decodeQrCode(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {p0, v0}, LP2/e;-><init>(LP2/d;)V
...
.method public static synthetic g(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;Landroidx/activity/result/ActivityResult;)V
    .registers 2
...
.method public static bridge synthetic h(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;)I
    .registers 1
...
.method private handleLinkAction(LO2/u;Ld1/s;Z)V
    .registers 9
    ...
    :try_start_2c
    invoke-static {v0, p1, p2}, LO2/m;->f(Landroid/content/Context;LO2/u;Ld1/s;)V

    goto :goto_3e

    :cond_30
    invoke-static {v0, p1, p2}, LO2/m;->h(Landroid/content/Context;LO2/u;Ld1/s;)Landroid/content/Intent;
    ...
    :try_end_43
    .catch Landroid/content/ActivityNotFoundException; {:try_start_2c .. :try_end_43} :catch_59
    .catch Ljava/lang/SecurityException; {:try_start_2c .. :try_end_43} :catch_44
...
.method private handleQrCodeDetected(Ljava/lang/String;[ILandroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    invoke-static {v0, p1}, LO2/B;->a(Landroid/content/Context;Ljava/lang/String;)LO2/w;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;
    ...
    iget-object p1, p1, LO2/w;->c:LO2/C;

    invoke-virtual {p1}, LO2/C;->b()Lcom/sec/android/app/camera/interfaces/SaLogDetail;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;
...
.method private handleRequestedScanAction(Ljava/lang/String;LO2/w;)V
    .registers 6
    ...
    invoke-static {v0, p1, v1}, LG2/u;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p2, LO2/w;->c:LO2/C;
    ...
    invoke-static {}, LO2/v;->values()[LO2/v;
    ...
    invoke-direct {v1, p1, v2}, LO2/k;-><init>(Ljava/lang/String;I)V
    ...
    sget-object v0, LO2/v;->EMPTY:LO2/v;
    ...
    iget-object p2, p2, LO2/w;->c:LO2/C;

    invoke-virtual {p1, p2}, LO2/v;->a(LO2/C;)LO2/u;
    ...
    :cond_44
    iget-object p2, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;

    iget-object p2, p2, LO2/w;->a:Ld1/s;

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleLinkAction(LO2/u;Ld1/s;Z)V
...
.method public static bridge synthetic i(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;Landroid/graphics/Bitmap;)V
    .registers 2
...
.method public static bridge synthetic j(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;IIII)Landroid/graphics/Matrix;
    .registers 11
...
.method public static bridge synthetic k(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;)Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter$QrDetectionState;
    .registers 1
...
.method public static bridge synthetic l(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;Ljava/lang/String;[ILandroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    .registers 5
...
.method public onFlashButtonClicked(Z)V
    ...
    const-string v0, "onFlashButtonClicked : activated="
...
.method public onGalleryButtonClicked()V
    ...
    :try_end_30
    .catch Landroid/content/ActivityNotFoundException; {:try_start_13 .. :try_end_30} :catch_31
...
.method public onQrCodeDetected(Ljava/lang/String;[ILandroid/graphics/Bitmap;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleQrCodeDetected(Ljava/lang/String;[ILandroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public onQrDetectAnimationFinished()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;

    invoke-direct {p0, v0, v1}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleRequestedScanAction(Ljava/lang/String;LO2/w;)V

    return-void

    :cond_34
    iget-object v0, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:LO2/w;

    iget-object v2, v2, LO2/w;->a:Ld1/s;

    invoke-direct {p0, v0, v2, v1}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleLinkAction(LO2/u;Ld1/s;Z)V
