...
.method private clearInactiveShootingMode()V
    ...
    invoke-static {v3, v4, v1}, Landroidx/concurrent/futures/a;->s(ILjava/lang/String;Ljava/lang/String;)V
...
.method private initializeCameraId(II)V
    ...
    move-result-object p1
    :try_end_32
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1e .. :try_end_32} :catch_38
...
.method private initializeQuickLaunchFacing(Landroid/content/Intent;)Z
    ...
    :sswitch_data_46
    .sparse-switch
        -0x7d98ff13 -> :sswitch_2d
        -0x569a6dc0 -> :sswitch_23
        -0x49a88781 -> :sswitch_19
        -0x3554c18d -> :sswitch_f
    .end sparse-switch
.end method
...
.method public clearShootingModeExtra()V
    ...
    invoke-static {p0, v0}, Lcom/sec/android/app/camera/engine/core/callback/h;->m(Lcom/sec/android/app/camera/interfaces/CameraContext;Ljava/lang/String;)V
...
.method public initializeView()V
    ...
    invoke-interface {v0, v1}, Lcom/sec/android/app/camera/interfaces/ShootingModeLayerManager;->setBackInvokedEventListener(Lcom/sec/android/app/camera/interfaces/ShootingModeLayerManager$BackInvokeEventListener;)V
...
.method public setShootingMode(IZ)V
    ...
    const-string v0, "ShootingMode - SetShootingMode"
    ...
    invoke-static {p1, v1, v2}, LG2/u;->v(ILjava/lang/String;Ljava/lang/String;)V
    ...
    check-cast v1, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl$ShootingMode;

    if-nez v1, :cond_60

    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl;->mShootingModeBuilderMap:Ljava/util/HashMap;
    ...
    check-cast v1, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl$Builder;

    invoke-static {v1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v2, p0, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl;->mCameraContext:Lcom/sec/android/app/camera/interfaces/CameraContext;

    invoke-interface {v1, v2, p1}, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl$Builder;->build(Lcom/sec/android/app/camera/interfaces/CameraContext;I)Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl$ShootingMode;
    ...
    iput-object v1, p0, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl;->mCurrentShootingMode:Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl$ShootingMode;

    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl;->mFeatureProvider:Lcom/sec/android/app/camera/shootingmode/feature/ShootingModeFeatureProviderImpl;

    invoke-virtual {v1, p1}, Lcom/sec/android/app/camera/shootingmode/feature/ShootingModeFeatureProviderImpl;->setShootingMode(I)V

    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/ShootingModeProviderImpl;->mCameraContext:Lcom/sec/android/app/camera/interfaces/CameraContext;

    invoke-interface {v1}, Lcom/sec/android/app/camera/interfaces/CameraContext;->isLayerInitialized()Z
