...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    check-cast p1, LD2/X4;

    iput-object p1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;
...
.method private setTimeBgWidth(Z)V
    ...
    iget-object v0, v0, LD2/X4;->a:Landroid/widget/TextView;
    ...
    iget-object p1, p1, LD2/X4;->e:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v2, v2, LD2/X4;->e:Landroid/widget/TextView;
    ...
    iget-object v2, v2, LD2/X4;->h:Landroid/widget/ImageView;

    invoke-virtual {v2, v1, v1}, Landroid/view/View;->measure(II)V

    iget-object v2, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v2, v2, LD2/X4;->g:Landroid/widget/ImageView;

    invoke-virtual {v2, v1, v1}, Landroid/view/View;->measure(II)V

    iget-object v1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v1, v1, LD2/X4;->h:Landroid/widget/ImageView;
    ...
    iget-object p1, p1, LD2/X4;->c:Landroid/widget/TextView;
    ...
    iget-object v2, v2, LD2/X4;->c:Landroid/widget/TextView;
    ...
    iget-object v2, v2, LD2/X4;->j:Landroid/widget/ImageView;

    invoke-virtual {v2, v1, v1}, Landroid/view/View;->measure(II)V

    iget-object v1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v1, v1, LD2/X4;->j:Landroid/widget/ImageView;
    ...
    iget-object v1, v1, LD2/X4;->f:Landroid/widget/ImageView;
...
.method private setTimeDividerLayoutMargin(I)V
    ...
    iget-object v0, v0, LD2/X4;->j:Landroid/widget/ImageView;
...
.method public final b(IZ)V
    ...
    invoke-direct {p2, p0, v0}, LS2/m;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
    ...
    iget-object p1, p1, LD2/X4;->f:Landroid/widget/ImageView;
...
.method public final e()V
    ...
    invoke-static {v2}, LG2/u;->w(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {v3, p0, v1}, LS2/m;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
    ...
    invoke-direct {v2, p0, v0}, LS2/n;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
...
.method public final f(FI)V
    ...
    iget-object v2, v2, LD2/X4;->b:Landroid/widget/RelativeLayout;

    invoke-virtual {v2, v1}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v1, v1, LD2/X4;->a:Landroid/widget/TextView;
    ...
    iget-object v4, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v4, v4, LD2/X4;->d:Landroid/widget/RelativeLayout;

    invoke-virtual {v4, v3}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v3, v3, LD2/X4;->c:Landroid/widget/TextView;

    invoke-virtual {v3, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v2, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object v2, v2, LD2/X4;->a:Landroid/widget/TextView;
    ...
    iget-object v2, v2, LD2/X4;->d:Landroid/widget/RelativeLayout;
    ...
    :cond_b5
    iget-object p2, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object p2, p2, LD2/X4;->a:Landroid/widget/TextView;
    ...
    iget-object p1, p1, LD2/X4;->i:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public final g()V
    ...
    invoke-direct {v1, p0, v2}, LS2/m;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
...
.method public final h()V
    ...
    iget-object v3, v3, LD2/X4;->b:Landroid/widget/RelativeLayout;
    ...
    iget-object v1, v1, LD2/X4;->g:Landroid/widget/ImageView;
    ...
    iget-object v0, v0, LD2/X4;->i:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public final i(Z)V
    ...
    invoke-direct {v1, p0, v0}, LS2/m;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
    ...
    invoke-direct {v1, p0, v2}, LS2/n;-><init>(Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;I)V
    ...
    iget-object v2, v1, LD2/X4;->f:Landroid/widget/ImageView;

    invoke-virtual {v2, p1}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, v1, LD2/X4;->j:Landroid/widget/ImageView;

    const/16 v2, 0x8

    invoke-virtual {p1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, v1, LD2/X4;->h:Landroid/widget/ImageView;

    invoke-virtual {p1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, v1, LD2/X4;->g:Landroid/widget/ImageView;

    invoke-virtual {p1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p1, v1, LD2/X4;->e:Landroid/widget/TextView;
...
.method public final j(JI)V
    ...
    iget-object v0, v0, LD2/X4;->b:Landroid/widget/RelativeLayout;

    invoke-virtual {v0, p1}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object p1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object p1, p1, LD2/X4;->a:Landroid/widget/TextView;
    ...
    iget-object p3, p3, LD2/X4;->d:Landroid/widget/RelativeLayout;

    invoke-virtual {p3, p2}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object p0, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->a:LD2/X4;

    iget-object p0, p0, LD2/X4;->c:Landroid/widget/TextView;
...
.method public setSystemTimerEventListener(LS2/o;)V
    .registers 2

    iput-object p1, p0, Lcom/sec/android/app/camera/widget/RecordingTimeIndicator;->i:LS2/o;
