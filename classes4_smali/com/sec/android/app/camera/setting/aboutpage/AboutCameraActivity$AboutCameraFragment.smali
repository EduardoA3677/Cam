...
.method private refreshConnectButton(I)V
    ...
    const-string p0, "refreshConnectButton: there is no case for updating. "
...
.method private showUpdateUsingDataInformationSecurityDialog()V
    ...
    iget-object v2, v1, LD2/E;->a:Landroid/widget/TextView;
...
.method private declared-synchronized startUpdateCheck(Z)V
    ...
    invoke-static {v1, v2}, Lcom/sec/android/app/camera/setting/aboutpage/AboutCameraActivity;->n(Lcom/sec/android/app/camera/setting/aboutpage/AboutCameraActivity;Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/camera/setting/aboutpage/AboutCameraActivity$AboutCameraFragment;->onUpdateCheckCompleted(I)V
    :try_end_55
    .catchall {:try_start_3 .. :try_end_55} :catchall_3e
    ...
    monitor-exit p0
    :try_end_58
    .catchall {:try_start_57 .. :try_end_58} :catchall_3e
