...
.method private final getCutoutForDisplay(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    :try_end_46
    .catch Ljava/lang/ClassNotFoundException; {:try_start_1 .. :try_end_46} :catch_52
    .catch Ljava/lang/NoSuchMethodException; {:try_start_1 .. :try_end_46} :catch_50
    .catch Ljava/lang/NoSuchFieldException; {:try_start_1 .. :try_end_46} :catch_4e
    .catch Ljava/lang/IllegalAccessException; {:try_start_1 .. :try_end_46} :catch_4c
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1 .. :try_end_46} :catch_4a
    .catch Ljava/lang/InstantiationException; {:try_start_1 .. :try_end_46} :catch_48
...
.method public final computeWindowBoundsP$window_release(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    move-result v2
    :try_end_28
    .catch Ljava/lang/NoSuchFieldException; {:try_start_12 .. :try_end_28} :catch_49
    .catch Ljava/lang/NoSuchMethodException; {:try_start_12 .. :try_end_28} :catch_47
    .catch Ljava/lang/IllegalAccessException; {:try_start_12 .. :try_end_28} :catch_45
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_12 .. :try_end_28} :catch_43
    ...
    throw v1
    :try_end_6d
    .catch Ljava/lang/NoSuchFieldException; {:try_start_2d .. :try_end_6d} :catch_49
    .catch Ljava/lang/NoSuchMethodException; {:try_start_2d .. :try_end_6d} :catch_47
    .catch Ljava/lang/IllegalAccessException; {:try_start_2d .. :try_end_6d} :catch_45
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_2d .. :try_end_6d} :catch_43
...
.method public final computeWindowBoundsQ$window_release(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    throw v0
    :try_end_46
    .catch Ljava/lang/NoSuchFieldException; {:try_start_d .. :try_end_46} :catch_3c
    .catch Ljava/lang/NoSuchMethodException; {:try_start_d .. :try_end_46} :catch_3a
    .catch Ljava/lang/IllegalAccessException; {:try_start_d .. :try_end_46} :catch_38
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_d .. :try_end_46} :catch_36
