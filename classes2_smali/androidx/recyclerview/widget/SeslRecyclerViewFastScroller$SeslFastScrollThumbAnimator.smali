...
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/drawable/LayerDrawable;)V
    ...
    invoke-direct {v1, p0, v2}, Landroidx/recyclerview/widget/b;-><init>(Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;I)V

    const/high16 v2, -0x40800000  # -1.0f

    invoke-direct {p1, v2, v0, v1}, Landroidx/recyclerview/animation/SeslFloatAnimatable;-><init>(FLandroidx/recyclerview/animation/SeslAnimatable$AnimationSpec;LJ3/k;)V
    ...
    invoke-direct {v2, p0, v4}, Landroidx/recyclerview/widget/b;-><init>(Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;I)V

    const/4 v4, -0x1

    invoke-direct {v0, v4, v1, v2}, Landroidx/recyclerview/animation/SeslColorAnimatable;-><init>(ILandroidx/recyclerview/animation/SeslAnimatable$AnimationSpec;LJ3/k;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/recyclerview/animation/SeslAnimatable;->tryAnimateTo(Ljava/lang/Object;)Lc5/k0;

    invoke-static {p2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p0

    invoke-virtual {v0, p0}, Landroidx/recyclerview/animation/SeslAnimatable;->tryAnimateTo(Ljava/lang/Object;)Lc5/k0;

    return-void
.end method

.method public static synthetic b(Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;Ljava/lang/Float;)Lv3/o;
    .registers 2

    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;->lambda$new$0(Ljava/lang/Float;)Lv3/o;
...
.method public static synthetic c(Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;Ljava/lang/Integer;)Lv3/o;
    .registers 2

    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/SeslRecyclerViewFastScroller$SeslFastScrollThumbAnimator;->lambda$new$1(Ljava/lang/Integer;)Lv3/o;
...
.method private synthetic lambda$new$0(Ljava/lang/Float;)Lv3/o;
    .registers 4
...
.method private synthetic lambda$new$1(Ljava/lang/Integer;)Lv3/o;
    .registers 3
...
.method public setDragging(Z)V
    ...
    invoke-virtual {v1, v0}, Landroidx/recyclerview/animation/SeslAnimatable;->tryAnimateTo(Ljava/lang/Object;)Lc5/k0;
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/animation/SeslAnimatable;->tryAnimateTo(Ljava/lang/Object;)Lc5/k0;
