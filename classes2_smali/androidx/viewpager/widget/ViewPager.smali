...
.method private determineTargetPage(IFII)I
    ...
    invoke-static {p0, p3}, Landroidx/compose/foundation/text/a;->m(Ljava/util/ArrayList;I)Ljava/lang/Object;
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    :try_end_1a
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_12 .. :try_end_1a} :catch_1b
...
.method private performDrag(FF)Z
    ...
    invoke-static {v8, v4}, Landroidx/compose/foundation/text/a;->m(Ljava/util/ArrayList;I)Ljava/lang/Object;
...
.method public populate(I)V
    ...
    if-ge v11, v7, :cond_19a

    cmpl-float v12, v3, v10

    if-ltz v12, :cond_164

    if-le v11, v1, :cond_164
    ...
    move-result-object v1
    :try_end_227
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_21b .. :try_end_227} :catch_228
    ...
    .line 73
    invoke-static {v3, v4, v5, v7, v6}, Landroidx/concurrent/futures/a;->v(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
