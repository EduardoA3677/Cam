...
.field private final workerJob:Lc5/s;
...
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper$Builder;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:Lc5/s;
...
.method public static final synthetic access$getWorkerJob$p(Landroidx/work/impl/WorkerWrapper;)Lc5/s;
    .registers 1

    iget-object p0, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:Lc5/s;
...
.method public static final synthetic access$runWorker(Landroidx/work/impl/WorkerWrapper;Lz3/d;)Ljava/lang/Object;
    .registers 2

    invoke-direct {p0, p1}, Landroidx/work/impl/WorkerWrapper;->runWorker(Lz3/d;)Ljava/lang/Object;
...
.method private final iterativelyFailWorkAndDependents(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lw3/u;->T([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {p1}, Lw3/z;->m0(Ljava/util/List;)Ljava/lang/Object;
...
.method private final runWorker(Lz3/d;)Ljava/lang/Object;
    .registers 25
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v1, v0}, Landroidx/work/impl/WorkerWrapper$runWorker$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lz3/d;)V
    ...
    :try_end_33
    .catch Ljava/util/concurrent/CancellationException; {:try_start_30 .. :try_end_33} :catch_3c
    ...
    invoke-direct {v8, v1, v9}, Landroidx/work/impl/f;-><init>(Landroidx/work/impl/WorkerWrapper;I)V
    ...
    invoke-static {v9, v10}, Lw3/t;->N0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v9}, Landroidx/work/Configuration;->getWorkerCoroutineContext()Lz3/i;
    ...
    invoke-direct/range {v9 .. v21}, Landroidx/work/WorkerParameters;-><init>(Ljava/util/UUID;Landroidx/work/Data;Ljava/util/Collection;Landroidx/work/WorkerParameters$RuntimeExtras;IILjava/util/concurrent/Executor;Lz3/i;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkerFactory;Landroidx/work/ProgressUpdater;Landroidx/work/ForegroundUpdater;)V
    ...
    move-result-object v3
    :try_end_146
    .catchall {:try_start_136 .. :try_end_146} :catchall_147
    ...
    invoke-interface {v2}, Lz3/d;->getContext()Lz3/i;

    move-result-object v5

    sget-object v6, Lc5/j0;->a:Lc5/j0;

    invoke-interface {v5, v6}, Lz3/i;->get(Lz3/h;)Lz3/g;

    move-result-object v5

    invoke-static {v5}, Lkotlin/jvm/internal/p;->b(Ljava/lang/Object;)V

    check-cast v5, Lc5/k0;
    ...
    invoke-interface {v5, v6}, Lc5/k0;->o(LJ3/k;)Lc5/T;
    ...
    invoke-direct {v0, v8, v4, v6}, Landroidx/work/impl/WorkerWrapper$Resolution$ResetWorkerStatus;-><init>(IILkotlin/jvm/internal/h;)V
    ...
    invoke-interface {v5}, Lc5/k0;->isCancelled()Z
    ...
    invoke-static {v4}, Lc5/G;->n(Ljava/util/concurrent/Executor;)Lc5/z;
    ...
    invoke-direct {v5, v1, v3, v0, v6}, Landroidx/work/impl/WorkerWrapper$runWorker$result$1;-><init>(Landroidx/work/impl/WorkerWrapper;Landroidx/work/ListenableWorker;Landroidx/work/ForegroundUpdater;Lz3/d;)V
    ...
    invoke-static {v4, v5, v2}, Lc5/G;->I(Lz3/i;LJ3/n;Lz3/d;)Ljava/lang/Object;
    ...
    :try_end_1f7
    .catch Ljava/util/concurrent/CancellationException; {:try_start_1d5 .. :try_end_1f7} :catch_1fa
    .catchall {:try_start_1d5 .. :try_end_1f7} :catchall_1f8
    ...
    invoke-static {v4, v5, v6}, Landroidx/concurrent/futures/a;->n(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v1, v5}, Landroidx/concurrent/futures/a;->n(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final trySetRunning()Z
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/f;-><init>(Landroidx/work/impl/WorkerWrapper;I)V
...
.method public final interrupt(I)V
    ...
    invoke-virtual {p0, v0}, Lc5/u0;->y(Ljava/util/concurrent/CancellationException;)V
...
.method public final launch()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-interface {v0}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()Lc5/z;
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/WorkerWrapper$launch$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lz3/d;)V

    const/4 p0, 0x2

    invoke-static {v0, v2, v1, p0, v2}, Landroidx/work/ListenableFutureKt;->launchFuture$default(Lz3/i;Lc5/F;LJ3/n;ILjava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
