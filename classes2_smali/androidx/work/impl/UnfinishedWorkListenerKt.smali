...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lc5/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V",
        "",
        "TAG",
        "Ljava/lang/String;",
        "",
...
.method public static final maybeLaunchUnfinishedWorkListener(Lc5/D;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
    .registers 7
    ...
    invoke-interface {p2}, Landroidx/work/impl/model/WorkSpecDao;->hasUnfinishedWorkFlow()Lf5/j;
    ...
    invoke-direct {p3, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$1;-><init>(Lz3/d;)V

    new-instance v1, Lf5/v;

    const/4 v2, 0x0

    invoke-direct {v1, p2, p3, v2}, Lf5/v;-><init>(Lf5/j;Lv3/a;I)V

    const/4 p2, -0x1

    invoke-static {v1, p2}, Lf5/b0;->f(Lf5/j;I)Lf5/j;

    move-result-object p2

    invoke-static {p2}, Lf5/b0;->k(Lf5/j;)Lf5/j;

    move-result-object p2

    new-instance p3, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;

    invoke-direct {p3, p1, v0}, Landroidx/work/impl/UnfinishedWorkListenerKt$maybeLaunchUnfinishedWorkListener$2;-><init>(Landroid/content/Context;Lz3/d;)V

    new-instance p1, Lf5/y;

    const/4 v1, 0x1

    invoke-direct {p1, p2, p3, v1}, Lf5/y;-><init>(Lf5/j;LJ3/n;I)V

    new-instance p2, Lf5/m;

    invoke-direct {p2, p1, v0}, Lf5/m;-><init>(Lf5/y;Lz3/d;)V

    const/4 p1, 0x3

    invoke-static {p0, v0, v0, p2, p1}, Lc5/G;->y(Lc5/D;Lz3/i;Lc5/F;LJ3/n;I)Lc5/D0;
