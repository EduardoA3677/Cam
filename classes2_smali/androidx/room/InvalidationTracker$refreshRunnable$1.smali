...
.method private final checkUpdatedTable()Ljava/util/Set;
    ...
    invoke-virtual {v1, v2}, Lx3/j;->add(Ljava/lang/Object;)Z
    :try_end_2a
    ...
    :cond_2d
    invoke-static {v0, v3}, LQ3/I;->j(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {v1}, Lw3/N;->a(Lx3/j;)Lx3/j;

    move-result-object v0

    iget-object v1, v0, Lx3/j;->a:Lx3/g;

    invoke-virtual {v1}, Lx3/g;->isEmpty()Z
...
.method public run()V
    ...
    move-result v1
    :try_end_13
    .catch Ljava/lang/IllegalStateException; {:try_start_d .. :try_end_13} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_d .. :try_end_13} :catch_88
    ...
    move-result v1
    :try_end_30
    .catch Ljava/lang/IllegalStateException; {:try_start_24 .. :try_end_30} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_24 .. :try_end_30} :catch_88
    ...
    move-result v1
    :try_end_4b
    .catch Ljava/lang/IllegalStateException; {:try_start_41 .. :try_end_4b} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_41 .. :try_end_4b} :catch_88
    ...
    :try_end_6d
    .catch Ljava/lang/IllegalStateException; {:try_start_5c .. :try_end_6d} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_5c .. :try_end_6d} :catch_88
    ...
    :try_end_74
    .catchall {:try_start_6d .. :try_end_74} :catchall_8c

    :try_start_74
    invoke-interface {v1}, Landroidx/sqlite/db/SupportSQLiteDatabase;->endTransaction()V
    :try_end_77
    .catch Ljava/lang/IllegalStateException; {:try_start_74 .. :try_end_77} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_74 .. :try_end_77} :catch_88
    ...
    throw v2
    :try_end_91
    .catch Ljava/lang/IllegalStateException; {:try_start_8d .. :try_end_91} :catch_8a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_8d .. :try_end_91} :catch_88
    ...
    sget-object v2, Lw3/D;->a:Lw3/D;
    :try_end_af
    .catchall {:try_start_a6 .. :try_end_af} :catchall_86
