...
.method private final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v0}, Lx3/j;->add(Ljava/lang/Object;)Z
    :try_end_3a
    ...
    invoke-static {p1, p2}, LQ3/I;->j(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {p0}, Lw3/N;->a(Lx3/j;)Lx3/j;
...
.method private final readOptions(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    move-result p2
    :try_end_1b
    .catchall {:try_start_17 .. :try_end_1b} :catchall_28
    ...
    const-string p2, ""
    :try_end_2c
    .catchall {:try_start_1f .. :try_end_2c} :catchall_28
...
.method public final parseOptions(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v0, v1, v1, p0}, La5/f;->W(Ljava/lang/CharSequence;CIZI)I
    ...
    invoke-static {p1, v2}, La5/f;->b0(Ljava/lang/String;C)I
    ...
    :goto_126
    if-ge v5, v4, :cond_113

    aget-object v6, v3, v5

    invoke-static {v2, v6}, La5/n;->P(Ljava/lang/String;Ljava/lang/String;)Z
