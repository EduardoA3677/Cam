...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 13
    iput v1, p0, Landroidx/core/widget/NestedScrollView;->mShowFadeOutGTT:I
    ...
    .line 16
    iput v1, p0, Landroidx/core/widget/NestedScrollView;->mSeslOverlayFeatureHeight:I

    .line 17
    iput-boolean v1, p0, Landroidx/core/widget/NestedScrollView;->mIsSupportGoToTop:Z

    .line 18
    iput-boolean v1, p0, Landroidx/core/widget/NestedScrollView;->mEnableGoToTop:Z
    ...
    iput-object v4, p0, Landroidx/core/widget/NestedScrollView;->SINE_IN_OUT_70:Landroid/view/animation/Interpolator;
    ...
    iput-object v5, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeOutRunnable:Ljava/lang/Runnable;

    .line 29
    new-instance v5, Landroidx/core/widget/NestedScrollView$2;

    invoke-direct {v5, p0}, Landroidx/core/widget/NestedScrollView$2;-><init>(Landroidx/core/widget/NestedScrollView;)V

    iput-object v5, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeInRunnable:Ljava/lang/Runnable;

    .line 30
    new-instance v5, Landroidx/core/widget/NestedScrollView$3;

    invoke-direct {v5, p0}, Landroidx/core/widget/NestedScrollView$3;-><init>(Landroidx/core/widget/NestedScrollView;)V

    iput-object v5, p0, Landroidx/core/widget/NestedScrollView;->mAutoHide:Ljava/lang/Runnable;
    ...
    .line 40
    iput-wide v5, p0, Landroidx/core/widget/NestedScrollView;->mHoverRecognitionCurrentTime:J
    ...
    invoke-direct {v3, v5, v2}, Landroidx/core/view/DifferentialMotionFlingController;-><init>(Landroid/content/Context;Landroidx/core/view/DifferentialMotionFlingTarget;)V
...
.method public static synthetic access$000(Landroidx/core/widget/NestedScrollView;)V
    .registers 1
...
.method public static synthetic access$100(Landroidx/core/widget/NestedScrollView;)V
    .registers 1
...
.method public static synthetic access$1300(Landroidx/core/widget/NestedScrollView;)Z
    .registers 1
...
.method public static synthetic access$500(Landroidx/core/widget/NestedScrollView;)Landroid/widget/ImageView;
    .registers 1

    iget-object p0, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopView:Landroid/widget/ImageView;

    return-object p0
.end method

.method public static synthetic access$602(Landroidx/core/widget/NestedScrollView;I)I
    .registers 2

    iput p1, p0, Landroidx/core/widget/NestedScrollView;->mShowFadeOutGTT:I
...
.method public static synthetic access$800(Landroidx/core/widget/NestedScrollView;Landroid/os/Message;)V
    .registers 2
...
.method private autoHide(I)V
    ...
    iget-object p1, p0, Landroidx/core/widget/NestedScrollView;->mAutoHide:Ljava/lang/Runnable;
...
.method private findAndGetDimension(Ljava/lang/String;I)I
    ...
    move-result p0
    :try_end_1c
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_12 .. :try_end_1c} :catch_1d
...
.method private initGoToTop(ZZ)Z
    .registers 6
    ...
    iget v1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopElevation:I
    ...
    iput-object v1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopView:Landroid/widget/ImageView;

    :cond_28
    if-eqz p2, :cond_2d

    const-string p2, "sesl_go_to_top_background_light"

    goto :goto_2f

    :cond_2d
    const-string p2, "sesl_go_to_top_background_dark"

    :goto_2f
    invoke-direct {p0, p2}, Landroidx/core/widget/NestedScrollView;->findAndGetDrawable(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopView:Landroid/widget/ImageView;
    ...
    iget-boolean p2, p0, Landroidx/core/widget/NestedScrollView;->mEnableGoToTop:Z
    ...
    :cond_6a
    :goto_6a
    iput-boolean p1, p0, Landroidx/core/widget/NestedScrollView;->mEnableGoToTop:Z

    new-array p1, v0, [F

    fill-array-data p1, :array_c6

    invoke-static {p1}, Landroid/animation/ValueAnimator;->ofFloat([F)Landroid/animation/ValueAnimator;

    move-result-object p1

    iput-object p1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeInAnimator:Landroid/animation/ValueAnimator;

    const-wide/16 v1, 0x14d

    invoke-virtual {p1, v1, v2}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object p1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeInAnimator:Landroid/animation/ValueAnimator;

    iget-object p2, p0, Landroidx/core/widget/NestedScrollView;->SINE_IN_OUT_70:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeInAnimator:Landroid/animation/ValueAnimator;

    new-instance p2, Landroidx/core/widget/NestedScrollView$5;

    invoke-direct {p2, p0}, Landroidx/core/widget/NestedScrollView$5;-><init>(Landroidx/core/widget/NestedScrollView;)V

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-array p1, v0, [F

    fill-array-data p1, :array_ce
    ...
    sget-object p2, Landroidx/core/widget/NestedScrollView;->LINEAR_INTERPOLATOR:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p1, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeOutAnimator:Landroid/animation/ValueAnimator;

    new-instance p2, Landroidx/core/widget/NestedScrollView$6;

    invoke-direct {p2, p0}, Landroidx/core/widget/NestedScrollView$6;-><init>(Landroidx/core/widget/NestedScrollView;)V
    ...
    const-string p2, "GTT not support : maybe not contains AppCompat "
...
.method private setupGoToTop(I)V
    ...
    invoke-direct {p0}, Landroidx/core/widget/NestedScrollView;->isTalkBackIsRunning()Z
    ...
    iget-object v2, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeOutRunnable:Ljava/lang/Runnable;
    ...
    iget-object v2, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopFadeInRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v2}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    :cond_51
    iget v2, p0, Landroidx/core/widget/NestedScrollView;->mShowFadeOutGTT:I

    if-nez v2, :cond_60

    if-nez p1, :cond_60

    iget v2, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopLastState:I
    ...
    :cond_b1
    iget-object v2, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopView:Landroid/widget/ImageView;
...
.method public dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    if-lt v6, v0, :cond_201

    if-gt v6, v7, :cond_201
    ...
    if-le v6, v0, :cond_21f

    iget v0, p0, Landroidx/core/widget/NestedScrollView;->mHoverBottomAreaHeight:I

    sub-int/2addr v7, v0

    if-lt v6, v7, :cond_227
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, v0, Landroidx/core/widget/NestedScrollView;->mHoverHandler:Landroidx/core/widget/NestedScrollView$HoverScrollHandler;

    if-nez v5, :cond_1f

    new-instance v5, Landroidx/core/widget/NestedScrollView$HoverScrollHandler;

    invoke-direct {v5, v0}, Landroidx/core/widget/NestedScrollView$HoverScrollHandler;-><init>(Landroidx/core/widget/NestedScrollView;)V

    iput-object v5, v0, Landroidx/core/widget/NestedScrollView;->mHoverHandler:Landroidx/core/widget/NestedScrollView$HoverScrollHandler;
    ...
    if-eq v10, v14, :cond_7f

    goto/16 :goto_100

    :cond_7f
    invoke-direct/range {p0 .. p0}, Landroidx/core/widget/NestedScrollView;->isSupportGotoTop()Z

    move-result v14

    if-eqz v14, :cond_100

    iget v14, v0, Landroidx/core/widget/NestedScrollView;->mGoToTopState:I

    if-eqz v14, :cond_100

    iget-object v14, v0, Landroidx/core/widget/NestedScrollView;->mGoToTopImage:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/core/widget/NestedScrollView;->canScrollUp()Z

    move-result v1

    if-eqz v1, :cond_c8

    new-instance v1, Landroidx/core/widget/NestedScrollView$8;

    invoke-direct {v1, v0}, Landroidx/core/widget/NestedScrollView$8;-><init>(Landroidx/core/widget/NestedScrollView;)V
    ...
    if-eq v14, v9, :cond_100

    iget-object v14, v0, Landroidx/core/widget/NestedScrollView;->mGoToTopRect:Landroid/graphics/Rect;
    ...
    :cond_100
    :goto_100
    iget v14, v0, Landroidx/core/widget/NestedScrollView;->mHoverTopAreaHeight:I

    const-wide/16 v11, 0x0

    if-le v2, v14, :cond_10b

    iget v14, v0, Landroidx/core/widget/NestedScrollView;->mHoverBottomAreaHeight:I

    sub-int/2addr v3, v14

    if-lt v2, v3, :cond_1be
    ...
    :cond_173
    iget-object v1, v0, Landroidx/core/widget/NestedScrollView;->mHoverHandler:Landroidx/core/widget/NestedScrollView$HoverScrollHandler;
    ...
    :cond_180
    iput-wide v11, v0, Landroidx/core/widget/NestedScrollView;->mHoverRecognitionStartTime:J

    iput-wide v11, v0, Landroidx/core/widget/NestedScrollView;->mHoverScrollStartTime:J
    ...
    .packed-switch 0xd3
        ...
        :pswitch_144  #000000d4
        :pswitch_128  #000000d5
    .end packed-switch
.end method
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0}, Landroidx/core/widget/NestedScrollView;->drawGoToTop()V
...
.method public onLayout(ZIIII)V
    ...
    sget v1, Landroidx/core/R$dimen;->sesl_nestedscrollview_overlay_feature_hidden_height:I
...
.method public seslSetGoToTopEnabled(ZI)V
    ...
    iput v0, p0, Landroidx/core/widget/NestedScrollView;->mGoToTopBottomPadding:I
    ...
    .line 6
    :goto_23
    invoke-direct {p0, p1, p2}, Landroidx/core/widget/NestedScrollView;->initGoToTop(ZZ)Z
