...
.field private final eventChannel:Le5/i;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/glance/session/Session$Companion;-><init>(Lkotlin/jvm/internal/h;)V
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, v1}, Lj2/b;->a(IILe5/a;)Le5/e;

    move-result-object p1

    iput-object p1, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;

    return-void
.end method

.method public static synthetic onCompositionError$suspendImpl(Landroidx/glance/session/Session;Landroid/content/Context;Ljava/lang/Throwable;Lz3/d;)Ljava/lang/Object;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final close()V
    ...
    iget-object v0, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Le5/v;->l(Ljava/lang/Throwable;)Z
...
.method public onCompositionError(Landroid/content/Context;Ljava/lang/Throwable;Lz3/d;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/glance/session/Session;->onCompositionError$suspendImpl(Landroidx/glance/session/Session;Landroid/content/Context;Ljava/lang/Throwable;Lz3/d;)Ljava/lang/Object;
...
.method public abstract processEmittableTree(Landroid/content/Context;Landroidx/glance/EmittableWithChildren;Lz3/d;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public abstract processEvent(Landroid/content/Context;Ljava/lang/Object;Lz3/d;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public abstract provideGlance(Landroid/content/Context;)LJ3/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
...
.method public final receiveEvents(Landroid/content/Context;LJ3/k;Lz3/d;)Ljava/lang/Object;
    .registers 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p3}, Landroidx/glance/session/Session$receiveEvents$1;-><init>(Landroidx/glance/session/Session;Lz3/d;)V
    ...
    :try_end_3d
    .catch Le5/n; {:try_start_3a .. :try_end_3d} :catch_43
    ...
    invoke-static {p3}, Ll0/a;->x(Ljava/lang/Object;)V
    :try_end_61
    .catch Le5/n; {:try_start_5e .. :try_end_61} :catch_43
    ...
    iget-object v3, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;
    ...
    iget-object p3, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;

    invoke-interface {p3}, Le5/u;->iterator()Le5/b;
    ...
    invoke-virtual {p3, v1}, Le5/b;->b(LB3/c;)Ljava/lang/Object;

    move-result-object v0
    :try_end_8c
    .catch Le5/n; {:try_start_65 .. :try_end_8c} :catch_cf
    ...
    invoke-interface {p1, p3}, LJ3/k;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, p3, v1}, Landroidx/glance/session/Session;->processEvent(Landroid/content/Context;Ljava/lang/Object;Lz3/d;)Ljava/lang/Object;

    move-result-object p3
    :try_end_c9
    .catch Le5/n; {:try_start_96 .. :try_end_c9} :catch_43
...
.method public final sendEvent(Ljava/lang/Object;Lz3/d;)Ljava/lang/Object;
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2}, Landroidx/glance/session/Session$sendEvent$1;-><init>(Landroidx/glance/session/Session;Lz3/d;)V
    ...
    :try_end_2e
    .catch Le5/o; {:try_start_2b .. :try_end_2e} :catch_2f
    ...
    invoke-interface {v3}, Le5/v;->isClosedForSend()Z

    move-result v3

    iget-object v6, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;

    invoke-interface {v6}, Le5/u;->isClosedForReceive()Z
    ...
    iget-object p2, p0, Landroidx/glance/session/Session;->eventChannel:Le5/i;
    ...
    invoke-interface {p2, p1, v1}, Le5/v;->b(Ljava/lang/Object;Lz3/d;)Ljava/lang/Object;

    move-result-object p0
    :try_end_73
    .catch Le5/o; {:try_start_3c .. :try_end_73} :catch_2f
