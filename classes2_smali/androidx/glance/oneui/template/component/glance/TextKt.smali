...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "textColor",
        "Lv3/o;",
        "GlanceAutoText-2T94tj4",
        "(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V",
        "GlanceAutoText",
        "GlanceText-2T94tj4",
        "GlanceText",
...
# direct methods
.method public static final GlanceAutoText-2T94tj4(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    .registers 27
    ...
    const-string v8, "androidx.glance.oneui.template.component.glance.GlanceAutoText (Text.kt:41)"
    ...
    sget-object v7, Landroidx/glance/appwidget/util/FontUtils;->INSTANCE:Landroidx/glance/appwidget/util/FontUtils;

    invoke-virtual/range {p2 .. p2}, Landroidx/glance/text/TextPercentData;->getMinSize()F
    ...
    sget-object v10, Landroidx/glance/text/FontFamily;->Companion:Landroidx/glance/text/FontFamily$Companion;

    invoke-virtual {v10}, Landroidx/glance/text/FontFamily$Companion;->getSec()Landroidx/glance/text/FontFamily;
    ...
    invoke-virtual/range {v7 .. v16}, Landroidx/glance/appwidget/util/FontUtils;->calculateWidth-_9VYaYk(Landroid/content/Context;Ljava/lang/String;FFFFILandroidx/glance/text/FontFamily;I)F

    move-result v0

    new-instance v8, Landroidx/glance/oneui/template/layout/TextSize;

    const/4 v7, 0x0

    move/from16 v15, p3

    invoke-direct {v8, v15, v3, v7}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(ILandroidx/glance/text/TextPercentData;Lkotlin/jvm/internal/h;)V
    ...
    invoke-static {v4, v7, v1, v9}, Landroidx/glance/appwidget/percent/SizeModifiersKt;->height(Landroidx/glance/GlanceModifier;FLandroidx/compose/runtime/Composer;I)Landroidx/glance/GlanceModifier;

    move-result-object v7

    invoke-static {v7, v0}, Landroidx/glance/layout/SizeModifiersKt;->width-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    invoke-static/range {v7 .. v17}, Landroidx/glance/appwidget/util/FontUtils;->autoTextSizeByDp-HbfmOzc$default(Landroidx/glance/appwidget/util/FontUtils;Landroid/content/Context;Ljava/lang/String;FFFFLandroidx/glance/text/FontFamily;IILjava/lang/Object;)F
    ...
    new-instance v9, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceAutoText$1;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceAutoText$1;-><init>(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;II)V
...
.method public static final GlanceText(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;Landroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v6, "androidx.glance.oneui.template.component.glance.GlanceText (Text.kt:193)"
    ...
    :cond_5a
    invoke-virtual/range {p0 .. p0}, Landroidx/glance/oneui/template/BaseComponent;->getKeepColor()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroidx/glance/oneui/template/layout/TextSize;->getPercentData()Landroidx/glance/text/TextPercentData;

    move-result-object v28

    invoke-virtual/range {p0 .. p0}, Landroidx/glance/oneui/template/TextData;->getTextVerticalAlign-J86Ipig()I

    move-result v8

    invoke-virtual/range {p0 .. p0}, Landroidx/glance/oneui/template/TextData;->getTextAppearanceResource()I

    move-result v30

    new-instance v9, Landroidx/glance/text/TextStyle;
    ...
    invoke-static {v8}, Landroidx/glance/text/TextVerticalAlign;->box-impl(I)Landroidx/glance/text/TextVerticalAlign;
    ...
    invoke-static {v13, v5}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->contentDescription(Landroidx/glance/GlanceModifier;Ljava/lang/String;)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v5, v6}, Landroidx/glance/oneui/template/utils/GlanceModifierUtilsKt;->maybeAnimation(Landroidx/glance/GlanceModifier;Landroidx/glance/appwidget/animation/RemoteAnimation;)Landroidx/glance/GlanceModifier;
    ...
    :goto_f0
    invoke-static {v5, v6}, Landroidx/glance/appwidget/AppWidgetModifiersKt;->alpha(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    invoke-static {v5, v6}, Landroidx/glance/appwidget/AppWidgetModifiersKt;->keepColor(Landroidx/glance/GlanceModifier;Z)Landroidx/glance/GlanceModifier;
    ...
    new-instance v8, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$5;
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$5;-><init>(Landroidx/glance/oneui/template/TextData;Landroidx/glance/oneui/template/layout/TextSize;Landroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;II)V

    invoke-interface {v0, v8}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V

    :cond_168
    return-void
.end method

.method public static final GlanceText-2T94tj4(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    .registers 34
    ...
    const-string v2, "androidx.glance.oneui.template.component.glance.GlanceText (Text.kt:95)"
    ...
    invoke-direct {v2, v14, v8, v0}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(ILandroidx/glance/text/TextPercentData;Lkotlin/jvm/internal/h;)V
    ...
    invoke-static {v13, v0, v12, v1}, Landroidx/glance/appwidget/percent/SizeModifiersKt;->height(Landroidx/glance/GlanceModifier;FLandroidx/compose/runtime/Composer;I)Landroidx/glance/GlanceModifier;
    ...
    sget-object v15, Landroidx/glance/appwidget/util/FontUtils;->INSTANCE:Landroidx/glance/appwidget/util/FontUtils;
    ...
    invoke-static/range {v15 .. v25}, Landroidx/glance/appwidget/util/FontUtils;->autoTextSizeByDp-HbfmOzc$default(Landroidx/glance/appwidget/util/FontUtils;Landroid/content/Context;Ljava/lang/String;FFFFLandroidx/glance/text/FontFamily;IILjava/lang/Object;)F

    move-result v1

    new-instance v15, Landroidx/glance/oneui/template/layout/TextSize;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFLandroidx/glance/text/TextPercentData;ILkotlin/jvm/internal/h;)V

    invoke-static {v13, v8}, Landroidx/glance/layout/SizeModifiersKt;->height-3ABfNKs(Landroidx/glance/GlanceModifier;F)Landroidx/glance/GlanceModifier;
    ...
    new-instance v12, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$1;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$1;-><init>(Landroidx/glance/GlanceModifier;Landroidx/glance/oneui/template/TextData;Landroidx/glance/text/TextPercentData;ILandroidx/glance/unit/ColorProvider;II)V
...
.method public static final GlanceText-4QGO3ko(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/text/ComplexUnit;ILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.glance.GlanceText (Text.kt:178)"
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(ILandroidx/glance/text/ComplexUnit;IFLkotlin/jvm/internal/h;)V
    ...
    new-instance v15, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$4;
    ...
    invoke-direct/range {v0 .. v9}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$4;-><init>(Landroidx/glance/oneui/template/TextData;ILandroidx/glance/text/ComplexUnit;ILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;FII)V

    invoke-interface {v12, v15}, Landroidx/compose/runtime/ScopeUpdateScope;->updateScope(LJ3/n;)V
...
.method public static final GlanceText-FbLeKfk(Landroidx/glance/oneui/template/TextData;FILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v7, "androidx.glance.oneui.template.component.glance.GlanceText (Text.kt:143)"
    ...
    invoke-direct/range {v8 .. v14}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFILkotlin/jvm/internal/h;)V
    ...
    new-instance v9, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$2;
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$2;-><init>(Landroidx/glance/oneui/template/TextData;FILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;II)V
...
.method public static final GlanceText-KuOwvYU(Landroidx/glance/oneui/template/TextData;JILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;FLandroidx/compose/runtime/Composer;II)V
    ...
    const-string v2, "androidx.glance.oneui.template.component.glance.GlanceText (Text.kt:160)"
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/glance/oneui/template/layout/TextSize;-><init>(FLandroidx/glance/text/ComplexUnit;IFLkotlin/jvm/internal/h;)V
    ...
    new-instance v14, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$3;
    ...
    invoke-direct/range {v0 .. v9}, Landroidx/glance/oneui/template/component/glance/TextKt$GlanceText$3;-><init>(Landroidx/glance/oneui/template/TextData;JILandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;FII)V
