...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "secondaryContent",
        "SmallLayout",
        "(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/PrimaryContentData;Landroidx/glance/oneui/template/SecondaryContentData;LJ3/n;LJ3/n;Landroidx/compose/runtime/Composer;II)V",
...
# direct methods
.method public static final SmallLayout(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/PrimaryContentData;Landroidx/glance/oneui/template/SecondaryContentData;LJ3/n;LJ3/n;Landroidx/compose/runtime/Composer;II)V
    .registers 32
    ...
    const-string v8, "androidx.glance.oneui.template.layout.compose.combine.SmallLayout (SmallLayout.kt:37)"
    ...
    invoke-static {v8, v7, v1, v9, v14}, Landroidx/compose/foundation/text/a;->i(Landroidx/compose/foundation/layout/Arrangement;Landroidx/compose/ui/Alignment$Vertical;Landroidx/compose/runtime/Composer;II)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-static {v13, v11, v7, v11, v8}, Landroidx/collection/a;->f(Landroidx/compose/ui/node/ComposeUiNode$Companion;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/layout/MeasurePolicy;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/unit/Density;)LJ3/n;
    ...
    invoke-static {v11, v12, v7, v1, v10}, Landroidx/collection/a;->y(ILJ3/o;Landroidx/compose/runtime/SkippableUpdater;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-virtual {v7, v0}, Landroidx/glance/oneui/template/size/CombineTemplatePercent;->getButtonSize-L2j3NV4(I)Lv3/h;
    ...
    iget-object v9, v7, Lv3/h;->a:Ljava/lang/Object;
    ...
    iget-object v7, v7, Lv3/h;->b:Ljava/lang/Object;
    ...
    invoke-static {v13, v7, v8}, Landroidx/compose/foundation/layout/SizeKt;->size-6HolHcs(Landroidx/compose/ui/Modifier;J)Landroidx/compose/ui/Modifier;
    ...
    invoke-static/range {v7 .. v12}, Landroidx/glance/oneui/template/layout/compose/combine/SmallLayoutKt;->SmallLayout$PrimaryContent(LJ3/n;Landroidx/glance/oneui/template/PrimaryContentData;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-static {v2, v8, v1, v8, v7}, Landroidx/collection/a;->h(Landroidx/compose/ui/Alignment$Companion;ZLandroidx/compose/runtime/Composer;II)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-static {v12, v11, v2, v11, v7}, Landroidx/collection/a;->f(Landroidx/compose/ui/node/ComposeUiNode$Companion;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/layout/MeasurePolicy;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/unit/Density;)LJ3/n;

    move-result-object v2

    invoke-static {v11, v9, v2}, Landroidx/compose/runtime/Updater;->set-impl(Landroidx/compose/runtime/Composer;Ljava/lang/Object;LJ3/n;)V

    invoke-static {v12, v11, v10, v1, v1}, Landroidx/collection/a;->g(Landroidx/compose/ui/node/ComposeUiNode$Companion;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/platform/ViewConfiguration;Landroidx/compose/runtime/Composer;Landroidx/compose/runtime/Composer;)Landroidx/compose/runtime/SkippableUpdater;

    move-result-object v2

    const v7, 0x7ab4aae9

    invoke-static {v8, v0, v2, v1, v7}, Landroidx/collection/a;->y(ILJ3/o;Landroidx/compose/runtime/SkippableUpdater;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-interface {v5, v1, v0}, LJ3/n;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const v2, 0x102ff319  # 3.469994E-29f
    ...
    invoke-static {v0, v2, v3, v1, v7}, Landroidx/glance/oneui/template/layout/compose/combine/SmallLayoutKt;->SmallLayout$SecondaryContent(ILandroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/SecondaryContentData;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/glance/oneui/template/layout/compose/combine/SmallLayoutKt$SmallLayout$2;-><init>(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/PrimaryContentData;Landroidx/glance/oneui/template/SecondaryContentData;LJ3/n;LJ3/n;II)V
...
.method private static final SmallLayout$PrimaryContent(LJ3/n;Landroidx/glance/oneui/template/PrimaryContentData;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "androidx.glance.oneui.template.layout.compose.combine.SmallLayout.PrimaryContent (SmallLayout.kt:41)"
    ...
    invoke-static {p1, p4, p3, p4, p5}, Landroidx/collection/a;->h(Landroidx/compose/ui/Alignment$Companion;ZLandroidx/compose/runtime/Composer;II)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-interface {p3, v3}, Landroidx/compose/runtime/Composer;->createNode(LJ3/a;)V
    ...
    invoke-static {v2, v3, p1, v3, p5}, Landroidx/collection/a;->f(Landroidx/compose/ui/node/ComposeUiNode$Companion;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/layout/MeasurePolicy;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/unit/Density;)LJ3/n;

    move-result-object p1

    invoke-static {v3, v0, p1}, Landroidx/compose/runtime/Updater;->set-impl(Landroidx/compose/runtime/Composer;Ljava/lang/Object;LJ3/n;)V

    invoke-static {v2, v3, v1, p3, p3}, Landroidx/collection/a;->g(Landroidx/compose/ui/node/ComposeUiNode$Companion;Landroidx/compose/runtime/Composer;Landroidx/compose/ui/platform/ViewConfiguration;Landroidx/compose/runtime/Composer;Landroidx/compose/runtime/Composer;)Landroidx/compose/runtime/SkippableUpdater;

    move-result-object p1

    const p5, 0x7ab4aae9

    invoke-static {p4, p2, p1, p3, p5}, Landroidx/collection/a;->y(ILJ3/o;Landroidx/compose/runtime/SkippableUpdater;Landroidx/compose/runtime/Composer;I)V
...
.method private static final SmallLayout$SecondaryContent(ILandroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/SecondaryContentData;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v2, "androidx.glance.oneui.template.layout.compose.combine.SmallLayout.SecondaryContent (SmallLayout.kt:50)"
    ...
    :cond_4d
    invoke-virtual/range {p2 .. p2}, Landroidx/glance/oneui/template/SecondaryContentData;->getFirstProgressBar$glance_oneui_template_release()Landroidx/glance/oneui/template/LinearProgressData;

    move-result-object v0

    if-eqz v0, :cond_86

    invoke-virtual/range {p2 .. p2}, Landroidx/glance/oneui/template/SecondaryContentData;->getSecondProgressBar$glance_oneui_template_release()Landroidx/glance/oneui/template/LinearProgressData;
...
.method private static final SmallLayout$SecondaryContent$SecondaryProgressListContent(Landroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/LinearProgressData;Landroidx/glance/oneui/template/LinearProgressData;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v2, "androidx.glance.oneui.template.layout.compose.combine.SmallLayout.SecondaryContent.SecondaryProgressListContent (SmallLayout.kt:126)"
    ...
    invoke-static {v0, p0, p4, p3, v2}, Landroidx/collection/a;->y(ILJ3/o;Landroidx/compose/runtime/SkippableUpdater;Landroidx/compose/runtime/Composer;I)V
...
.method private static final SmallLayout$SecondaryContent$SecondaryTextListContent(Landroidx/glance/oneui/template/SecondaryContentData;ILandroidx/compose/ui/Modifier;Landroidx/glance/oneui/template/TypedTextListData;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v2, "androidx.glance.oneui.template.layout.compose.combine.SmallLayout.SecondaryContent.SecondaryTextListContent (SmallLayout.kt:54)"
    ...
    invoke-static {v0, v1, v10, v3}, Landroidx/compose/foundation/layout/ColumnKt;->columnMeasurePolicy(Landroidx/compose/foundation/layout/Arrangement$Vertical;Landroidx/compose/ui/Alignment$Horizontal;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-static {v12, v7, v0, v10, v1}, Landroidx/collection/a;->y(ILJ3/o;Landroidx/compose/runtime/SkippableUpdater;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-virtual {v0, v15, v1, v4}, Landroidx/glance/oneui/template/size/CombineTemplatePercent;->getTextViewHeightPercent-tZlUyYw(III)F
    ...
    invoke-static {v9, v8, v12, v7, v8}, Landroidx/compose/foundation/layout/SizeKt;->wrapContentSize$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/Alignment;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    invoke-virtual {v6, v1, v4, v5}, Landroidx/glance/oneui/template/size/CombineTemplatePercent;->getTextViewHeightPercent-tZlUyYw(III)F
    ...
    invoke-static {v0, v1, v12, v3, v1}, Landroidx/compose/foundation/layout/SizeKt;->wrapContentSize$default(Landroidx/compose/ui/Modifier;Landroidx/compose/ui/Alignment;ZILjava/lang/Object;)Landroidx/compose/ui/Modifier;
