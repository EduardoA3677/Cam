...
.method public constructor <init>(Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/unit/ColorProvider;LJ3/n;LJ3/n;)V
    ...
    iput-object p4, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$mainContent:LJ3/n;

    iput-object p5, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$subContent:LJ3/n;
...
.method public final invoke(Landroidx/glance/layout/ColumnScope;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "androidx.glance.oneui.template.layout.glance.GlanceTextBlockLayout.<anonymous> (TextBlockLayout.kt:78)"
    ...
    iget-object v2, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object v3, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$mainContent:LJ3/n;

    invoke-direct {v0, v2, v3}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2$1;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LJ3/n;)V
    ...
    .line 3
    iget-object v0, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    invoke-virtual {v0}, Landroidx/glance/oneui/template/TextBlockItem;->getApplyInverseColor()Z

    move-result v0

    iget-object v1, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;
    ...
    .line 12
    :cond_85
    iget-object v0, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$dividerColor:Landroidx/glance/unit/ColorProvider;

    const/16 v1, 0x46

    const/4 v2, 0x0

    invoke-static {v2, v0, p2, v1, v2}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt;->GlanceDivider(ZLandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    iget-object p3, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object p0, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2;->$subContent:LJ3/n;

    invoke-direct {p1, p3, p0}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$2$2;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LJ3/n;)V
