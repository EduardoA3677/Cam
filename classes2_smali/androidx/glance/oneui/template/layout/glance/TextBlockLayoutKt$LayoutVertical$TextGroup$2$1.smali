...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v3, "androidx.glance.oneui.template.layout.glance.LayoutVertical.TextGroup.<anonymous>.<anonymous> (TextBlockLayout.kt:283)"
    ...
    .line 12
    iget v4, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$visibleTextCount:I
    ...
    .line 19
    new-instance v1, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1$1;

    iget-object v5, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$nextText:Landroidx/glance/oneui/template/TypedTextData;
    ...
    iget-object v7, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$defaultTextColor:Landroidx/glance/unit/ColorProvider;

    iget-object v8, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$defaultTextModifier:Landroidx/glance/GlanceModifier;

    iget-object v9, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$textList:Ljava/util/List;

    iget v10, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$i:I

    iget v11, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1;->$visibleTextCount:I

    move-object v4, v1

    invoke-direct/range {v4 .. v11}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$LayoutVertical$TextGroup$2$1$1;-><init>(Landroidx/glance/oneui/template/TypedTextData;ZLandroidx/glance/unit/ColorProvider;Landroidx/glance/GlanceModifier;Ljava/util/List;II)V
