...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/glance/state/GlanceState;->mutex:Ll5/a;
...
.method public static final synthetic access$getDataStore(Landroidx/glance/state/GlanceState;Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    .registers 5

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
...
.method private final getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    .registers 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, p0, p4}, Landroidx/glance/state/GlanceState$getDataStore$1;-><init>(Landroidx/glance/state/GlanceState;Lz3/d;)V
    ...
    invoke-static {p0}, Ll0/a;->x(Ljava/lang/Object;)V
    :try_end_57
    .catchall {:try_start_54 .. :try_end_57} :catchall_3d
    ...
    sget-object p0, Landroidx/glance/state/GlanceState;->mutex:Ll5/a;
    ...
    invoke-virtual {p0, v6, v1}, Ll5/d;->c(Ljava/lang/Object;LB3/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1, p3, v1}, Landroidx/glance/state/PreferencesGlanceStateDefinition;->getOrPutDataStore$glance_release(Landroid/content/Context;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;

    move-result-object p1
    :try_end_d1
    .catchall {:try_start_88 .. :try_end_d1} :catchall_da
    ...
    :try_end_d9
    .catchall {:try_start_d7 .. :try_end_d9} :catchall_3d
    ...
    invoke-interface {p2, p1, p3, v1}, Landroidx/glance/state/GlanceStateDefinition;->getDataStore(Landroid/content/Context;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;

    move-result-object p1
    :try_end_ec
    .catchall {:try_start_de .. :try_end_ec} :catchall_da
    ...
    :try_end_106
    .catchall {:try_start_f2 .. :try_end_106} :catchall_3d

    check-cast p2, Ll5/d;

    invoke-virtual {p2, v6}, Ll5/d;->d(Ljava/lang/Object;)V
...
# virtual methods
.method public deleteStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    .registers 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p4}, Landroidx/glance/state/GlanceState$deleteStore$1;-><init>(Landroidx/glance/state/GlanceState;Lz3/d;)V
    ...
    invoke-virtual {p0, v5, v0}, Ll5/d;->c(Ljava/lang/Object;LB3/c;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v4, v0}, Lc5/l;-><init>(ILz3/d;)V
    ...
    invoke-direct {v3, v1}, Landroidx/glance/state/GlanceState$deleteStore$2$1$1;-><init>(Lc5/k;)V

    invoke-virtual {v1, v3}, Lc5/l;->k(LJ3/k;)V
    ...
    :cond_d1
    :goto_d1
    invoke-virtual {v1, v2}, Lc5/l;->resumeWith(Ljava/lang/Object;)V

    invoke-virtual {v1}, Lc5/l;->p()Ljava/lang/Object;

    move-result-object p1
    :try_end_d8
    .catchall {:try_start_7c .. :try_end_d8} :catchall_cc
    ...
    invoke-virtual {p1, v5}, Ll5/d;->d(Ljava/lang/Object;)V
...
.method public getValue(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    .registers 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p4}, Landroidx/glance/state/GlanceState$getValue$1;-><init>(Landroidx/glance/state/GlanceState;Lz3/d;)V
    ...
    invoke-static {p4}, Ll0/a;->x(Ljava/lang/Object;)V
    :try_end_4b
    .catch Ljava/lang/Exception; {:try_start_48 .. :try_end_4b} :catch_34
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    ...
    invoke-interface {p4}, Landroidx/datastore/core/DataStore;->getData()Lf5/j;
    ...
    invoke-static {p0, v0}, Lf5/b0;->n(Lf5/j;Lz3/d;)Ljava/lang/Object;

    move-result-object p4
    :try_end_6c
    .catch Ljava/lang/Exception; {:try_start_4f .. :try_end_6c} :catch_34
...
.method public updateValue(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;LJ3/n;Lz3/d;)Ljava/lang/Object;
    .registers 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, p0, p5}, Landroidx/glance/state/GlanceState$updateValue$1;-><init>(Landroidx/glance/state/GlanceState;Lz3/d;)V
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Landroidx/glance/state/GlanceState;->getDataStore(Landroid/content/Context;Landroidx/glance/state/GlanceStateDefinition;Ljava/lang/String;Lz3/d;)Ljava/lang/Object;
    ...
    invoke-interface {p5, p4, v1}, Landroidx/datastore/core/DataStore;->updateData(LJ3/n;Lz3/d;)Ljava/lang/Object;

    move-result-object p5
    :try_end_90
    .catch Ljava/lang/Exception; {:try_start_59 .. :try_end_90} :catch_39
