...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lv3/o;",
        "updateManager",
        "(Lc5/D;Landroid/content/Context;)V",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/glance/appwidget/GlanceAppWidgetReceiver;->coroutineContext:Lz3/i;

    return-void
.end method

.method public static final synthetic access$updateManager(Landroidx/glance/appwidget/GlanceAppWidgetReceiver;Lc5/D;Landroid/content/Context;)V
    .registers 3

    invoke-direct {p0, p1, p2}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver;->updateManager(Lc5/D;Landroid/content/Context;)V
...
.method private final updateManager(Lc5/D;Landroid/content/Context;)V
    .registers 5
    ...
    invoke-direct {v0, p2, p0, v1}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver$updateManager$1;-><init>(Landroid/content/Context;Landroidx/glance/appwidget/GlanceAppWidgetReceiver;Lz3/d;)V
...
.method public getCoroutineContext()Lz3/i;
    ...
    iget-object p0, p0, Landroidx/glance/appwidget/GlanceAppWidgetReceiver;->coroutineContext:Lz3/i;
...
.method public onAppWidgetOptionsChanged(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;ILandroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver;->getCoroutineContext()Lz3/i;
    ...
    invoke-static {p0, p2, v6}, Landroidx/glance/appwidget/CoroutineBroadcastReceiverKt;->goAsync(Landroid/content/BroadcastReceiver;Lz3/i;LJ3/n;)V
...
.method public onDeleted(Landroid/content/Context;[I)V
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver$onDeleted$1;-><init>(Landroidx/glance/appwidget/GlanceAppWidgetReceiver;Landroid/content/Context;[ILz3/d;)V

    invoke-static {p0, v0, v1}, Landroidx/glance/appwidget/CoroutineBroadcastReceiverKt;->goAsync(Landroid/content/BroadcastReceiver;Lz3/i;LJ3/n;)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v1, "[unspecified] onReceive: action="
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver$onReceive$1$1;-><init>(Landroidx/glance/appwidget/GlanceAppWidgetReceiver;Landroid/content/Context;ILjava/lang/String;Lz3/d;)V

    invoke-static {p0, p2, v0}, Landroidx/glance/appwidget/CoroutineBroadcastReceiverKt;->goAsync(Landroid/content/BroadcastReceiver;Lz3/i;LJ3/n;)V
    ...
    :try_end_de
    .catch Ljava/util/concurrent/CancellationException; {:try_start_e .. :try_end_de} :catch_e2
    .catchall {:try_start_e .. :try_end_de} :catchall_7c
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    invoke-direct {v0, p0, p1, p3, v1}, Landroidx/glance/appwidget/GlanceAppWidgetReceiver$onUpdate$1;-><init>(Landroidx/glance/appwidget/GlanceAppWidgetReceiver;Landroid/content/Context;[ILz3/d;)V
