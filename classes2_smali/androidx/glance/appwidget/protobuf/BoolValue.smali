.class public final Landroidx/glance/appwidget/protobuf/BoolValue;
...
# static fields
.field private static final DEFAULT_INSTANCE:Landroidx/glance/appwidget/protobuf/BoolValue;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/glance/appwidget/protobuf/BoolValue;

    invoke-direct {v0}, Landroidx/glance/appwidget/protobuf/BoolValue;-><init>()V

    sput-object v0, Landroidx/glance/appwidget/protobuf/BoolValue;->DEFAULT_INSTANCE:Landroidx/glance/appwidget/protobuf/BoolValue;

    const-class v1, Landroidx/glance/appwidget/protobuf/BoolValue;
...
.method public static synthetic access$000()Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 1

    sget-object v0, Landroidx/glance/appwidget/protobuf/BoolValue;->DEFAULT_INSTANCE:Landroidx/glance/appwidget/protobuf/BoolValue;

    return-object v0
.end method

.method public static synthetic access$100(Landroidx/glance/appwidget/protobuf/BoolValue;Z)V
    .registers 2

    invoke-direct {p0, p1}, Landroidx/glance/appwidget/protobuf/BoolValue;->setValue(Z)V

    return-void
.end method

.method public static synthetic access$200(Landroidx/glance/appwidget/protobuf/BoolValue;)V
    .registers 1

    invoke-direct {p0}, Landroidx/glance/appwidget/protobuf/BoolValue;->clearValue()V
...
.method private clearValue()V
    ...
    iput-boolean v0, p0, Landroidx/glance/appwidget/protobuf/BoolValue;->value_:Z

    return-void
.end method

.method public static getDefaultInstance()Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 1
...
.method public static newBuilder()Landroidx/glance/appwidget/protobuf/BoolValue$Builder;
    .registers 1
    ...
    check-cast v0, Landroidx/glance/appwidget/protobuf/BoolValue$Builder;

    return-object v0
.end method

.method public static newBuilder(Landroidx/glance/appwidget/protobuf/BoolValue;)Landroidx/glance/appwidget/protobuf/BoolValue$Builder;
    .registers 2
    ...
    check-cast p0, Landroidx/glance/appwidget/protobuf/BoolValue$Builder;

    return-object p0
.end method

.method public static of(Z)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2

    invoke-static {}, Landroidx/glance/appwidget/protobuf/BoolValue;->newBuilder()Landroidx/glance/appwidget/protobuf/BoolValue$Builder;

    move-result-object v0

    invoke-virtual {v0, p0}, Landroidx/glance/appwidget/protobuf/BoolValue$Builder;->setValue(Z)Landroidx/glance/appwidget/protobuf/BoolValue$Builder;
...
.method public static parseDelimitedFrom(Ljava/io/InputStream;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseDelimitedFrom(Ljava/io/InputStream;Landroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method public static parseFrom(Landroidx/glance/appwidget/protobuf/ByteString;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseFrom(Landroidx/glance/appwidget/protobuf/ByteString;Landroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method public static parseFrom(Landroidx/glance/appwidget/protobuf/CodedInputStream;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseFrom(Landroidx/glance/appwidget/protobuf/CodedInputStream;Landroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method public static parseFrom(Ljava/io/InputStream;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseFrom(Ljava/io/InputStream;Landroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method public static parseFrom(Ljava/nio/ByteBuffer;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseFrom(Ljava/nio/ByteBuffer;Landroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method public static parseFrom([B)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 2
...
.method public static parseFrom([BLandroidx/glance/appwidget/protobuf/ExtensionRegistryLite;)Landroidx/glance/appwidget/protobuf/BoolValue;
    .registers 3
...
.method private setValue(Z)V
    ...
    iput-boolean p1, p0, Landroidx/glance/appwidget/protobuf/BoolValue;->value_:Z
...
.method public final dynamicMethod(Landroidx/glance/appwidget/protobuf/GeneratedMessageLite$MethodToInvoke;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p0, Landroidx/glance/appwidget/protobuf/BoolValue$1;->$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke:[I
    ...
    :pswitch_19  #0x5
    sget-object p0, Landroidx/glance/appwidget/protobuf/BoolValue;->PARSER:Landroidx/glance/appwidget/protobuf/Parser;

    if-nez p0, :cond_34

    const-class p1, Landroidx/glance/appwidget/protobuf/BoolValue;
    ...
    sget-object p2, Landroidx/glance/appwidget/protobuf/BoolValue;->DEFAULT_INSTANCE:Landroidx/glance/appwidget/protobuf/BoolValue;
    ...
    sput-object p0, Landroidx/glance/appwidget/protobuf/BoolValue;->PARSER:Landroidx/glance/appwidget/protobuf/Parser;
    ...
    :pswitch_35  #0x4
    sget-object p0, Landroidx/glance/appwidget/protobuf/BoolValue;->DEFAULT_INSTANCE:Landroidx/glance/appwidget/protobuf/BoolValue;
    ...
    :pswitch_47  #0x2
    new-instance p0, Landroidx/glance/appwidget/protobuf/BoolValue$Builder;

    invoke-direct {p0, p1}, Landroidx/glance/appwidget/protobuf/BoolValue$Builder;-><init>(Landroidx/glance/appwidget/protobuf/BoolValue$1;)V

    return-object p0

    :pswitch_4d  #0x1
    new-instance p0, Landroidx/glance/appwidget/protobuf/BoolValue;

    invoke-direct {p0}, Landroidx/glance/appwidget/protobuf/BoolValue;-><init>()V
...
.method public getValue()Z
    ...
    iget-boolean p0, p0, Landroidx/glance/appwidget/protobuf/BoolValue;->value_:Z
