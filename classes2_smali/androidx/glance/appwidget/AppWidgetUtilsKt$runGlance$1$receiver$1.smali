.class final Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Landroidx/glance/appwidget/ContentReceiver;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
.end annotation
...
.method public constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;Le5/s;)V
    ...
    iput-object p2, p0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1;->$$this$channelFlow:Le5/s;
...
.method public fold(Ljava/lang/Object;LJ3/n;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p2}, Landroidx/glance/appwidget/ContentReceiver$DefaultImpls;->fold(Landroidx/glance/appwidget/ContentReceiver;Ljava/lang/Object;LJ3/n;)Ljava/lang/Object;
...
.method public get(Lz3/h;)Lz3/g;
    ...
    invoke-static {p0, p1}, Landroidx/glance/appwidget/ContentReceiver$DefaultImpls;->get(Landroidx/glance/appwidget/ContentReceiver;Lz3/h;)Lz3/g;
...
.method public minusKey(Lz3/h;)Lz3/i;
    ...
    invoke-static {p0, p1}, Landroidx/glance/appwidget/ContentReceiver$DefaultImpls;->minusKey(Landroidx/glance/appwidget/ContentReceiver;Lz3/h;)Lz3/i;
...
.method public plus(Lz3/i;)Lz3/i;
    ...
    invoke-static {p0, p1}, Landroidx/glance/appwidget/ContentReceiver$DefaultImpls;->plus(Landroidx/glance/appwidget/ContentReceiver;Lz3/i;)Lz3/i;
...
.method public final provideContent(LJ3/n;Lz3/d;)Ljava/lang/Object;
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$provideContent$1;-><init>(Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1;Lz3/d;)V
    ...
    :cond_2b
    iget-object p0, v0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$provideContent$1;->L$2:Ljava/lang/Object;

    check-cast p0, Le5/s;

    iget-object p0, v0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$provideContent$1;->L$1:Ljava/lang/Object;

    check-cast p0, Ljava/util/concurrent/atomic/AtomicReference;

    iget-object p0, v0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$provideContent$1;->L$0:Ljava/lang/Object;
    ...
    iget-object p2, p0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1;->$contentCoroutine:Ljava/util/concurrent/atomic/AtomicReference;

    iget-object p0, p0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1;->$$this$channelFlow:Le5/s;
    ...
    iput-object p0, v0, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$provideContent$1;->L$2:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Landroidx/glance/appwidget/AppWidgetUtilsKt$runGlance$1$receiver$1$1$1;-><init>(Le5/s;)V
    ...
    invoke-virtual {p2, v3, v0}, Landroidx/glance/oneui/common/GlanceLog$Companion;->d(Ljava/lang/String;Ljava/lang/String;)V
