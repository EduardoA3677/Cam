...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj/i;->a:Ljava/lang/Object;
    ...
    :catchall_3a
    sput-object v0, Lj/i;->b:Ljavax/xml/parsers/DocumentBuilderFactory;
...
.method public static a(Lorg/w3c/dom/Node;Z[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-static {v2, v0, p2}, Lj/i;->a(Lorg/w3c/dom/Node;Z[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    sget-object p0, Lj/i;->a:Ljava/lang/Object;
    ...
    :cond_7a
    invoke-static {v2, p1, p2}, Lj/i;->a(Lorg/w3c/dom/Node;Z[Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public static b(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;
    ...
    :try_start_0
    sget-object v0, Lj/i;->b:Ljavax/xml/parsers/DocumentBuilderFactory;
    ...
    move-result-object p0
    :try_end_e
    .catch Lorg/xml/sax/SAXException; {:try_start_0 .. :try_end_e} :catch_13
    .catch Ljavax/xml/parsers/ParserConfigurationException; {:try_start_0 .. :try_end_e} :catch_11
    ...
    invoke-direct {v0, v2, v1, p0}, Li/b;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method public static c(Lj/b;Ll/c;)Lorg/w3c/dom/Document;
    .registers 8
    ...
    :try_end_f
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_f} :catch_24
    ...
    move-result v1
    :try_end_15
    .catch Li/b; {:try_start_11 .. :try_end_15} :catch_27
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_11 .. :try_end_15} :catch_24

    if-eqz v1, :cond_1f

    :try_start_17
    sget-object v1, Lj/i;->b:Ljavax/xml/parsers/DocumentBuilderFactory;
    ...
    :cond_1f
    :try_start_1f
    invoke-static {v0}, Lj/i;->b(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;

    move-result-object p0
    :try_end_23
    .catch Li/b; {:try_start_1f .. :try_end_23} :catch_27
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_1f .. :try_end_23} :catch_24
    ...
    invoke-static {p0}, Ll0/a;->i(Lj/b;)Lj/b;
    ...
    invoke-static {p0}, Lj/i;->b(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;
    ...
    invoke-static {p1}, Lj/i;->b(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;
    ...
    throw p0
    :try_end_a0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_28 .. :try_end_a0} :catch_24
    ...
    invoke-direct {p1, v1, v0, p0}, Li/b;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
