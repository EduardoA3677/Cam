...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ld0/d;->b:Ljava/lang/Object;
...
.method public static d(Landroid/app/Activity;ILg0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    .registers 9
    ...
    :cond_33
    invoke-static {p0, p1}, Lg0/l;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_6f
    invoke-static {p0, p1}, Lg0/l;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iput-object p1, v2, Ld0/h;->a:Landroid/app/AlertDialog;

    if-eqz p3, :cond_21

    iput-object p3, v2, Ld0/h;->b:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object p1, v2, Ld0/b;->a:Landroid/app/AlertDialog;

    if-eqz p3, :cond_3d

    iput-object p3, v2, Ld0/b;->b:Landroid/content/DialogInterface$OnCancelListener;
...
.method public final c(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p1, p2, v0}, Ld0/e;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p0, p1, v1}, Lg0/m;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p2, v0, p3}, Ld0/d;->d(Landroid/app/Activity;ILg0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p3}, Ld0/d;->e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final f(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p2, v0, v1}, Landroidx/collection/a;->p(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p1}, Ld0/i;-><init>(Ld0/d;Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lg0/l;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_39
    invoke-static {p1, p2}, Lg0/l;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_51
    invoke-static {p1, p2}, Lg0/l;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_56
    :goto_56
    invoke-static {p1}, Lg0/l;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p0

    const-string v3, "common_google_play_services_resolution_required_text"

    invoke-static {p1, v3, p0}, Lg0/l;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v6, Lj2/b;->c:Ljava/lang/Boolean;
    ...
    sput-object v5, Lj2/b;->c:Ljava/lang/Boolean;

    :cond_a1
    sget-object v5, Lj2/b;->c:Ljava/lang/Boolean;
    ...
    :goto_ed
    sget-object p0, Ld0/d;->b:Ljava/lang/Object;
    ...
    monitor-exit p0
    :try_end_f1
    .catchall {:try_start_f0 .. :try_end_f1} :catchall_13c
    ...
    if-eq p2, v1, :cond_130

    if-eq p2, v6, :cond_130
    ...
    :cond_130
    sget-object p1, Ld0/f;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final g(Landroid/app/Activity;Lf0/e;ILandroid/content/DialogInterface$OnCancelListener;)V
    .registers 7

    const-string v0, "d"

    invoke-super {p0, p1, p3, v0}, Ld0/e;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p0, p2, v1}, Lg0/m;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p3, v0, p4}, Ld0/d;->d(Landroid/app/Activity;ILg0/m;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p4}, Ld0/d;->e(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
