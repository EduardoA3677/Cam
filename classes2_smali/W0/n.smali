...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iput v3, v0, LW0/n;->i:I

    new-instance v4, Ljava/util/LinkedHashSet;

    invoke-direct {v4}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v4, v0, LW0/n;->j:Ljava/util/LinkedHashSet;

    new-instance v4, LW0/j;

    invoke-direct {v4, v0}, LW0/j;-><init>(LW0/n;)V

    iput-object v4, v0, LW0/n;->v:LW0/j;

    new-instance v4, LW0/k;

    invoke-direct {v4, v0}, LW0/k;-><init>(LW0/n;)V
    ...
    iput-object v5, v0, LW0/n;->t:Landroid/view/accessibility/AccessibilityManager;

    iput-object v1, v0, LW0/n;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v6, v0, LW0/n;->b:Landroid/widget/FrameLayout;
    ...
    const v10, 0x7f0a05fe

    invoke-virtual {v0, v0, v9, v10}, LW0/n;->a(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;

    move-result-object v10

    iput-object v10, v0, LW0/n;->c:Lcom/google/android/material/internal/CheckableImageButton;

    const v11, 0x7f0a05fc

    invoke-virtual {v0, v6, v9, v11}, LW0/n;->a(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;

    move-result-object v9

    iput-object v9, v0, LW0/n;->g:Lcom/google/android/material/internal/CheckableImageButton;

    new-instance v11, LW0/m;

    invoke-direct {v11, v0, v2}, LW0/m;-><init>(LW0/n;Landroidx/appcompat/widget/TintTypedArray;)V

    iput-object v11, v0, LW0/n;->h:LW0/m;
    ...
    iput-object v11, v0, LW0/n;->q:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v13, v2, v12}, LP0/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v12

    iput-object v12, v0, LW0/n;->d:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v12, v14}, LL0/x;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v12

    iput-object v12, v0, LW0/n;->e:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0, v12}, LW0/n;->i(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v15, v2, v13}, LP0/c;->b(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v13

    iput-object v13, v0, LW0/n;->k:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v13, v14}, LL0/x;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v13

    iput-object v13, v0, LW0/n;->l:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0, v12}, LW0/n;->g(I)V
    ...
    iget v13, v0, LW0/n;->m:I

    if-eq v12, v13, :cond_199

    iput v12, v0, LW0/n;->m:I
    ...
    invoke-static {v8}, La/a;->k(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v8

    iput-object v8, v0, LW0/n;->n:Landroid/widget/ImageView$ScaleType;
    ...
    :goto_1ee
    iput-object v14, v0, LW0/n;->p:Ljava/lang/CharSequence;

    invoke-virtual {v11, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual/range {p0 .. p0}, LW0/n;->n()V
    ...
    invoke-virtual {v4, v1}, LW0/k;->a(Lcom/google/android/material/textfield/TextInputLayout;)V

    :cond_20e
    new-instance v1, LW0/l;

    invoke-direct {v1, v0}, LW0/l;-><init>(LW0/n;)V
...
.method public final a(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p0}, LP0/c;->d(Landroid/content/Context;)Z
...
.method public final b()LW0/o;
    .registers 5

    iget v0, p0, LW0/n;->i:I

    iget-object p0, p0, LW0/n;->h:LW0/m;

    iget-object v1, p0, LW0/m;->c:Ljava/lang/Cloneable;
    ...
    invoke-direct {p0, v3}, LW0/i;-><init>(LW0/n;)V
    ...
    invoke-direct {p0, v3}, LW0/d;-><init>(LW0/n;)V
    ...
    invoke-direct {v2, v3, p0}, LW0/v;-><init>(LW0/n;I)V
    ...
    invoke-direct {p0, v3, v2}, LW0/e;-><init>(LW0/n;I)V
...
.method public final c()I
    ...
    invoke-virtual {p0}, LW0/n;->d()Z

    move-result v0

    if-nez v0, :cond_f

    invoke-virtual {p0}, LW0/n;->e()Z
...
.method public final d()Z
    ...
    iget-object v0, p0, LW0/n;->b:Landroid/widget/FrameLayout;
...
.method public final f(Z)V
    ...
    invoke-virtual {v0}, LW0/o;->k()Z

    move-result v1

    iget-object v2, p0, LW0/n;->g:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object p0, p0, LW0/n;->a:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-static {p0, v2, p1}, La/a;->A(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
...
.method public final g(I)V
    ...
    iget-object v1, p0, LW0/n;->u:Landroidx/core/view/accessibility/AccessibilityManagerCompat$TouchExplorationStateChangeListener;

    iget-object v2, p0, LW0/n;->t:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object v1, p0, LW0/n;->u:Landroidx/core/view/accessibility/AccessibilityManagerCompat$TouchExplorationStateChangeListener;

    invoke-virtual {v0}, LW0/o;->s()V

    iput p1, p0, LW0/n;->i:I

    iget-object v0, p0, LW0/n;->j:Ljava/util/LinkedHashSet;
    ...
    :goto_2e
    invoke-virtual {p0, v3}, LW0/n;->h(Z)V

    invoke-virtual {p0}, LW0/n;->b()LW0/o;

    move-result-object v3

    iget-object v4, p0, LW0/n;->h:LW0/m;

    iget v4, v4, LW0/m;->a:I

    if-nez v4, :cond_3f

    invoke-virtual {v3}, LW0/o;->d()I
    ...
    :goto_4b
    iget-object v5, p0, LW0/n;->g:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v6, p0, LW0/n;->a:Lcom/google/android/material/textfield/TextInputLayout;

    if-eqz v4, :cond_60

    iget-object v4, p0, LW0/n;->k:Landroid/content/res/ColorStateList;

    iget-object v7, p0, LW0/n;->l:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v6, v5, v4, v7}, La/a;->h(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v3, v1}, LW0/o;->i(I)Z

    move-result v1

    if-eqz v1, :cond_c1

    invoke-virtual {v3}, LW0/o;->r()V

    invoke-virtual {v3}, LW0/o;->h()Landroidx/core/view/accessibility/AccessibilityManagerCompat$TouchExplorationStateChangeListener;

    move-result-object p1

    iput-object p1, p0, LW0/n;->u:Landroidx/core/view/accessibility/AccessibilityManagerCompat$TouchExplorationStateChangeListener;
    ...
    iget-object p1, p0, LW0/n;->u:Landroidx/core/view/accessibility/AccessibilityManagerCompat$TouchExplorationStateChangeListener;
    ...
    :cond_a0
    invoke-virtual {v3}, LW0/o;->f()Landroid/view/View$OnClickListener;

    move-result-object p1

    iget-object v1, p0, LW0/n;->o:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v5, p1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v5, v1}, La/a;->G(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iget-object p1, p0, LW0/n;->s:Landroid/widget/EditText;

    if-eqz p1, :cond_b6

    invoke-virtual {v3, p1}, LW0/o;->m(Landroid/widget/EditText;)V

    invoke-virtual {p0, v3}, LW0/n;->j(LW0/o;)V
    ...
    invoke-static {v6, v5, p1, v1}, La/a;->h(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V

    invoke-virtual {p0, v0}, LW0/n;->f(Z)V
...
.method public final i(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, LW0/n;->e:Landroid/graphics/PorterDuff$Mode;

    iget-object p0, p0, LW0/n;->a:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-static {p0, v0, p1, v1}, La/a;->h(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)V

    return-void
.end method

.method public final j(LW0/o;)V
    .registers 4

    iget-object v0, p0, LW0/n;->s:Landroid/widget/EditText;
    ...
    :cond_5
    invoke-virtual {p1}, LW0/o;->e()Landroid/view/View$OnFocusChangeListener;
    ...
    :cond_14
    invoke-virtual {p1}, LW0/o;->g()Landroid/view/View$OnFocusChangeListener;
...
.method public final k()V
    ...
    :goto_14
    iget-object v3, p0, LW0/n;->b:Landroid/widget/FrameLayout;

    invoke-virtual {v3, v0}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, LW0/n;->p:Ljava/lang/CharSequence;

    if-eqz v0, :cond_23

    iget-boolean v0, p0, LW0/n;->r:Z
...
.method public final l()V
    ...
    iget-object v1, v2, Lcom/google/android/material/textfield/TextInputLayout;->j:LW0/r;

    iget-boolean v1, v1, LW0/r;->q:Z
...
.method public final n()V
    ...
    iget-object v2, p0, LW0/n;->p:Ljava/lang/CharSequence;

    const/4 v3, 0x0

    if-eqz v2, :cond_11

    iget-boolean v2, p0, LW0/n;->r:Z
    ...
    :cond_1c
    invoke-virtual {v1, v3}, LW0/o;->p(Z)V
