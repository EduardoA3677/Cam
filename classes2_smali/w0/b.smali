...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lw0/b;->a:Landroidx/collection/SimpleArrayMap;

    new-instance v0, Landroidx/collection/SimpleArrayMap;

    invoke-direct {v0}, Landroidx/collection/SimpleArrayMap;-><init>()V

    iput-object v0, p0, Lw0/b;->b:Landroidx/collection/SimpleArrayMap;

    return-void
.end method

.method public static a(Landroid/content/Context;I)Lw0/b;
    .registers 5
    ...
    invoke-static {p0}, Lw0/b;->b(Ljava/util/ArrayList;)Lw0/b;
    ...
    invoke-static {v1}, Lw0/b;->b(Ljava/util/ArrayList;)Lw0/b;
...
.method public static b(Ljava/util/ArrayList;)Lw0/b;
    .registers 14
    ...
    iget-object v7, v0, Lw0/b;->b:Landroidx/collection/SimpleArrayMap;
    ...
    sget-object v11, Lw0/a;->c:Landroidx/interpolator/view/animation/FastOutLinearInInterpolator;
    ...
    sget-object v11, Lw0/a;->d:Landroidx/interpolator/view/animation/LinearOutSlowInInterpolator;

    goto :goto_4f

    :cond_4d
    :goto_4d
    sget-object v11, Lw0/a;->b:Landroidx/interpolator/view/animation/FastOutSlowInInterpolator;

    :cond_4f
    :goto_4f
    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    iput v2, v6, Lw0/c;->d:I

    const/4 v12, 0x1

    iput v12, v6, Lw0/c;->e:I

    iput-wide v7, v6, Lw0/c;->a:J

    iput-wide v9, v6, Lw0/c;->b:J

    iput-object v11, v6, Lw0/c;->c:Landroid/animation/TimeInterpolator;

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatCount()I

    move-result v7

    iput v7, v6, Lw0/c;->d:I

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatMode()I

    move-result v4

    iput v4, v6, Lw0/c;->e:I

    iget-object v4, v0, Lw0/b;->a:Landroidx/collection/SimpleArrayMap;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object p0, p0, Lw0/b;->a:Landroidx/collection/SimpleArrayMap;

    iget-object p1, p1, Lw0/b;->a:Landroidx/collection/SimpleArrayMap;
